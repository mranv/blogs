...
def update_day_post(filepath, day_num):
    ...
    # Calculate date for this day (sequential from Jan 1, 2023)
    base_date = datetime(2023, 1, 1, 9, 0, 0)  # Start at 9 AM
...
def main():
    ...
    for filepath in day_files:
        ...
        if day_num:
            title = update_day_post(filepath, day_num)
            print(f"✅ Enhanced Day {day_num:02d}: {title}")
    ...
    if os.path.exists(blacklist_file):
        ...
        # Set date for blacklist
        pub_date = datetime(2023, 5, 1, 10, 0, 0)
        ...
        with open(blacklist_file, 'w', encoding='utf-8') as f:
            f.write(content)
        print("✅ Enhanced 2024-blacklist.md")
