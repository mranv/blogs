...
- Admonitions ([미리보기 및 사용법](https://mranv.pages.dev/posts/markdown-extended/#admonitions))
- GitHub 저장소 카드 ([미리보기 및 사용법](https://mranv.pages.dev/posts/markdown-extended/#github-repository-cards))
- Expressive Code를 사용한 향상된 코드 블록 ([미리보기](https://mranv.pages.dev/posts/expressive-code/) / [문서](https://expressive-code.com/))
