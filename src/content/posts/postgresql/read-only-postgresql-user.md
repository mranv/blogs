...
author: Anubhav Gain
category: postgresql
description: I wanted to grant a PostgreSQL user (or role) read-only access to a specific
  list of tables.
draft: false
featured: false
lang: en
pubDatetime: '2024-03-21T17:48:32+05:30'
slug: granting-a-postgresql-user-read-only-access-to-some-tables
tags:
- /
- postgresql
- python
...
- web
- cli
title: Granting a PostgreSQL user read-only access to some tables
---
