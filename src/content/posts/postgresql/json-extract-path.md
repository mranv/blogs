...
author: Anubhav Gain
category: postgresql
description: The `json_extract_path()` function in PostgreSQL can be used to extract
  specific items from JSON - but I couldn't find documentation for the path l...
draft: false
featured: false
lang: en
pubDatetime: '2024-04-30T11:04:50+05:30'
slug: using-json_extract_path-in-postgresql
tags:
- /
- postgresql
- python
...
- database
- web
title: Using json_extract_path in PostgreSQL
---
