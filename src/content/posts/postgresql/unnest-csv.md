...
author: Anubhav Gain
category: postgresql
description: '[django-sql-dashboard](https://github.com/simonw/django-sql-dashboard)
  lets you define a SQL query plus one or more text inputs that the user can p...'
draft: false
featured: false
lang: en
pubDatetime: '2024-03-31T12:06:35+05:30'
slug: using-unnest-to-use-a-comma-separated-string-as-the-input-to-an-in-query
tags:
- /
- postgresql
- python
...
- database
- web
title: Using unnest() to use a comma-separated string as the input to an IN query
---
