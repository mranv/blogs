...
author: Anubhav Gain
category: jupyter
description: I tried to get [jupyterlab](https://jupyter.org/install) working via
  `uv tool install` today and ran into some sharp edges.
draft: false
featured: false
lang: en
pubDatetime: '2024-04-17T09:35:32+05:30'
slug: running-jupyterlab-via-uv-tool-install
tags:
- /
- jupyter
- python
...
- web
- cli
title: Running jupyterlab via uv tool install
---
