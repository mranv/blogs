...
author: Anubhav Gain
category: html
description: Today I figured out how to use the `<video>` tag to show a static thumbnail
  that gets replaced by the loaded video only when the user clicks play.
draft: false
featured: false
lang: en
pubDatetime: '2024-05-29T17:46:59+05:30'
slug: html-video-that-loads-when-the-user-clicks-play
tags:
- /
- html
- web
title: HTML video that loads when the user clicks play
---
