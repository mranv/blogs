...
author: Anubhav Gain
category: html
description: '[Most modern browsers](https://caniuse.com/loading-lazy-attr) now include
  support for the `loading="lazy"` image attribute, which causes images not...'
draft: false
featured: false
lang: en
pubDatetime: '2024-06-21T13:48:51+05:30'
slug: lazy-loading-images-in-html
tags:
- /
- html
- python
