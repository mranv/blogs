...
author: Anubhav Gain
category: yaml
description: I decided to see if there was an equivalent of [Black](https://pypi.org/project/black/)
  or [Prettier](https://prettier.io/) for YAML files. I found...
draft: false
featured: false
lang: en
pubDatetime: '2024-05-11T20:21:46+05:30'
slug: auto-formatting-yaml-files-with-yamlfmt
tags:
- /
- yaml
- python
...
- cli
- testing
title: Auto-formatting YAML files with yamlfmt
---
