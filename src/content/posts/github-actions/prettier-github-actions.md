...
description: I [decided](https://github.com/simonw/datasette/issues/1166) to adopt
  [Prettier](https://prettier.io/) as the JavaScript code style for Datasette, ...
draft: false
featured: false
lang: en
pubDatetime: '2024-12-10T14:22:19+05:30'
slug: using-prettier-to-check-javascript-code-style-in-github-actions
tags:
- /
- github-actions
- python
...
- web
- testing
title: Using Prettier to check JavaScript code style in GitHub Actions
---
