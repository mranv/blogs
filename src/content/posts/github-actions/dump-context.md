...
description: 'Useful for seeing what''s available for `if: ` conditions (see [context
  and expression syntax](https://help.github.com/en/actions/reference/context-...'
draft: false
featured: false
lang: en
pubDatetime: '2024-09-07T13:34:17+05:30'
slug: dump-out-all-github-actions-context
tags:
- /
- github-actions
- javascript
- git
- web
title: Dump out all GitHub Actions context
---
