...
description: Newly created GitHub repositories come with a default set of labels.
  I have several labels I like to add on top of these. The most important is **r...
draft: false
featured: false
lang: en
pubDatetime: '2024-04-26T17:10:37+05:30'
slug: creating-github-repository-labels-with-an-actions-workflow
tags:
- /
- github-actions
- javascript
...
- web
- testing
title: Creating GitHub repository labels with an Actions workflow
---
