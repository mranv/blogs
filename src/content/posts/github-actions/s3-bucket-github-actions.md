...
description: For my [git-history live demos](https://github.com/simonw/git-history/issues/30)
  I needed to store quite large files (~200MB SQLite databases) in b...
draft: false
featured: false
lang: en
pubDatetime: '2024-12-12T12:55:45+05:30'
slug: storing-files-in-an-s3-bucket-between-github-actions-runs
tags:
- /
- github-actions
- aws
...
- database
- web
title: Storing files in an S3 bucket between GitHub Actions runs
---
