...
description: Some of my repositories have GitHub Actions workflows that execute commands
  using `npx`, for example my [graphql-scraper](https://github.com/simonw...
draft: false
featured: false
lang: en
pubDatetime: '2024-08-18T14:27:10+05:30'
slug: using-the-github-actions-cache-with-npx-and-no-packagejson
tags:
- /
- github-actions
- javascript
- git
- web
title: Using the GitHub Actions cache with npx and no package.json
---
