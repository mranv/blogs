...
description: I figured out how to serve a JavaScript project built using [Vite](https://vitejs.dev/)
  using GitHub Pages and a custom build script that runs usin...
draft: false
featured: false
lang: en
pubDatetime: '2024-04-15T21:04:29+05:30'
slug: serving-a-javascript-project-built-using-vite-from-github-pages
tags:
- /
- github-actions
- javascript
...
- cli
- testing
title: Serving a JavaScript project built using Vite from GitHub Pages
---
