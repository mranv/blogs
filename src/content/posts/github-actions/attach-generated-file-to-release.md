...
description: For [Datasette Desktop](https://github.com/simonw/datasette-app) I wanted
  to run an action which, when I created a release, would build an asset fo...
draft: false
featured: false
lang: en
pubDatetime: '2024-05-13T10:52:15+05:30'
slug: attaching-a-generated-file-to-a-github-release-using-actions
tags:
- /
- github-actions
- javascript
- git
- web
title: Attaching a generated file to a GitHub release using Actions
---
