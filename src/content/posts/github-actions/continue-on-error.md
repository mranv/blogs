...
description: I wanted to have a GitHub Action step run that might fail, but if it
  failed the rest of the steps should still execute and the overall run should b...
draft: false
featured: false
lang: en
pubDatetime: '2024-04-24T12:41:00+05:30'
slug: skipping-a-github-actions-step-without-failing
tags:
- /
- github-actions
- python
