...
description: I decided to run my CI tests against the Python 3.11 preview, to avoid
  the problem I had when Python 3.10 came out with [a bug that affected Datase...
draft: false
featured: false
lang: en
pubDatetime: '2024-11-24T13:54:19+05:30'
slug: testing-against-python-311-preview-using-github-actions
tags:
- /
- github-actions
- python
...
- web
- testing
title: Testing against Python 3.11 preview using GitHub Actions
---
