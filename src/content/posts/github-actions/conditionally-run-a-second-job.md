...
description: My [simonwillisonblog-backup workflow](https://github.com/simonw/simonwillisonblog-backup/blob/main/.github/workflows/backup.yml)
  periodically crea...
draft: false
featured: false
lang: en
pubDatetime: '2024-05-25T10:39:20+05:30'
slug: conditionally-running-a-second-job-in-a-github-actions-workflow
tags:
- /
- github-actions
- javascript
...
- web
- testing
title: Conditionally running a second job in a GitHub Actions workflow
---
