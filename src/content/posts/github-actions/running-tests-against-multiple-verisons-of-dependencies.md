...
description: My [datasette-export-notebook](https://github.com/simonw/datasette-export-notebook)
  plugin worked fine in the stable release of Datasette, currentl...
draft: false
featured: false
lang: en
pubDatetime: '2024-04-13T14:22:25+05:30'
slug: running-tests-against-multiple-versions-of-a-python-dependency-in-github-actions
tags:
- /
- github-actions
- python
...
- cli
- testing
title: Running tests against multiple versions of a Python dependency in GitHub Actions
---
