...
description: I wanted to ensure that when [this template repository](https://github.com/simonw/action-transcription)
  was used to create a new repo that repo wou...
draft: false
featured: false
lang: en
pubDatetime: '2024-08-13T19:21:24+05:30'
slug: ensure-labels-exist-in-a-github-repository
tags:
- /
- github-actions
- git
- web
- testing
title: Ensure labels exist in a GitHub repository
---
