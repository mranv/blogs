...
description: The GitHub Actions `ubuntu-latest` default runner currently includes
  an installation of PostgreSQL 13. The server is not running by default but you...
draft: false
featured: false
lang: en
pubDatetime: '2024-04-16T21:58:02+05:30'
slug: installing-different-postgresql-server-versions-in-github-actions
tags:
- /
- github-actions
- python
...
- web
- testing
title: Installing different PostgreSQL server versions in GitHub Actions
---
