...
description: '[markdown-toc](https://github.com/jonschlinkert/markdown-toc) is a Node
  script that parses a Markdown file and generates a table of contents for it...'
draft: false
featured: false
lang: en
pubDatetime: '2024-06-10T09:47:03+05:30'
slug: updating-a-markdown-table-of-contents-with-a-github-action
tags:
- /
- github-actions
- javascript
...
- web
- testing
title: Updating a Markdown table of contents with a GitHub Action
---
