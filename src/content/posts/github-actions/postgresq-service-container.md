...
description: I wanted to run some Django tests - using `pytest-django` and with Django
  configured to pick up the `DATABASE_URL` environment variable via [dj-dat...
draft: false
featured: false
lang: en
pubDatetime: '2024-03-18T16:37:54+05:30'
slug: running-tests-against-postgresql-in-a-service-container
tags:
- /
- github-actions
- python
...
- web
- testing
title: Running tests against PostgreSQL in a service container
---
