...
description: Say you have a workflow that runs hourly, but once a day you want the
  workflow to run slightly differently - without duplicating the entire workflow.
draft: false
featured: false
lang: en
pubDatetime: '2024-09-30T17:02:32+05:30'
slug: running-different-steps-on-a-schedule
tags:
- /
- github-actions
- git
- web
- testing
title: Running different steps on a schedule
---
