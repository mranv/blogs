...
description: 'This recipe runs a Python script to update a README, then commits it
  back to the parent repo but only if it has changed:'
draft: false
featured: false
lang: en
pubDatetime: '2024-03-19T22:42:48+05:30'
slug: commit-a-file-if-it-changed
tags:
- /
- github-actions
- python
...
- cli
- testing
title: Commit a file if it changed
---
