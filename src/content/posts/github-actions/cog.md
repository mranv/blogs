...
description: I really like [Cog](https://nedbatchelder.com/code/cog/) ([previously](https://til.simonwillison.net/python/cog-to-update-help-in-readme))
  as a too...
draft: false
featured: false
lang: en
pubDatetime: '2024-05-07T12:29:18+05:30'
slug: running-cog-automatically-against-github-pull-requests
tags:
- /
- github-actions
- python
...
- web
- testing
title: Running cog automatically against GitHub pull requests
---
