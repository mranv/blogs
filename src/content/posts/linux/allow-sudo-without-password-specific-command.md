...
author: Anubhav Gain
category: linux
description: I wanted a script running as a non-root user to be able to restart a
  systemd service on my Ubuntu machine without needing a password.
draft: false
featured: false
lang: en
pubDatetime: '2024-02-16T19:08:11+05:30'
slug: enabling-a-user-to-execute-a-specific-command-as-root-without-a-password
tags:
- /
- linux
title: Enabling a user to execute a specific command as root without a password
---
