...
author: Anubhav Gain
category: linux
description: In [sqlite-utils issue 439](https://github.com/simonw/sqlite-utils/issues/439)
  I was testing against a CSV file that used UTF16 little endian encod...
draft: false
featured: false
lang: en
pubDatetime: '2024-02-12T12:04:07+05:30'
slug: using-iconv-to-convert-the-text-encoding-of-a-file
tags:
- /
- linux
- git
...
- web
- testing
title: Using iconv to convert the text encoding of a file
---
