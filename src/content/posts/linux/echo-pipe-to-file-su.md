...
author: Anubhav Gain
category: linux
description: I wanted to create a file with a shell one-liner where the file lived
  somewhere owned by root.
draft: false
featured: false
lang: en
pubDatetime: '2024-03-23T09:02:55+05:30'
slug: piping-echo-to-a-file-owned-by-root-using-sudo-and-tee
tags:
- /
- linux
- python
- cli
title: Piping echo to a file owned by root using sudo and tee
---
