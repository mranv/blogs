...
author: Anubhav Gain
category: sphinx
description: Datasette's [release notes](https://github.com/simonw/datasette/blob/main/docs/changelog.rst)
  are formatted using Sphinx. Almost every bullet point...
draft: false
featured: false
lang: en
pubDatetime: '2024-03-31T14:06:00+05:30'
slug: using-sphinxextextlinks-for-issue-links
tags:
- /
- sphinx
- python
- git
- web
title: Using sphinx.ext.extlinks for issue links
---
