...
author: Anubhav Gain
category: sphinx
description: I built a [new API reference page](https://sqlite-utils.datasette.io/en/latest/reference.html)
  today for `sqlite-utils`, using the Sphinx [autodoc ...
draft: false
featured: false
lang: en
pubDatetime: '2024-04-12T10:09:32+05:30'
slug: adding-sphinx-autodoc-to-a-project-and-configuring-read-the-docs-to-build-it
tags:
- /
- sphinx
- python
...
- web
- testing
title: Adding Sphinx autodoc to a project, and configuring Read The Docs to build
  it
---
