...
author: Anubhav Gain
category: sphinx
description: I [wanted to include](https://github.com/simonw/datasette/issues/1830)
  some example Python tests in the Datasette documentation - but since they we...
draft: false
featured: false
lang: en
pubDatetime: '2024-05-27T17:21:56+05:30'
slug: literalinclude-with-markers-for-showing-code-in-documentation
tags:
- /
- sphinx
- python
...
- web
- testing
title: literalinclude with markers for showing code in documentation
---
