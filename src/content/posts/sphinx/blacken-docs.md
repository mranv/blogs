...
author: Anubhav Gain
category: sphinx
description: I decided to enforce that all code examples in the [Datasette documentation](https://docs.datasette.io/)
  be formatted using [Black](https://github....
draft: false
featured: false
lang: en
pubDatetime: '2024-08-19T20:07:13+05:30'
slug: format-code-examples-in-documentation-with-blacken-docs
tags:
- /
- sphinx
- python
...
- web
- testing
title: Format code examples in documentation with blacken-docs
---
