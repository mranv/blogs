...
description: I managed to accidentally create a GIF that ran once without looping.
  I think this is because I created it in [LICEcap](https://www.cockos.com/lice...
draft: false
featured: false
lang: en
pubDatetime: '2024-02-28T22:12:38+05:30'
slug: set-a-gif-to-loop-using-imagemagick
tags:
- /
- imagemagick
- web
title: Set a GIF to loop using ImageMagick
---
