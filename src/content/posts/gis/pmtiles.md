...
author: Anubhav Gain
category: gis
description: '[Protomaps](https://protomaps.com/) is "an open source map of the world,
  deployable as a single static file on cloud storage". It involves some _ve...'
draft: false
featured: false
lang: en
pubDatetime: '2024-03-13T13:18:14+05:30'
slug: serving-a-custom-vector-web-map-using-pmtiles-and-maplibre-gl
tags:
- /
- gis
- javascript
