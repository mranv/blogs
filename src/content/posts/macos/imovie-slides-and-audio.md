...
author: Anubhav Gain
category: macos
description: I found an MP3 recording of an old talk I gave and decided to use the
  slides from that talk to create a video using iMovie.
draft: false
featured: false
lang: en
pubDatetime: '2024-04-06T09:10:46+05:30'
slug: syncing-slide-images-and-audio-in-imovie
tags:
- /
- macos
- git
- web
title: Syncing slide images and audio in iMovie
---
