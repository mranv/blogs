...
author: Anubhav Gain
category: macos
description: For a friend's wedding I needed to run a Google Photos slideshow on some
  large televisions.
draft: false
featured: false
lang: en
pubDatetime: '2024-03-04T19:26:42+05:30'
slug: driving-an-external-display-from-a-mac-laptop
tags:
- /
- macos
- git
- web
title: Driving an external display from a Mac laptop
---
