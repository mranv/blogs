...
author: Anubhav Gain
category: macos
description: '`lsof` stands for "list open files". Here are some very basic usage
  notes for the version that ships with macOS.'
draft: false
featured: false
lang: en
pubDatetime: '2024-01-29T22:45:41+05:30'
slug: using-lsof-on-macos
tags:
- /
- macos
- python
