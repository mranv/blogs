...
author: Anubhav Gain
category: macos
description: I decided to try out [atuin](https://github.com/ellie/atuin?utm_source=tldrnewsletter),
  a shell extension that writes your history to a SQLite data...
draft: false
featured: false
lang: en
pubDatetime: '2024-05-05T11:29:47+05:30'
slug: seeing-files-opened-by-a-process-using-opensnoop
tags:
- /
- macos
- git
...
- web
- cli
title: Seeing files opened by a process using opensnoop
---
