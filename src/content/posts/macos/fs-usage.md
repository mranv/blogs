...
author: Anubhav Gain
category: macos
description: Today I wanted to figure out where the `vercel` CLI tool on my Mac kept
  its authentication tokens.
draft: false
featured: false
lang: en
pubDatetime: '2024-01-05T22:28:54+05:30'
slug: using-fs_usage-to-see-what-files-a-process-is-using
tags:
- /
- macos
- javascript
