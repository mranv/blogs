...
author: Anubhav Gain
category: macos
description: '*TLDR: Use `platform: linux/amd64` in `docker-compose.yml` and your
  containers will probably work!*'
draft: false
featured: false
lang: en
pubDatetime: '2024-06-03T09:00:02+05:30'
slug: running-docker-on-an-m1-mac
tags:
- /
- macos
- python
...
- web
- cli
title: Running Docker on an M1 Mac
---
