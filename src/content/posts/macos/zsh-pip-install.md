...
author: Anubhav Gain
category: macos
description: macOS Catalina uses `zsh` rather than `bash` as the default shell (apparently
  because Apple don't like GPL 3).
draft: false
featured: false
lang: en
pubDatetime: '2024-02-28T18:51:52+05:30'
slug: running-pip-install-e-test-in-zsh-on-macos-catalina
tags:
- /
- macos
- python
- cli
- testing
title: Running pip install -e .[test] in zsh on macOS Catalina
---
