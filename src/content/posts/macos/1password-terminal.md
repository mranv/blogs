...
author: Anubhav Gain
category: macos
description: I save things like API keys in [1Password](https://1password.com/). Today
  I figured out how to access those from macOS terminal scripts.
draft: false
featured: false
lang: en
pubDatetime: '2024-01-20T19:02:36+05:30'
slug: accessing-1password-items-from-the-terminal
tags:
- /
- macos
- python
...
- web
- cli
title: Accessing 1Password items from the terminal
---
