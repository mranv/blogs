...
author: Anubhav Gain
category: gpt3
description: OpenAI [released an API for ChatGPT](https://openai.com/blog/introducing-chatgpt-and-whisper-apis)
  yesterday. It's 1/10th of the price of the `text...
draft: false
featured: false
lang: en
pubDatetime: '2024-10-11T18:26:26+05:30'
slug: a-simple-python-wrapper-for-the-chatgpt-api
tags:
- /
- gpt3
- python
...
- git
- web
title: A simple Python wrapper for the ChatGPT API
---
