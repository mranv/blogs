...
author: Anubhav Gain
category: gpt3
description: I wanted to start playing around with [OpenAPI](https://www.openapis.org/).
  I decided to see if I could get GPT-3 to generate the first version of ...
draft: false
featured: false
lang: en
pubDatetime: '2024-09-06T08:22:35+05:30'
slug: generating-openapi-specifications-using-gpt-3
tags:
- /
- gpt3
- javascript
- database
- web
title: Generating OpenAPI specifications using GPT-3
---
