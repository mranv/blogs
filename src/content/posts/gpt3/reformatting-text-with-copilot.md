...
author: Anubhav Gain
category: gpt3
description: I wanted to write alt text for the following screenshot ([of this page]()),
  so I could include it in [this post on Mastodon](https://fedi.simonwill...
draft: false
featured: false
lang: en
pubDatetime: '2025-01-13T21:43:54+05:30'
slug: reformatting-text-with-copilot
tags:
- /
- gpt3
- git
- web
title: Reformatting text with Copilot
---
