...
author: Anubhav Gain
category: css
description: 'For my blog entry today [Now add a walrus: Prompt engineering in DALL-E
  3](https://simonwillison.net/2023/Oct/26/add-a-walrus/) I wanted to display...'
draft: false
featured: false
lang: en
pubDatetime: '2024-05-13T20:04:22+05:30'
slug: a-simple-two-column-css-grid
tags:
- /
- css
- docker
- git
- web
title: A simple two column CSS grid
---
