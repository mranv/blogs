...
author: Anubhav Gain
category: css
description: I've been experimenting with the HTML [dialog element](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/dialog)
  recently, for example in m...
draft: false
featured: false
lang: en
pubDatetime: '2024-01-26T20:03:55+05:30'
slug: styling-an-html-dialog-modal-to-take-the-full-height-of-the-viewport
tags:
- /
- css
- javascript
...
- web
- cli
title: Styling an HTML dialog modal to take the full height of the viewport
---
