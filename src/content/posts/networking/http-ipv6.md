...
author: Anubhav Gain
category: networking
description: 'Tiny TIL today: I learned how to make an HTTP call to an IPv6 address.
  The trick is to enclose the address in the URL in square braces:'
draft: false
featured: false
lang: en
pubDatetime: '2024-01-26T13:30:28+05:30'
slug: making-http-calls-using-ipv6
tags:
- /
- networking
- python
- web
title: Making HTTP calls using IPv6
---
