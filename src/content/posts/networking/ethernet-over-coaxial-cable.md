...
author: Anubhav Gain
category: networking
description: I recently noticed that the router in our garage was providing around
  900 Mbps if I plugged my laptop directly into it via an Ethernet cable, but t...
draft: false
featured: false
lang: en
pubDatetime: '2024-05-17T17:24:59+05:30'
slug: running-ethernet-over-existing-coaxial-cable
tags:
- /
- networking
- web
title: Running Ethernet over existing coaxial cable
---
