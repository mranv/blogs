...
author: Anubhav Gain
category: purpleair
description: '[Purple Air](https://www.purpleair.com/) sensors have an API at `https://www.purpleair.com/map.json?show=SENSOR-ID-HERE`,
  which returns JSON that l...'
draft: false
featured: false
lang: en
pubDatetime: '2024-08-11T20:29:18+05:30'
slug: calculating-the-aqi-based-on-the-purple-air-api-for-a-sensor
tags:
- /
- purpleair
- javascript
...
- git
- web
title: Calculating the AQI based on the Purple Air API for a sensor
---
