...
author: Anubhav Gain
category: django
description: Django 3.1 introduces PostgreSQL `search_type="websearch"` - which gives
  you search with advanced operators like `"phrase search" -excluding`. Jame...
draft: false
featured: false
lang: en
pubDatetime: '2024-01-31T16:11:10+05:30'
slug: postgresql-full-text-search-in-the-django-admin
tags:
- /
- django
- python
...
- database
- web
title: PostgreSQL full-text search in the Django Admin
---
