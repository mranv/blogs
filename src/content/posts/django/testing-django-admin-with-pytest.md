...
author: Anubhav Gain
category: django
description: I'm using [pytest-django](https://pytest-django.readthedocs.io/) on a
  project and I wanted to write a test for a Django admin create form submissio...
draft: false
featured: false
lang: en
pubDatetime: '2024-06-29T15:42:05+05:30'
slug: writing-tests-for-the-django-admin-with-pytest-django
tags:
- /
- django
- python
...
- web
- testing
title: Writing tests for the Django admin with pytest-django
---
