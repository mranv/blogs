...
author: Anubhav Gain
category: django
description: 'I published a reusable Django application today: **[django-http-debug](https://github.com/simonw/django-http-debug)**,
  which lets you define mock H...'
draft: false
featured: false
lang: en
pubDatetime: '2024-04-18T20:20:11+05:30'
slug: using-pytest-django-with-a-reusable-django-application
tags:
- /
- django
- python
...
- cli
- testing
title: Using pytest-django with a reusable Django application
---
