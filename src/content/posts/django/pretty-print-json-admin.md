...
author: Anubhav Gain
category: django
description: I have a bunch of models with JSON fields that are marked as read-only
  in the Django admin - usually because they're recording the raw JSON that wa...
draft: false
featured: false
lang: en
pubDatetime: '2024-05-19T21:42:24+05:30'
slug: pretty-printing-all-read-only-json-in-the-django-admin
tags:
- /
- django
- python
- javascript
- web
title: Pretty-printing all read-only JSON in the Django admin
---
