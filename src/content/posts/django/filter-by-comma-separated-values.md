...
author: Anubhav Gain
category: django
description: I have a text column which contains comma-separated values - inherited
  from an older database schema.
draft: false
featured: false
lang: en
pubDatetime: '2024-04-05T20:50:09+05:30'
slug: filter-by-comma-separated-values-in-the-django-admin
tags:
- /
- django
- python
- database
- web
title: Filter by comma-separated values in the Django admin
---
