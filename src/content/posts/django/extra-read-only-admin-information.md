...
author: Anubhav Gain
category: django
description: I figured out this pattern today for adding templated extra blocks of
  information to the Django admin change page for an object.
draft: false
featured: false
lang: en
pubDatetime: '2024-02-27T11:29:46+05:30'
slug: adding-extra-read-only-information-to-a-django-admin-change-page
tags:
- /
- django
- python
- web
title: Adding extra read-only information to a Django admin change page
---
