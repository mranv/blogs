...
author: Anubhav Gain
category: django
description: I tried using a gin index to speed up `LIKE '%term%'` queries against
  a column.
draft: false
featured: false
lang: en
pubDatetime: '2024-05-18T17:02:52+05:30'
slug: enabling-a-gin-index-for-faster-like-queries
tags:
- /
- django
- python
- database
- web
title: Enabling a gin index for faster LIKE queries
---
