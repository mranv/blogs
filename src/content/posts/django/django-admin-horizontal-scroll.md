...
author: Anubhav Gain
category: django
description: 'I got a complaint from a Windows-with-mouse user of a Django admin project
  I''m working on: they couldn''t see the right hand columns in a table with...'
draft: false
featured: false
lang: en
pubDatetime: '2024-06-01T13:11:18+05:30'
slug: usable-horizontal-scrollbars-in-the-django-admin-for-mouse-users
tags:
- /
- django
- python
...
- git
- web
title: Usable horizontal scrollbars in the Django admin for mouse users
---
