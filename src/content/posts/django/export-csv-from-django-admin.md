...
author: Anubhav Gain
category: django
description: I wanted to add an action option to the Django Admin for exporting the
  currently selected set of rows (or every row in the table) as a CSV file.
draft: false
featured: false
lang: en
pubDatetime: '2024-05-26T12:15:01+05:30'
slug: django-admin-action-for-exporting-selected-rows-as-csv
tags:
- /
- django
- python
- database
- web
title: Django Admin action for exporting selected rows as CSV
---
