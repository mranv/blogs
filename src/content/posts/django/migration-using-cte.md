...
author: Anubhav Gain
category: django
description: I figured out how to use a PostgreSQL CTE as part of an update statement
  in a Django data migration. The trick here is mainly understanding how to ...
draft: false
featured: false
lang: en
pubDatetime: '2024-03-25T22:31:54+05:30'
slug: django-data-migration-using-a-postgresql-cte
tags:
- /
- django
- python
- database
title: Django data migration using a PostgreSQL CTE
---
