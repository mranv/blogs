...
author: Anubhav Gain
category: duckdb
description: '[pickapic.io](https://pickapic.io/) is a new tool funded by [stability.ai](https://stability.ai/)
  which asks people to generate and then vote on im...'
draft: false
featured: false
lang: en
pubDatetime: '2024-06-05T15:08:51+05:30'
slug: use-duckdb-to-convert-parquet-to-json-and-then-open-it-in-datasette-lite
tags:
- /
- duckdb
- python
...
- database
- web
title: Use DuckDB to convert parquet to JSON and then open it in Datasette Lite
---
