...
author: Anubhav Gain
category: duckdb
description: Did a quick experiment with [DuckDB](https://duckdb.org/) today, inspired
  by the [bmschmidt/hathi-binary](https://github.com/bmschmidt/hathi-binary...
draft: false
featured: false
lang: en
pubDatetime: '2024-08-20T08:11:51+05:30'
slug: using-duckdb-in-python-to-access-parquet-data
tags:
- /
- duckdb
- python
- git
- web
title: Using DuckDB in Python to access Parquet data
---
