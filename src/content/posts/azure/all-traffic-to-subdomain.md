...
author: Anubhav Gain
category: azure
description: '[Azure Functions](https://docs.microsoft.com/en-us/azure/azure-functions/)
  default to serving traffic from a path like `/api/FunctionName` - for ex...'
draft: false
featured: false
lang: en
pubDatetime: '2024-08-04T22:12:21+05:30'
slug: writing-an-azure-function-that-serves-all-traffic-to-a-subdomain
tags:
- /
- azure
- javascript
- git
- web
title: Writing an Azure Function that serves all traffic to a subdomain
---
