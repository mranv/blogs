...
author: Anubhav Gain
category: zeit-now
description: I wanted to redirect all traffic to `https://something.vercel.app/` to
  a different domain - preserving the path and the querystring and serving a 3...
draft: false
featured: false
lang: en
pubDatetime: '2024-12-08T09:57:07+05:30'
slug: redirecting-all-paths-on-a-vercel-instance
tags:
- /
- zeit-now
- javascript
- git
- web
title: Redirecting all paths on a Vercel instance
---
