...
author: Anubhav Gain
category: git
description: I wanted to start [a new git repository](https://github.com/simonw/graphql-scraper/tree/828a1efc4307cca6cd378c394c2d33eac2eceb52)
  containing just t...
draft: false
featured: false
lang: en
pubDatetime: '2024-04-01T10:29:26+05:30'
slug: rewriting-a-repo-to-contain-the-history-of-just-specific-files
tags:
- /
- git
- python
- web
title: Rewriting a repo to contain the history of just specific files
---
