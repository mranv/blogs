...
author: Anubhav Gain
category: git
description: I wanted to know how large the [deepseek-ai/DeepSeek-V3-Base](https://huggingface.co/deepseek-ai/DeepSeek-V3-Base)
  repo on Hugging Face was without...
draft: false
featured: false
lang: en
pubDatetime: '2024-05-06T16:05:34+05:30'
slug: calculating-the-size-of-all-lfs-files-in-a-repo
tags:
- /
- git
- aws
- web
- cli
title: Calculating the size of all LFS files in a repo
---
