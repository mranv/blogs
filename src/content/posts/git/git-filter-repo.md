...
author: Anubhav Gain
category: git
description: After rebasing a branch with 60+ commits onto `main` I was disappointed
  to see that the commit dates on the commits (which are a different thing fr...
draft: false
featured: false
lang: en
pubDatetime: '2024-05-07T14:25:06+05:30'
slug: using-git-filter-repo-to-set-commit-dates-to-author-dates
tags:
- /
- git
- python
- web
- cli
title: Using git-filter-repo to set commit dates to author dates
---
