...
author: Anubhav Gain
category: git
description: I figured this out in [a Gist in 2016](https://gist.github.com/simonw/a44af92b4b255981161eacc304417368)
  which has attracted a bunch of comments ove...
draft: false
featured: false
lang: en
pubDatetime: '2024-06-23T19:44:49+05:30'
slug: how-to-create-a-tarball-of-a-git-repository-using-git-archive
tags:
- /
- git
- web
- testing
title: How to create a tarball of a git repository using "git archive"
---
