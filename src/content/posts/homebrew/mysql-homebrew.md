...
author: Anubhav Gain
category: homebrew
description: 'First, install MySQL like so:'
draft: false
featured: false
lang: en
pubDatetime: '2024-02-10T14:49:25+05:30'
slug: running-a-mysql-server-using-homebrew
tags:
- /
- homebrew
- python
- database
title: Running a MySQL server using Homebrew
---
