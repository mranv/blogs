...
author: Anubhav Gain
category: homebrew
description: 'I made a pleasant discovery today: Homebrew are very quick to update
  to the latest SQLite release (here''s [their formula](https://github.com/Homebr...'
draft: false
featured: false
lang: en
pubDatetime: '2024-06-18T11:38:16+05:30'
slug: running-the-latest-sqlite-in-datasette-using-homebrew
tags:
- /
- homebrew
- javascript
...
- web
- testing
title: Running the latest SQLite in Datasette using Homebrew
---
