...
author: Anubhav Gain
category: homebrew
description: I previously wrote about [Packaging a Python CLI tool for Homebrew](https://til.simonwillison.net/homebrew/packaging-python-cli-for-homebrew).
  I've...
draft: false
featured: false
lang: en
pubDatetime: '2024-03-15T11:16:20+05:30'
slug: automatically-maintaining-homebrew-formulas-using-github-actions
tags:
- /
- homebrew
- python
...
- cli
- testing
title: Automatically maintaining Homebrew formulas using GitHub Actions
---
