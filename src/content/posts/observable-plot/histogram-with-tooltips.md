---
author: Anubhav Gain
category: observable-plot
description: Given an array of datetime objects, I wanted to plot a histogram. But
  I wanted to automatically pick a bucket size for that histogram that resulted...
draft: false
featured: false
lang: en
pubDatetime: '2024-06-22T20:47:47+05:30'
slug: histogram-with-tooltips-in-observable-plot
tags:
- /
- observable-plot
- javascript
- git
- web
title: Histogram with tooltips in Observable Plot
---
