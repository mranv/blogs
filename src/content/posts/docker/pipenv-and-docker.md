...
author: Anubhav Gain
category: docker
description: I had [a Django project](https://github.com/natbat/cbwg) that used `pipenv`
  (in particular a `Pipfile.lock`) to manage dependencies and I wanted to...
draft: false
featured: false
lang: en
pubDatetime: '2024-01-20T13:54:57+05:30'
slug: using-pipenv-and-docker
tags:
- /
- docker
- python
