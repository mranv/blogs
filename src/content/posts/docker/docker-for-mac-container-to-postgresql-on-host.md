...
author: Anubhav Gain
category: docker
description: I like using [Postgres.app](https://postgresapp.com/) to run PostgreSQL
  on my macOS laptop. I use it for a bunch of different projects.
draft: false
featured: false
lang: en
pubDatetime: '2024-08-18T14:51:34+05:30'
slug: allowing-a-container-in-docker-desktop-for-mac-to-talk-to-a-postgresql-server-on-the-host-machine
tags:
- /
- docker
- python
...
- web
- testing
title: Allowing a container in Docker Desktop for Mac to talk to a PostgreSQL server
  on the host machine
---
