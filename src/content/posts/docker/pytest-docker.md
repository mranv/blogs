...
author: Anubhav Gain
category: docker
description: 'For [datasette issue #1802](https://github.com/simonw/datasette/issues/1802)
  I needed to run my `pytest` test suite using a specific version of Pyt...'
draft: false
featured: false
lang: en
pubDatetime: '2024-07-02T20:43:00+05:30'
slug: run-pytest-against-a-specific-python-version-using-docker
tags:
- /
- docker
- python
...
- cli
- testing
title: Run pytest against a specific Python version using Docker
---
