...
author: Anubhav Gain
category: docker
description: 'For [Datasette #1249](https://github.com/simonw/datasette/issues/1249)
  I wanted to build a Docker image from the `python:3.9.2-slim-buster` base im...'
draft: false
featured: false
lang: en
pubDatetime: '2024-07-12T14:58:52+05:30'
slug: installing-packages-from-debian-unstable-in-a-docker-image-based-on-stable
tags:
- /
- docker
- python
...
- web
- testing
title: Installing packages from Debian unstable in a Docker image based on stable
---
