...
author: Anubhav Gain
category: datasette
description: I'm experimenting with a Datasette plugin that itself adds new plugin
  hooks which other plugins can then interact with.
draft: false
featured: false
lang: en
pubDatetime: '2024-08-13T18:12:58+05:30'
slug: registering-new-datasette-plugin-hooks-by-defining-them-in-other-plugins
tags:
- /
- datasette
- python
- git
- web
title: Registering new Datasette plugin hooks by defining them in other plugins
---
