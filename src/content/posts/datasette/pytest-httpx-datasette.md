...
author: Anubhav Gain
category: datasette
description: I've been working on a tool called [dclient](https://github.com/simonw/dclient)
  which is a CLI client tool for talking to Datasette instances.
draft: false
featured: false
lang: en
pubDatetime: '2024-06-09T08:48:48+05:30'
slug: using-pytest-httpx-to-run-intercepted-requests-through-an-in-memory-datasette-instance
tags:
- /
- datasette
- python
...
- cli
- testing
title: Using pytest-httpx to run intercepted requests through an in-memory Datasette
  instance
---
