...
author: Anubhav Gain
category: datasette
description: The [MBTiles](https://github.com/mapbox/mbtiles-spec) format uses SQLite
  to bundle map tiles for use with libraries such as Leaflet.
draft: false
featured: false
lang: en
pubDatetime: '2024-08-15T12:15:53+05:30'
slug: serving-mbtiles-with-datasette-media
tags:
- /
- datasette
- git
- database
- web
title: Serving MBTiles with datasette-media
---
