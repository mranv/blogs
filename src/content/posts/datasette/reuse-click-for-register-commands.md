...
author: Anubhav Gain
category: datasette
description: The [register_commands](https://docs.datasette.io/en/stable/plugin_hooks.html#register-commands-cli)
  plugin hook lets you add extra sub-commands to...
draft: false
featured: false
lang: en
pubDatetime: '2024-04-15T09:31:28+05:30'
slug: reusing-an-existing-click-tool-with-register_commands
tags:
- /
- datasette
- python
...
- database
- web
title: Reusing an existing Click tool with register_commands
---
