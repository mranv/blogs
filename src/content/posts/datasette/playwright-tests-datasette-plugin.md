...
author: Anubhav Gain
category: datasette
description: I really like [Playwright](https://playwright.dev/) for writing automated
  tests for web applications using a headless browser. It's pretty easy to ...
draft: false
featured: false
lang: en
pubDatetime: '2024-01-26T19:13:10+05:30'
slug: writing-playwright-tests-for-a-datasette-plugin
tags:
- /
- datasette
- python
...
- web
- cli
title: Writing Playwright tests for a Datasette Plugin
---
