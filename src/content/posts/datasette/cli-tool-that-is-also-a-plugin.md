...
author: Anubhav Gain
category: datasette
description: I'm working on [dclient](https://github.com/simonw/dclient), a CLI tool
  for interacting with Datasette instances via the Datasette API.
draft: false
featured: false
lang: en
pubDatetime: '2024-04-24T22:36:39+05:30'
slug: writing-a-cli-utility-that-is-also-a-datasette-plugin
tags:
- /
- datasette
- python
...
- web
- testing
title: Writing a CLI utility that is also a Datasette plugin
---
