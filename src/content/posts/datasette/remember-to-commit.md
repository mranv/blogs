...
author: Anubhav Gain
category: datasette
description: I was writing some code for [datasette-auth-tokens](https://github.com/simonw/datasette-auth-tokens)
  that used [db.execute_write_fn()](https://docs...
draft: false
featured: false
lang: en
pubDatetime: '2024-08-04T18:45:36+05:30'
slug: remember-to-commit-when-using-datasetteexecute_write_fn
tags:
- /
- datasette
- python
...
- web
- testing
title: Remember to commit when using datasette.execute_write_fn()
---
