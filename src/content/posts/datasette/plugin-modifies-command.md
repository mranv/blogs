...
author: Anubhav Gain
category: datasette
description: My new [datasette-gunicorn](https://datasette.io/plugins/datasette-gunicorn)
  plugin adds a new command to Datasette - `datasette gunicorn` - which ...
draft: false
featured: false
lang: en
pubDatetime: '2024-02-03T18:44:18+05:30'
slug: writing-a-datasette-cli-plugin-that-mostly-duplicates-an-existing-command
tags:
- /
- datasette
- python
