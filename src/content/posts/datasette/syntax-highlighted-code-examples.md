...
author: Anubhav Gain
category: datasette
description: I wanted to add syntax highlighting to the new tutorial [Data analysis
  with SQLite and Python](https://datasette.io/tutorials/data-analysis).
draft: false
featured: false
lang: en
pubDatetime: '2024-05-28T19:33:38+05:30'
slug: syntax-highlighted-code-examples-in-datasette
tags:
- /
- datasette
- python
...
- web
- cli
title: Syntax highlighted code examples in Datasette
---
