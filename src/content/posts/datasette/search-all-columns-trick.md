...
author: Anubhav Gain
category: datasette
description: I came up with this trick today, when I wanted to run a `LIKE` search
  against every column in a table.
draft: false
featured: false
lang: en
pubDatetime: '2024-07-23T08:40:24+05:30'
slug: searching-all-columns-of-a-table-in-datasette
tags:
- /
- datasette
- javascript
...
- web
- testing
title: Searching all columns of a table in Datasette
---
