...
author: Anubhav Gain
category: pluggy
description: I found myself wanting to register more than one instance of a [Pluggy](https://pluggy.readthedocs.io/)
  plugin hook inside a single module.
draft: false
featured: false
lang: en
pubDatetime: '2024-04-06T19:50:10+05:30'
slug: registering-the-same-pluggy-hook-multiple-times-in-a-single-file
tags:
- /
- pluggy
- python
...
- web
- testing
title: Registering the same Pluggy hook multiple times in a single file
---
