...
author: Anubhav Gain
category: jq
description: I wanted to take a nested set of JSON objects and import them into a
  SQLite database using `sqlite-utils insert` - but I wanted to "flatten" some o...
draft: false
featured: false
lang: en
pubDatetime: '2024-04-16T19:33:13+05:30'
slug: flattening-nested-json-objects-with-jq
tags:
- /
- jq
- javascript
...
- web
- cli
title: Flattening nested JSON objects with jq
---
