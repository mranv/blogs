...
author: Anubhav Gain
category: jq
description: I just spent way too long messing around with ChatGPT ([transcript here](https://gist.github.com/simonw/c3b486fa90d7c32a0e8dfb47e151090a))
  trying t...
draft: false
featured: false
lang: en
pubDatetime: '2024-03-09T18:21:02+05:30'
slug: convert-git-log-output-to-json-using-jq
tags:
- /
- jq
- python
...
- web
- cli
title: Convert git log output to JSON using jq
---
