...
author: Anubhav Gain
category: mastodon
description: I've been playing around with [the Mastodon timelines API](https://docs.joinmastodon.org/methods/timelines/).
  It's pretty fun!
draft: false
featured: false
lang: en
pubDatetime: '2024-08-22T16:48:41+05:30'
slug: export-a-mastodon-timeline-to-sqlite
tags:
- /
- mastodon
- javascript
...
- database
- web
title: Export a Mastodon timeline to SQLite
---
