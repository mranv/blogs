...
author: Anubhav Gain
category: markdown
description: If you copy and paste from a web page - including a full table - into
  a GitHub issue comment GitHub converts it to the corresponding Markdown for y...
draft: false
featured: false
lang: en
pubDatetime: '2024-06-04T10:40:23+05:30'
slug: converting-html-and-rich-text-to-markdown
tags:
- /
- markdown
- javascript
- git
- web
title: Converting HTML and rich-text to Markdown
---
