...
author: Anubhav Gain
category: markdown
description: I wanted to convert the Markdown used in my TILs to HTML, using the exact
  same configuration as GitHub does. GitHub has a whole load of custom exte...
draft: false
featured: false
lang: en
pubDatetime: '2024-05-13T18:04:40+05:30'
slug: rendering-markdown-with-the-github-markdown-api
tags:
- /
- markdown
- python
...
- git
- web
title: Rendering Markdown with the GitHub Markdown API
---
