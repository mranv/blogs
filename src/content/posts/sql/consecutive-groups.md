...
author: Anubhav Gain
category: sql
description: I have a database table with all of my Swarm checkins since 2011, created
  using my [swarm-to-sqlite](https://datasette.io/tools/swarm-to-sqlite) tool.
draft: false
featured: false
lang: en
pubDatetime: '2024-05-14T17:34:00+05:30'
slug: consecutive-groups-in-sql-using-window-functions
tags:
- /
- sql
- git
...
- web
- testing
title: Consecutive groups in SQL using window functions
---
