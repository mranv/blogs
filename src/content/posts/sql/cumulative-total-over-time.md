...
author: Anubhav Gain
category: sql
description: This is a quick trick for creating a cumulative chart of the total number
  of items created over time based just on their creation date.
draft: false
featured: false
lang: en
pubDatetime: '2024-03-02T13:19:17+05:30'
slug: cumulative-total-over-time-in-sql
tags:
- /
- sql
- git
- database
- web
title: Cumulative total over time in SQL
---
