...
author: Anubhav Gain
category: pytest
description: For both [s3-credentials](https://github.com/simonw/s3-credentials) and
  [datasette-publish-fly](https://github.com/simonw/datasette-publish-fly) I ...
draft: false
featured: false
lang: en
pubDatetime: '2024-05-08T22:52:50+05:30'
slug: opt-in-integration-tests-with-pytest-integration
tags:
- /
- pytest
- python
...
- web
- testing
title: Opt-in integration tests with pytest --integration
---
