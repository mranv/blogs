...
author: Anubhav Gain
category: pytest
description: While [working on this issue](https://github.com/simonw/datasette/issues/2461)
  I figured out a neat pattern for running the tests for my project lo...
draft: false
featured: false
lang: en
pubDatetime: '2024-04-06T10:10:26+05:30'
slug: running-pytest-against-a-specific-python-version-with-uv-run
tags:
- /
- pytest
- python
...
- cli
- testing
title: Running pytest against a specific Python version with uv run
---
