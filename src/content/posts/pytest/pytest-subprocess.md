...
author: Anubhav Gain
category: pytest
description: For [apple-notes-to-sqlite](https://github.com/dogsheep/apple-notes-to-sqlite)
  I needed to write some tests that simulated executing the `osascript...
draft: false
featured: false
lang: en
pubDatetime: '2024-06-19T22:03:39+05:30'
slug: mocking-subprocess-with-pytest-subprocess
tags:
- /
- pytest
- python
...
- web
- testing
title: Mocking subprocess with pytest-subprocess
---
