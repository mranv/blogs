...
author: Anubhav Gain
category: pytest
description: I wanted to start an actual server process, run it for the duration of
  my pytest session and shut it down at the end.
draft: false
featured: false
lang: en
pubDatetime: '2024-07-19T22:09:46+05:30'
slug: start-a-server-in-a-subprocess-during-a-pytest-session
tags:
- /
- pytest
- python
...
- web
- testing
title: Start a server in a subprocess during a pytest session
---
