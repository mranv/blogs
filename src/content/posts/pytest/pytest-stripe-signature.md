...
author: Anubhav Gain
category: pytest
description: I'm writing some code that accepts webhooks from Stripe. I wanted to
  simulate hits to this endpoint in my Django tests. Stripe uses a `Stripe-Signa...
draft: false
featured: false
lang: en
pubDatetime: '2024-01-16T11:03:05+05:30'
slug: mocking-stripe-signature-checks-in-a-pytest-fixture
tags:
- /
- pytest
- python
...
- web
- testing
title: Mocking Stripe signature checks in a pytest fixture
---
