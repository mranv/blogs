...
author: Anubhav Gain
category: pytest
description: For [sqlite-utils#364](https://github.com/simonw/sqlite-utils/issues/364)
  I needed to write a test for a [Click](https://click.palletsprojects.com/...
draft: false
featured: false
lang: en
pubDatetime: '2024-05-12T10:48:41+05:30'
slug: testing-a-click-app-with-streaming-input
tags:
- /
- pytest
- python
...
- web
- testing
title: Testing a Click app with streaming input
---
