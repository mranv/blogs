...
author: Anubhav Gain
category: pytest
description: My test suite for [Datasette](https://github.com/simonw/datasette) has
  grown so large that running the whole thing sometimes causes me to run out o...
draft: false
featured: false
lang: en
pubDatetime: '2024-03-06T14:32:29+05:30'
slug: show-files-opened-by-pytest-tests
tags:
- /
- pytest
- python
...
- web
- testing
title: Show files opened by pytest tests
---
