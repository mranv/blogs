...
author: Anubhav Gain
category: pytest
description: I usually build command-line tools using [Click](https://click.palletsprojects.com/)
  (and my [click-app](https://github.com/simonw/click-app) cooki...
draft: false
featured: false
lang: en
pubDatetime: '2024-07-18T19:28:18+05:30'
slug: writing-pytest-tests-against-tools-written-with-argparse
tags:
- /
- pytest
- python
...
- web
- testing
title: Writing pytest tests against tools written with argparse
---
