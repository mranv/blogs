...
author: Anubhav Gain
category: pytest
description: I [decided to add](https://github.com/simonw/datasette-lite/issues/35)
  automated tests to my [Datasette Lite](https://simonwillison.net/2022/May/4/...
draft: false
featured: false
lang: en
pubDatetime: '2024-04-02T09:22:10+05:30'
slug: using-pytest-and-playwright-to-test-a-javascript-web-application
tags:
- /
- pytest
- python
...
- web
- testing
title: Using pytest and Playwright to test a JavaScript web application
---
