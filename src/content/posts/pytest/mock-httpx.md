...
author: Anubhav Gain
category: pytest
description: I wrote this test to exercise some [httpx](https://pypi.org/project/httpx/)
  code today, using [pytest-mock](https://pypi.org/project/pytest-mock/).
draft: false
featured: false
lang: en
pubDatetime: '2024-06-20T14:27:03+05:30'
slug: how-to-mock-httpx-using-pytest-mock
tags:
- /
- pytest
- python
...
- web
- testing
title: How to mock httpx using pytest-mock
---
