...
author: Anubhav Gain
category: pytest
description: '[pytest-recording](https://github.com/kiwicom/pytest-recording) is a
  neat pytest plugin that makes it easy to use the [VCR library](https://vcrpy.r...'
draft: false
featured: false
lang: en
pubDatetime: '2024-05-06T10:04:23+05:30'
slug: using-vcr-and-pytest-with-pytest-recording
tags:
- /
- pytest
- python
...
- cli
- testing
title: Using VCR and pytest with pytest-recording
---
