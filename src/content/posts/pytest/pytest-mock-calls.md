...
author: Anubhav Gain
category: pytest
description: I needed to write a test that checked for a really complex sequence of
  mock calls for [s3-credentials#3](https://github.com/simonw/s3-credentials/i...
draft: false
featured: false
lang: en
pubDatetime: '2024-08-15T18:17:42+05:30'
slug: quick-and-dirty-mock-testing-with-mock_calls
tags:
- /
- pytest
- python
...
- web
- testing
title: Quick and dirty mock testing with mock_calls
---
