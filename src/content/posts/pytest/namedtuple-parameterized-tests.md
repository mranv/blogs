...
author: Anubhav Gain
category: pytest
description: I'm writing some quite complex [pytest]() parameterized tests this morning,
  and I was finding it a little bit hard to read the test cases as the nu...
draft: false
featured: false
lang: en
pubDatetime: '2024-07-27T15:26:53+05:30'
slug: using-namedtuple-for-pytest-parameterized-tests
tags:
- /
- pytest
- python
...
- web
- testing
title: Using namedtuple for pytest parameterized tests
---
