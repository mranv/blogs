...
author: Anubhav Gain
category: pytest
description: 'For [s3-ocr issue #21](https://github.com/simonw/s3-ocr/issues/21) I
  needed to write a test that simulates what happens when Amazon Textract return...'
draft: false
featured: false
lang: en
pubDatetime: '2024-05-18T22:08:00+05:30'
slug: mocking-a-textract-limitexceededexception-with-boto
tags:
- /
- pytest
- python
...
- web
- testing
title: Mocking a Textract LimitExceededException with boto
---
