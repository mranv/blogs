...
author: Anubhav Gain
category: bash
description: I wanted to write a bash script that would start a Datasette server running,
  run a request against it using `curl`, then stop the server again.
draft: false
featured: false
lang: en
pubDatetime: '2024-01-22T13:42:18+05:30'
slug: start-test-then-stop-a-localhost-web-server-in-a-bash-script
tags:
- /
- bash
- python
...
- cli
- testing
title: Start, test, then stop a localhost web server in a Bash script
---
