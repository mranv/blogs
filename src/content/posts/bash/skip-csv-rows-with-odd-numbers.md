...
author: Anubhav Gain
category: bash
description: 'I''m working with several huge CSV files - over 5 million rows total
  - and I ran into a problem: it turned out there were a few lines in those files...'
draft: false
featured: false
lang: en
pubDatetime: '2024-02-22T10:14:57+05:30'
slug: skipping-csv-rows-with-odd-numbers-of-quotes-using-ripgrep
tags:
- /
- bash
- database
- web
- cli
title: Skipping CSV rows with odd numbers of quotes using ripgrep
---
