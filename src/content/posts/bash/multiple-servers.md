...
author: Anubhav Gain
category: bash
description: I spotted [this script](https://github.com/varunshenoy/opendream/blob/main/run_opendream.sh)
  that starts the [opendream](https://github.com/varunsh...
draft: false
featured: false
lang: en
pubDatetime: '2024-02-06T10:49:01+05:30'
slug: running-multiple-servers-in-a-single-bash-script
tags:
- /
- bash
- python
