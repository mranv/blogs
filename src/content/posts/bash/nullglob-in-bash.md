...
author: Anubhav Gain
category: bash
description: 'I ran into a tricky problem while working [on this issue](https://github.com/simonw/datasette-publish-fly/issues/17):
  the following line was behavi...'
draft: false
featured: false
lang: en
pubDatetime: '2024-04-10T22:02:12+05:30'
slug: nullglob-in-bash
tags:
- /
- bash
- javascript
