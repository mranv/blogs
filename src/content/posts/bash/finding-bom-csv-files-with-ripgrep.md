...
author: Anubhav Gain
category: bash
description: For [sqlite-utils issue 250](https://github.com/simonw/sqlite-utils/issues/250)
  I needed to locate some test CSV files that start with a UTF-8 BOM.
draft: false
featured: false
lang: en
pubDatetime: '2024-03-31T16:42:21+05:30'
slug: finding-csv-files-that-start-with-a-bom-using-ripgrep
tags:
- /
- bash
- git
