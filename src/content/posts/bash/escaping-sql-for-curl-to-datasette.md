...
author: Anubhav Gain
category: bash
description: I used this pattern to pass a SQL query to Datasette's CSV export via
  curl and output the results, stripping off the first row (the header row) usi...
draft: false
featured: false
lang: en
pubDatetime: '2024-02-16T21:15:56+05:30'
slug: escaping-a-sql-query-to-use-with-curl-and-datasette
tags:
- /
- bash
- python
...
- web
- cli
title: Escaping a SQL query to use with curl and Datasette
---
