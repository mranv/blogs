...
author: Anubhav Gain
category: bash
description: '[bitfield/script](https://github.com/bitfield/script) is a really neat
  Go project: it tries to emulate shell scripting using Go chaining primitives...'
draft: false
featured: false
lang: en
pubDatetime: '2024-05-03T16:42:06+05:30'
slug: a-shell-script-for-running-go-one-liners
tags:
- /
- bash
- git
- web
- cli
title: A shell script for running Go one-liners
---
