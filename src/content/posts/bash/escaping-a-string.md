...
author: Anubhav Gain
category: bash
description: TIL this trick, [via Pascal Hirsch](https://twitter.com/phphys/status/1311727268398465029)
  on Twitter. Enter a line of Bash starting with a `#` com...
draft: false
featured: false
lang: en
pubDatetime: '2024-04-08T16:51:04+05:30'
slug: escaping-strings-in-bash-using-q
tags:
- /
- bash
- web
