...
author: Anubhav Gain
category: cloudflare
description: I got an unexpected traffic spike to https://russian-ira-facebook-ads.datasettes.com/
  - which runs on Cloud Run - and decided to use `robots.txt` t...
draft: false
featured: false
lang: en
pubDatetime: '2024-10-06T17:54:17+05:30'
slug: adding-a-robotstxt-using-cloudflare-workers
tags:
- /
- cloudflare
- javascript
- git
- web
title: Adding a robots.txt using Cloudflare workers
---
