...
author: Anubhav Gain
category: cloudflare
description: My [blog](https://simonwillison.net/) was showing poor performance, with
  some pages taking several seconds to load or even failing entirely.
draft: false
featured: false
lang: en
pubDatetime: '2024-03-17T16:58:34+05:30'
slug: rate-limiting-by-ip-using-cloudflares-rate-limiting-rules
tags:
- /
- cloudflare
- python
- web
title: Rate limiting by IP using Cloudflare's rate limiting rules
---
