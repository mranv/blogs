...
author: Anubhav Gain
category: npm
description: Jake Archibald [pointed to](https://twitter.com/jaffathecake/status/1491771402294370306)
  his `package.json` for `idb-keyval` as a "modernish exampl...
draft: false
featured: false
lang: en
pubDatetime: '2024-08-21T20:34:53+05:30'
slug: annotated-packagejson-for-idb-keyval
tags:
- /
- npm
- javascript
- git
- web
title: Annotated package.json for idb-keyval
---
