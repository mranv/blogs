...
author: Anubhav Gain
category: npm
description: I want to try using [QuickJS](https://bellard.org/quickjs/) compiled
  to WebAssembly in a browser as a way of executing untrusted user-provided Java...
draft: false
featured: false
lang: en
pubDatetime: '2024-02-14T09:46:21+05:30'
slug: running-self-hosted-quickjs-in-a-browser
tags:
- /
- npm
- python
...
- cli
- testing
title: Running self-hosted QuickJS in a browser
---
