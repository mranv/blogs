...
author: Anubhav Gain
category: npm
description: Here's what I learned about publishing a single file JavaScript package
  to NPM for my [Prompts.js](https://simonwillison.net/2024/Dec/7/prompts-js/...
draft: false
featured: false
lang: en
pubDatetime: '2024-08-31T11:35:11+05:30'
slug: publishing-a-simple-client-side-javascript-package-to-npm-with-github-actions
tags:
- /
- npm
- python
