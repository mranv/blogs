...
description: Inspired [by Armin](https://simonwillison.net/2025/Jun/29/agentic-coding/),
  I decided to figure out how to use the official [microsoft/playwright-m...
draft: false
featured: false
lang: en
pubDatetime: '2024-10-24T19:49:48+05:30'
slug: using-playwright-mcp-with-claude-code
tags:
- /
- claude-code
- javascript
