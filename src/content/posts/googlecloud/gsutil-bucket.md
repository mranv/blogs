...
description: I decided to publish static CSV files to accompany my https://cdc-vaccination-history.datasette.io/
  project, using a Google Cloud bucket (see [cdc-...
draft: false
featured: false
lang: en
pubDatetime: '2024-06-22T17:36:57+05:30'
slug: publishing-to-a-public-google-cloud-bucket-with-gsutil
tags:
- /
- googlecloud
- git
- web
title: Publishing to a public Google Cloud bucket with gsutil
---
