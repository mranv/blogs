...
description: For [google-drive-to-sqlite](https://github.com/simonw/google-drive-to-sqlite)
  I wanted a mechanism to recursively return metadata on every file in...
draft: false
featured: false
lang: en
pubDatetime: '2024-04-05T18:49:40+05:30'
slug: recursively-fetching-metadata-for-all-files-in-a-google-drive-folder
tags:
- /
- googlecloud
- python
...
- database
- web
title: Recursively fetching metadata for all files in a Google Drive folder
---
