...
description: I was asked if there was a way to run [shot-scraper](https://github.com/simonw/shot-scraper)
  against a list of URLs in a Google Sheet.
draft: false
featured: false
lang: en
pubDatetime: '2024-01-15T11:11:48+05:30'
slug: concatenating-strings-and-newlines-in-google-sheets
tags:
- /
- google-sheets
- python
- git
- web
title: Concatenating strings and newlines in Google Sheets
---
