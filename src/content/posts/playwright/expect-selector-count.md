...
author: Anubhav Gain
category: playwright
description: In the Playwright tests for [datasette-cluster-map](https://github.com/simonw/datasette-cluster-map)
  I wanted to assert that two markers had been d...
draft: false
featured: false
lang: en
pubDatetime: '2024-08-02T09:04:42+05:30'
slug: using-expect-to-wait-for-a-selector-to-match-multiple-items
tags:
- /
- playwright
- python
...
- web
- testing
title: Using expect() to wait for a selector to match multiple items
---
