...
author: Anubhav Gain
category: javascript
description: I needed this for [VIAL issue 722](https://github.com/CAVaccineInventory/vial/issues/722).
  I decided to disable form submissions for two seconds af...
draft: false
featured: false
lang: en
pubDatetime: '2024-05-29T18:44:24+05:30'
slug: preventing-double-form-submissions-with-javascript
tags:
- /
- javascript
- python
- git
- web
title: Preventing double form submissions with JavaScript
---
