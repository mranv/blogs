...
author: Anubhav Gain
category: javascript
description: TIL that `nodeValue` in the DOM has a size limit!
draft: false
featured: false
lang: en
pubDatetime: '2024-04-09T10:47:17+05:30'
slug: working-around-the-size-limit-for-nodevalue-in-the-dom
tags:
- /
- javascript
- git
- web
title: Working around the size limit for nodeValue in the DOM
---
