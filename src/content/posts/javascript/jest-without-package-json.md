...
author: Anubhav Gain
category: javascript
description: I wanted to try out [Jest](https://jestjs.io/) for writing JavaScript
  unit tests, in a project that wasn't set up with `package.json` and other NPM...
draft: false
featured: false
lang: en
pubDatetime: '2024-03-16T13:58:40+05:30'
slug: using-jest-without-a-packagejson
tags:
- /
- javascript
- web
- testing
title: Using Jest without a package.json
---
