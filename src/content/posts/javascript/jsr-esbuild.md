...
author: Anubhav Gain
category: javascript
description: '[JSR](https://jsr.io/) is a brand new package repository for "modern
  JavaScript and TypeScript", [launched on March 1st](https://deno.com/blog/jsr_...'
draft: false
featured: false
lang: en
pubDatetime: '2024-08-01T11:20:26+05:30'
slug: using-packages-from-jsr-with-esbuild
tags:
- /
- javascript
- git
- web
- cli
title: Using packages from JSR with esbuild
---
