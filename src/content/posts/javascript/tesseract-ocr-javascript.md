...
author: Anubhav Gain
category: javascript
description: Pasting this code into a DevTools console should load [Tesseract.js](https://github.com/naptha/tesseract.js)
  from a CDN, loop through every image l...
draft: false
featured: false
lang: en
pubDatetime: '2024-04-24T09:18:10+05:30'
slug: using-tesseractjs-to-ocr-every-image-on-a-page
tags:
- /
- javascript
- git
- web
title: Using Tesseract.js to OCR every image on a page
---
