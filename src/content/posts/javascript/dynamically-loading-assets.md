...
author: Anubhav Gain
category: javascript
description: For [datasette-leaflet-geojson](https://github.com/simonw/datasette-leaflet-geojson)
  I wanted to dynamically load some external CSS and JavaScript ...
draft: false
featured: false
lang: en
pubDatetime: '2024-08-02T15:25:07+05:30'
slug: dynamically-loading-multiple-assets-with-a-callback
tags:
- /
- javascript
- python
- git
- web
title: Dynamically loading multiple assets with a callback
---
