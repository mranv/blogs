...
author: Anubhav Gain
category: javascript
description: While [upgrading CodeMirror](https://github.com/simonw/datasette/issues/948)
  in Datasette I figured out how to minify JavaScript using `uglify-js` ...
draft: false
featured: false
lang: en
pubDatetime: '2024-01-16T08:47:53+05:30'
slug: minifying-javascript-with-npx-uglify-js
tags:
- /
- javascript
- git
- web
- cli
title: Minifying JavaScript with npx uglify-js
---
