...
author: Anubhav Gain
category: javascript
description: I wanted to change the layout of [my blog](https://simonwillison.net/)
  on mobile screens such that the content from the "Elsewhere" right hand colu...
draft: false
featured: false
lang: en
pubDatetime: '2024-02-16T09:46:01+05:30'
slug: writing-javascript-that-responds-to-media-queries
tags:
- /
- javascript
- git
- web
title: Writing JavaScript that responds to media queries
---
