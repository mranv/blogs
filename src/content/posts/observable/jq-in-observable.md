...
author: Anubhav Gain
category: observable
description: I use the `jq` language quite a lot these days, mainly because I can
  get ChatGPT to write little JSON transformation programs for me very quickly.
draft: false
featured: false
lang: en
pubDatetime: '2024-06-24T14:46:07+05:30'
slug: using-jq-in-an-observable-notebook
tags:
- /
- observable
- javascript
- web
title: Using jq in an Observable notebook
---
