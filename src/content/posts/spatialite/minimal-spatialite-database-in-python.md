...
author: Anubhav Gain
category: spatialite
description: When writing a test for [datasette-leaflet-freedraw](https://github.com/simonw/datasette-leaflet-freedraw)
  I realized I didn't have a simple tiny r...
draft: false
featured: false
lang: en
pubDatetime: '2024-07-08T13:18:07+05:30'
slug: creating-a-minimal-spatialite-database-with-python
tags:
- /
- spatialite
- python
...
- web
- testing
title: Creating a minimal SpatiaLite database with Python
---
