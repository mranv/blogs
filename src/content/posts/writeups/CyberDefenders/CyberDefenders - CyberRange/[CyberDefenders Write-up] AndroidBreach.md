...
![1dee642fbeae751fed3d8c274c09d41a.png](assets/resources-writeups1dee642fbeae751fed3d8c274c09d41a.png)

We have the whole files exported (or can we call it disk image?) from an Android phone as our evidence here.

![7d16bbcd76f253437421f50f6c8f27a7.png](assets/resources-writeups7d16bbcd76f253437421f50f6c8f27a7.png)
...
![fcecd23be79669aa685288a6cf48bcd3.png](assets/resources-writeupsfcecd23be79669aa685288a6cf48bcd3.png)
...
![4339af4f0055b12e4e21402d810ca97f.png](assets/resources-writeups4339af4f0055b12e4e21402d810ca97f.png)

After parsing process is completed, we can click "Open Report & Close" to open HTML report and close ALEAPP application.

![a09321b0ec7fa6c249ccf4bbcfff7944.png](assets/resources-writeupsa09321b0ec7fa6c249ccf4bbcfff7944.png)

Now after opened the report, we can see that we are investigating the disk image of Galaxy S4.

![f6843e8cc417434fdeb48a90fd78dbcc.png](assets/resources-writeupsf6843e8cc417434fdeb48a90fd78dbcc.png)
...
![ffd7120c5a69dda57e50f1428b75858b.png](assets/resources-writeupsffd7120c5a69dda57e50f1428b75858b.png)
...
![7468d6c8820260363d3accf8ab5972d0.png](assets/resources-writeups7468d6c8820260363d3accf8ab5972d0.png)
...
![d5bd5657cda76770c20466edd52c5f9c.png](assets/resources-writeupsd5bd5657cda76770c20466edd52c5f9c.png)

Now we have to decompile the APK with Jadx tool which is a tool that can decompile JAVA-compiled file including APK file.

![f0fffaaf82e290e744c39f4d8f5f8096.png](assets/resources-writeupsf0fffaaf82e290e744c39f4d8f5f8096.png)
...
![f42ddf6516fc70ab9a6b26b7ff088ef8.png](assets/resources-writeupsf42ddf6516fc70ab9a6b26b7ff088ef8.png)
...
![3cbb585c503b9c36eeba62613afeb56a.png](assets/resources-writeups3cbb585c503b9c36eeba62613afeb56a.png)
...
![060d1c52547b620bab321ec537d17552.png](assets/resources-writeups060d1c52547b620bab321ec537d17552.png)
...
![c1b52d63586966b09840fcee04d96161.png](assets/resources-writeupsc1b52d63586966b09840fcee04d96161.png)

Knowing the filename, make it's easier to find so we can open any of them to get the answer of this question.  

![b203988f6c8c32332973c59c5c6c3552.png](assets/resources-writeupsb203988f6c8c32332973c59c5c6c3552.png)
...
![f41fc9aac86f17fcc521e3352d41a997.png](assets/resources-writeupsf41fc9aac86f17fcc521e3352d41a997.png)
...
![0ee9cb54cd160a2d47b66065760f394d.png](assets/resources-writeups0ee9cb54cd160a2d47b66065760f394d.png)
...
![84dc816ff8074431bdad268d36b7d0b8.png](assets/resources-writeups84dc816ff8074431bdad268d36b7d0b8.png)
...
![c8980f0090e66e275ecbc90b312c079f.png](assets/resources-writeupsc8980f0090e66e275ecbc90b312c079f.png)
