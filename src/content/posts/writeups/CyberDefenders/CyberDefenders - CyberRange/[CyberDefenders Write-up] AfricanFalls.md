...
![9c295bd43c9b138d06afd35e1411132c.png](assets/resources-writeups9c295bd43c9b138d06afd35e1411132c.png)
...
![eb634436e2396a869f60e3f6a6ee6607.png](assets/resources-writeupseb634436e2396a869f60e3f6a6ee6607.png)
...
![4dad8b71b3ea3ae87deede76f059f370.png](assets/resources-writeups4dad8b71b3ea3ae87deede76f059f370.png)
Using ChromeHistoryView from NirSoft to parse all data
![2c075df83c15d539352586c7bbc0f4c0.png](assets/resources-writeups2c075df83c15d539352586c7bbc0f4c0.png)
...
![1448d37d68ff38eefcf17ef996209475.png](assets/resources-writeups1448d37d68ff38eefcf17ef996209475.png)	
...
![a6e54a6edb3898ce195f47e5d78c4cec.png](assets/resources-writeupsa6e54a6edb3898ce195f47e5d78c4cec.png)
...
![e6caaa67fdeb7cd65a84e16420cb7bc6.png](assets/resources-writeupse6caaa67fdeb7cd65a84e16420cb7bc6.png)
...
![2e5ee81f2a0c3109a18bf38aa074e8a4.png](assets/resources-writeups2e5ee81f2a0c3109a18bf38aa074e8a4.png)
...
![7f6fe386fb0668ca3296f63815ed34d6.png](assets/resources-writeups7f6fe386fb0668ca3296f63815ed34d6.png)
...
![9ed304d492c4310746a1b3a9a966caf0.png](assets/resources-writeups9ed304d492c4310746a1b3a9a966caf0.png)
...
![ad0c1ad170af19f5ba36d544e5585509.png](assets/resources-writeupsad0c1ad170af19f5ba36d544e5585509.png)
...
![8049e6c34237ff2b2e315720d493de5d.png](assets/resources-writeups8049e6c34237ff2b2e315720d493de5d.png)
...
![ef0814b84d48b1d8a13437d138e3761a.png](assets/resources-writeupsef0814b84d48b1d8a13437d138e3761a.png)
After searching through user directory, I found several images inside Contact folder 
![0a6cd25427d3d8c8290d887496c5323d.png](assets/resources-writeups0a6cd25427d3d8c8290d887496c5323d.png)
...
![df947db10362722b81bcbee4889f5703.png](assets/resources-writeupsdf947db10362722b81bcbee4889f5703.png)
```
Zambia
```
...
![65b28e2e92ddfb2917f09d40f1f7fb36.png](assets/resources-writeups65b28e2e92ddfb2917f09d40f1f7fb36.png)
Export it
![0bc95f54d59d93ce436a9a2ff0dae8f0.png](assets/resources-writeups0bc95f54d59d93ce436a9a2ff0dae8f0.png)
...
![656950481e6738b77591488114c6a1d5.png](assets/resources-writeups656950481e6738b77591488114c6a1d5.png)
I went back to an image and using Exiftool, we can see Camera model that shooting this image
![95f5cdbf7a4ba198a12845d8c52f4698.png](assets/resources-writeups95f5cdbf7a4ba198a12845d8c52f4698.png)
...
![87010ad5bd0d4cc1aed941334cb62e50.png](assets/resources-writeups87010ad5bd0d4cc1aed941334cb62e50.png)
...
![d3ea514d1d8ba425d6225f681a265934.png](assets/resources-writeupsd3ea514d1d8ba425d6225f681a265934.png)
We also need to export SAM and SYSTEM hives
![d978a5e5a2eb831b520c50142bc3be35.png](assets/resources-writeupsd978a5e5a2eb831b520c50142bc3be35.png)
Then executed mimikatz then using this command `lsadump::sam /system:SYSTEM /sam:SAM` to dump NTLM hashes
![22340fd93bb85ad8281d8922e6a43321.png](assets/resources-writeups22340fd93bb85ad8281d8922e6a43321.png)
We got one
![6f2f46b24d9086e28e21aa39c2116880.png](assets/resources-writeups6f2f46b24d9086e28e21aa39c2116880.png)
Using hashes.com to de-hash
```
ctf2021
```

![7805098918a5a29a0c7a4504fa5b0715.png](assets/resources-writeups7805098918a5a29a0c7a4504fa5b0715.png)
* * *
