...
![34b490a97bfd4d08bc3d38ce93a707bc.png](assets/resources-writeups34b490a97bfd4d08bc3d38ce93a707bc.png)
...
![9ccb41430e865c96c6efced3913cf8f4.png](assets/resources-writeups9ccb41430e865c96c6efced3913cf8f4.png)

There are not much communications were captured so it would be easier to move to wireshark 

![3789c1aabcd3d8a4bd5db01003626496.png](assets/resources-writeups3789c1aabcd3d8a4bd5db01003626496.png)
...
![ef540c119b150a2f860aff091c6b6154.png](assets/resources-writeupsef540c119b150a2f860aff091c6b6154.png)
...
![eaa0d7d9a1b66893a063e45853fc798d.png](assets/resources-writeupseaa0d7d9a1b66893a063e45853fc798d.png)

We can make this script look a little more readable by using https://beautifier.io/

![3ba6de161ddd5b9fda54584399f7deb3.png](assets/resources-writeups3ba6de161ddd5b9fda54584399f7deb3.png)
...
![f5cc8c7d63c17e01136010a482ab2ea0.png](assets/resources-writeupsf5cc8c7d63c17e01136010a482ab2ea0.png)
...
![e2e0af616c72f3b530f5acac8696655f.png](assets/resources-writeupse2e0af616c72f3b530f5acac8696655f.png)
...
![e89b69bb24412818a2ef4df6b02d9b7d.png](assets/resources-writeupse89b69bb24412818a2ef4df6b02d9b7d.png)
...
![dde76f305907416169bd94fef77839c8.png](assets/resources-writeupsdde76f305907416169bd94fef77839c8.png)
...
![0824195fb08f6a37a240273b3272b407.png](assets/resources-writeups0824195fb08f6a37a240273b3272b407.png)
...
![5f7d93f150c2e528830aac774b3e27e2.png](assets/resources-writeups5f7d93f150c2e528830aac774b3e27e2.png)
...
![4d054d40db112e7789c8013da073d0d8.png](assets/resources-writeups4d054d40db112e7789c8013da073d0d8.png)
...
![b908fc8cc7594bc9f53650010453f209.png](assets/resources-writeupsb908fc8cc7594bc9f53650010453f209.png)

So lets examine this JS on PDFStreamDumper

![bca48fafecad4348cc5597f350c5ae59.png](assets/resources-writeupsbca48fafecad4348cc5597f350c5ae59.png)
![6805eafeab3bf5edf7a50e71ce84d6e2.png](assets/resources-writeups6805eafeab3bf5edf7a50e71ce84d6e2.png)
...
![639726657d25a040e8587f1ed2c613a1.png](assets/resources-writeups639726657d25a040e8587f1ed2c613a1.png)
...
![888a7bcddd5f062511f743f4b7ec3dd7.png](assets/resources-writeups888a7bcddd5f062511f743f4b7ec3dd7.png)

Which object 6 leads us to object 7 

![58f13e7307d6fa46f6f9e647cc76b645.png](assets/resources-writeups58f13e7307d6fa46f6f9e647cc76b645.png)
...
![8dbcb8e41e35984688d7021b4587d305.png](assets/resources-writeups8dbcb8e41e35984688d7021b4587d305.png)

Now back to object 8 which will lead us to object 9

![f112a57ad1b2db2207cb033eaaddc80e.png](assets/resources-writeupsf112a57ad1b2db2207cb033eaaddc80e.png)

And it contains long strings that needed to be process 

![918dd43fc43c1ab8140e88618efb91ef.png](assets/resources-writeups918dd43fc43c1ab8140e88618efb91ef.png)
...
![7531e62101a079161126dddb07870d4f.png](assets/resources-writeups7531e62101a079161126dddb07870d4f.png)
...
![869ab3c99b619a2cb1a1af51acc2a171.png](assets/resources-writeups869ab3c99b619a2cb1a1af51acc2a171.png)
...
![aa7e0a4a8d3c054a1fc4cbee8e950de0.png](assets/resources-writeupsaa7e0a4a8d3c054a1fc4cbee8e950de0.png)
...
![c7302a0be821371bbad3af051d93ec50.png](assets/resources-writeupsc7302a0be821371bbad3af051d93ec50.png)
...
![f8b4decc8c373c5f4d469ac6c0717729.png](assets/resources-writeupsf8b4decc8c373c5f4d469ac6c0717729.png)
...
![29707f5cc3f09eabf7709af626b03ff8.png](assets/resources-writeups29707f5cc3f09eabf7709af626b03ff8.png)
...
![2133958eb44ce7cf074257c0212ae62c.png](assets/resources-writeups2133958eb44ce7cf074257c0212ae62c.png)
...
![8261a0249f91f8fc8b31c236e30b1844.png](assets/resources-writeups8261a0249f91f8fc8b31c236e30b1844.png)
...
![a70081af97f2068f5f49a026f0848904.png](assets/resources-writeupsa70081af97f2068f5f49a026f0848904.png)
...
![4643ccf881c758ad940e363d1b9d538e.png](assets/resources-writeups4643ccf881c758ad940e363d1b9d538e.png)

We still have object 11 that we didnot pay any attention to it until now

![f61eb785f8a750aaf7aaa5e9c6afd51e.png](assets/resources-writeupsf61eb785f8a750aaf7aaa5e9c6afd51e.png)

This look quite messy so we will dump it first (Right click -> Save As)

![32d78caaae1b257a05077a5a738368ac.png](assets/resources-writeups32d78caaae1b257a05077a5a738368ac.png)

It is zlib compressed data, now it makes sense why it looks so messy

![2256097e6fd2dc88f84fa724f7f5d4d2.png](assets/resources-writeups2256097e6fd2dc88f84fa724f7f5d4d2.png)

Now go back to PDFStreamDumper then go to "Tools -> Zlib Decompress_File" and select the file that we dumped earlier


![6986d3fa3ba62e1df532ffc0057c1bc1.png](assets/resources-writeups6986d3fa3ba62e1df532ffc0057c1bc1.png)
![7fa1a13e95c872c0010867665c77a6cd.png](assets/resources-writeups7fa1a13e95c872c0010867665c77a6cd.png)

Now we have XML document

![b60ebd76bb190b2d8b474f687a2080f4.png](assets/resources-writeupsb60ebd76bb190b2d8b474f687a2080f4.png)
...
![0d14220696b4171bea54884f56a154b2.png](assets/resources-writeups0d14220696b4171bea54884f56a154b2.png)

Now put these base64 inside CyberChef and to make a shellcode, we need to use "From Base64 -> To Hex -> Remove whitespace" 

![a2ba12c8a634157924c9e1172da947ff.png](assets/resources-writeupsa2ba12c8a634157924c9e1172da947ff.png)
...
![2ccf48819cf6211859a9240c5b1db97b.png](assets/resources-writeups2ccf48819cf6211859a9240c5b1db97b.png)

Lets start with `calc.exe` payload, we will use this line to search 

![54fef308635422dbfee14abf4b3f02fd.png](assets/resources-writeups54fef308635422dbfee14abf4b3f02fd.png)
...
![cdf66b522196aafad3ef67acec3aa880.png](assets/resources-writeupscdf66b522196aafad3ef67acec3aa880.png)

Next is `freecell.exe` payload, this variable seem unique enough to be searched

![a575fd68d655100f848e9a9c3cb1100a.png](assets/resources-writeupsa575fd68d655100f848e9a9c3cb1100a.png)
...
![a98b103d7648261165e52396312d3ed5.png](assets/resources-writeupsa98b103d7648261165e52396312d3ed5.png)

Third one is `notepad.exe` payload

![30a1756236379d2d6de35785576ba513.png](assets/resources-writeups30a1756236379d2d6de35785576ba513.png)

That leads us to [CVE-2007-5659 Adobe Collab.collectEmailInfo() Buffer Overflow](https://www.exploit-db.com/exploits/16674)

![4c69c6f7e285f1bef8d8934072bacc72.png](assets/resources-writeups4c69c6f7e285f1bef8d8934072bacc72.png)

And lastly, `cmd.exe` payload

![521890c3e1ce22ac0a111e93da51a972.png](assets/resources-writeups521890c3e1ce22ac0a111e93da51a972.png)
...
![df55e8d265ac373f94b791f788fb23ad.png](assets/resources-writeupsdf55e8d265ac373f94b791f788fb23ad.png)

It could be 6 since Exploits_Scan from PDFStreamDumper found this one on object 5 too but we're good now

![9cc22601691e614200d16652f81020db.png](assets/resources-writeups9cc22601691e614200d16652f81020db.png)
* * *