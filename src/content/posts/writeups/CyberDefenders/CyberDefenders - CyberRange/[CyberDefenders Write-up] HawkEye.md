...
![924a0ce9b43b3360417888ecd503803e.png](assets/resources-writeups924a0ce9b43b3360417888ecd503803e.png)
```
4003
```
...
![196a02a69b3f8a94a1dbab0e02c30644.png](assets/resources-writeups196a02a69b3f8a94a1dbab0e02c30644.png)
```
...
![7d3c908ab76996f9a20d9b9182d03852.png](assets/resources-writeups7d3c908ab76996f9a20d9b9182d03852.png)
```
01:03:41
```
...
![da06fee57c47067912e05176424fc576.png](assets/resources-writeupsda06fee57c47067912e05176424fc576.png)
...
![51d88bd4f2614ed2799bfbd0adc1435d.png](assets/resources-writeups51d88bd4f2614ed2799bfbd0adc1435d.png)
Alternatively, You can use NetworkMiner
![3ab8abf94483d48139a504997566df06.png](assets/resources-writeups3ab8abf94483d48139a504997566df06.png)
```
Hewlett-Packard
```
...
![0f8b68f95f4073d09739bec9717bef40.png](assets/resources-writeups0f8b68f95f4073d09739bec9717bef40.png)
```
Palo Alto
```
...
To answer this question, Go to Statistics > Endpoints
![d13bdea7c9f1ec95317c193ba8b2ef26.png](assets/resources-writeupsd13bdea7c9f1ec95317c193ba8b2ef26.png)
...
![50d8317f7507e5edee2a67cae2d125e6.png](assets/resources-writeups50d8317f7507e5edee2a67cae2d125e6.png)
```
3
```
...
![af67b211a3328e532c880b558a37cd65.png](assets/resources-writeupsaf67b211a3328e532c880b558a37cd65.png)
```
BEIJING-5CD1-PC
```
...
![5ee7c627ceb75367be32e51fe65d7601.png](assets/resources-writeups5ee7c627ceb75367be32e51fe65d7601.png)
...
![1e54d108150bc486b02a883954cd8b65.png](assets/resources-writeups1e54d108150bc486b02a883954cd8b65.png)
```
...
![e350a5d1761b5f3598fdc1750b383fd9.png](assets/resources-writeupse350a5d1761b5f3598fdc1750b383fd9.png)
...
![5d9f056dedcdc0aea938914603b7a3b4.png](assets/resources-writeups5d9f056dedcdc0aea938914603b7a3b4.png)
```
France
```
...
![90a731052582dbe0f220e3aa60850d4d.png](assets/resources-writeups90a731052582dbe0f220e3aa60850d4d.png)
...
![5a127b1de7863e7647533c1b258e1f5b.png](assets/resources-writeups5a127b1de7863e7647533c1b258e1f5b.png)
...
![14f1aaaeb5c37825ba12a3743e935a85.png](assets/resources-writeups14f1aaaeb5c37825ba12a3743e935a85.png)
...
![a29fef3a59399df3ac84f5333ca06775.png](assets/resources-writeupsa29fef3a59399df3ac84f5333ca06775.png)
On NetworkMiner, It caught web server banner which is LiteSpeed
![62805e189c96bdf20a88ffa5c5152b3d.png](assets/resources-writeups62805e189c96bdf20a88ffa5c5152b3d.png)
...
![0bcbd841b412e206be54256fe88ac6ce.png](assets/resources-writeups0bcbd841b412e206be54256fe88ac6ce.png)
Go to Host Details on NetworkMiner
![3e5b32761914d3f3dbf3a9824ffedcfc.png](assets/resources-writeups3e5b32761914d3f3dbf3a9824ffedcfc.png)
Alternatively, you can also see that there is a website to ask for a public IP address 
![0ed7331f16d1a56124af3a854fba149c.png](assets/resources-writeups0ed7331f16d1a56124af3a854fba149c.png)
Which was contacted by victim machine
![be134e70943e70e5453974d463c3a2a3.png](assets/resources-writeupsbe134e70943e70e5453974d463c3a2a3.png)
...
![fd3f3fadbfbc96f7c415117203b5e7ac.png](assets/resources-writeupsfd3f3fadbfbc96f7c415117203b5e7ac.png)
I filtered for Simple Mail Transfer Protocol on Wireshark then I obtained an IP address of this SMTP server
![b843b3dd0a74816c07ce2a4f2a8e2e13.png](assets/resources-writeupsb843b3dd0a74816c07ce2a4f2a8e2e13.png)
With the help of IPLocation, I finally obtained the correct answer
![40930eb68e4de8a7bed2fb9c923ef31a.png](assets/resources-writeups40930eb68e4de8a7bed2fb9c923ef31a.png)
...
![9056c81efc57ad5011999d70e9e249ec.png](assets/resources-writeups9056c81efc57ad5011999d70e9e249ec.png)
...
![5b7d8f2813462c25de65440e3f7aa822.png](assets/resources-writeups5b7d8f2813462c25de65440e3f7aa822.png)
...
![02b5217d55de2e72fe19251c8fbbd9aa.png](assets/resources-writeups02b5217d55de2e72fe19251c8fbbd9aa.png)
```
Sales@23
```
...
![e5ade1a67ac8e6c3b7836d15be0700c3.png](assets/resources-writeupse5ade1a67ac8e6c3b7836d15be0700c3.png)
...
![df941d0619bd536c2af37992ca38c438.png](assets/resources-writeupsdf941d0619bd536c2af37992ca38c438.png)
...
![d6905d93bf7e23c173426739349b97a3.png](assets/resources-writeupsd6905d93bf7e23c173426739349b97a3.png)
```
...
![d18c4ab95f206ac3890d3c13b9cdaf43.png](assets/resources-writeupsd18c4ab95f206ac3890d3c13b9cdaf43.png)
...
![15ac476fb2f92dc661c98c46c084d5fc.png](assets/resources-writeups15ac476fb2f92dc661c98c46c084d5fc.png)
* * *
