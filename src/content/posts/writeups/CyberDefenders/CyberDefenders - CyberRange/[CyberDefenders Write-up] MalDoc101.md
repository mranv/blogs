...
![66aa4d8eb04afd4704f031510902ab2c.png](assets/resources-writeups66aa4d8eb04afd4704f031510902ab2c.png)

We can a sample which whish is Microsoft Document Macro even though it was named `sample.bin`

![a79337ba56e921da54d04eed94e6c147.png](assets/resources-writeupsa79337ba56e921da54d04eed94e6c147.png)
...
![365309a3c0ba807ce3db20f8cd4a7362.png](assets/resources-writeups365309a3c0ba807ce3db20f8cd4a7362.png)
...
![196167a78d0fda58c8520f30289d4182.png](assets/resources-writeups196167a78d0fda58c8520f30289d4182.png)
...
![f6640c9d2ca256ae6262e577dd0ad456.png](assets/resources-writeupsf6640c9d2ca256ae6262e577dd0ad456.png)
...
![6c6734e18ee32f9652992b3437d4e35c.png](assets/resources-writeups6c6734e18ee32f9652992b3437d4e35c.png)
...
![558fbebbb834013b4fa5516899871be3.png](assets/resources-writeups558fbebbb834013b4fa5516899871be3.png)
...
![47d2a7f31ccd9725e35a932881be4286.png](assets/resources-writeups47d2a7f31ccd9725e35a932881be4286.png)

lets open this maldoc on LibreOffice which macro is turn off by default so we donot have to worry about it

![a7889ab1337d9496214d243b555af9cc.png](assets/resources-writeupsa7889ab1337d9496214d243b555af9cc.png)

Then go to "Tools" > "Macros" > "Edit Macros..." to edit/view all macros on this document file

![7916e21a7ef5891409d24c4b4d0508d0.png](assets/resources-writeups7916e21a7ef5891409d24c4b4d0508d0.png)
...
![c7ce7ecc819afbd3e64e5e313fbcf1b2.png](assets/resources-writeupsc7ce7ecc819afbd3e64e5e313fbcf1b2.png)
...
![25d95dc03f10b56ebfc11ebfcf46d2f5.png](assets/resources-writeups25d95dc03f10b56ebfc11ebfcf46d2f5.png)

Go back to `olevba` result, we can see which object responsible for removing these padding and executing malicious code

![44234ebe1abdd3f68bc72a53c39d3748.png](assets/resources-writeups44234ebe1abdd3f68bc72a53c39d3748.png)

Use `oledump.py` again to find which stream match this object name

![0af55ba4100e039eb4015f879741b631.png](assets/resources-writeups0af55ba4100e039eb4015f879741b631.png)
...
![073f2b593edd18b8892912dfa6fcd6ff.png](assets/resources-writeups073f2b593edd18b8892912dfa6fcd6ff.png)
![3c318deab4e3968f4b7f8085c1eef16d.png](assets/resources-writeups3c318deab4e3968f4b7f8085c1eef16d.png)

Then use find and replace function to remove all strings that match the pattern we found earlier

![d449c5993ffcc75659c3c9b65290da4e.png](assets/resources-writeupsd449c5993ffcc75659c3c9b65290da4e.png)
...
![0f9a21c921d1a279ac852afc25cdf7e2.png](assets/resources-writeups0f9a21c921d1a279ac852afc25cdf7e2.png)
...
![2721ae24462e7e35c28016b5564498bd.png](assets/resources-writeups2721ae24462e7e35c28016b5564498bd.png)
...
![f100f9f5185167eb83bbf2fe5eaea0fa.png](assets/resources-writeupsf100f9f5185167eb83bbf2fe5eaea0fa.png)
```
haoqunkong.com
```

![93186614fc76af03c012822366527d6f.png](assets/resources-writeups93186614fc76af03c012822366527d6f.png)
* * *
