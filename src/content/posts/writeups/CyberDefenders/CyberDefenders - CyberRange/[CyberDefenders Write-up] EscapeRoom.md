...
![d46cc76d0a573916225185ad255c5db2.png](assets/resources-writeups/d46cc76d0a573916225185ad255c5db2.png)
So I'll start with pcap file first since other logs wouldn't have the answer of this question
![c64bde22c14eaf0b0f1b0641bb73939a.png](assets/resources-writeups/c64bde22c14eaf0b0f1b0641bb73939a.png)
...
![1c0edb48d4d02fe645669ec25c257a6b.png](assets/resources-writeups/1c0edb48d4d02fe645669ec25c257a6b.png)
...
![c0457b3bc97150ebf8c6e5a8217be0f7.png](assets/resources-writeups/c0457b3bc97150ebf8c6e5a8217be0f7.png)
...
![8f8728b5d7e3fd0d04780c4b3160ec8c.png](assets/resources-writeups/8f8728b5d7e3fd0d04780c4b3160ec8c.png)
So I came back to the Info of SSH packages
![9f0f99c7bcef5d69613ab874c6f1b110.png](assets/resources-writeups/9f0f99c7bcef5d69613ab874c6f1b110.png)
...
![ee3b35ade55cbfa6a09eab5af441b909.png](assets/resources-writeups/ee3b35ade55cbfa6a09eab5af441b909.png)
...
![5739e6b17701da50725d5d8553f4d6ab.png](assets/resources-writeups/5739e6b17701da50725d5d8553f4d6ab.png)
...
![0d30474c7c0d90ae2000db3ac950c43a.png](assets/resources-writeups/0d30474c7c0d90ae2000db3ac950c43a.png)
...
![7e667d24e5d628a2f948212b1249a346.png](assets/resources-writeups/7e667d24e5d628a2f948212b1249a346.png)
...
![74e77f10aa0501f37281efc9c7a631b3.png](assets/resources-writeups/74e77f10aa0501f37281efc9c7a631b3.png)
...
![c150044ae0165a7b2542121f027fc3c1.png](assets/resources-writeups/c150044ae0165a7b2542121f027fc3c1.png)
...
![6ae7107f48134e05f3d1027b8ecc427f.png](assets/resources-writeups/6ae7107f48134e05f3d1027b8ecc427f.png)
Filtered by HTTP, we can see that all of HTTP requests have Wget as user-agent 
![4932923d5d23c7214899ef468cd6b820.png](assets/resources-writeups/4932923d5d23c7214899ef468cd6b820.png)
...
![7f656cf2add48fdb8c837d97c59d5ffb.png](assets/resources-writeups/7f656cf2add48fdb8c837d97c59d5ffb.png)
...
![dd0d5d2553a53e66d556aeb806047366.png](assets/resources-writeups/dd0d5d2553a53e66d556aeb806047366.png)
...
![f363148667b24459da450c7b2256552e.png](assets/resources-writeups/f363148667b24459da450c7b2256552e.png)
Lets examine first 3 files first, I used Network Miner since its automatically detected files for us 
![f8cb4b38a57f2e9274475ad5d3d8c877.png](assets/resources-writeups/f8cb4b38a57f2e9274475ad5d3d8c877.png)
Check file details to obtain hash
![9fb7e014a22faf063cac7b8ca9c7418f.png](assets/resources-writeups/9fb7e014a22faf063cac7b8ca9c7418f.png)
...
![bb05293f18e95b7ee521fb7e388fbad2.png](assets/resources-writeups/bb05293f18e95b7ee521fb7e388fbad2.png)
...
![9b72a99dcc30fd103de632260290a380.png](assets/resources-writeups/9b72a99dcc30fd103de632260290a380.png)
...
![f5cb6766581ef8dba0a2a7d220380de1.png](assets/resources-writeups/f5cb6766581ef8dba0a2a7d220380de1.png)
...
![6255de5a6695ba25381a1af8b659f6f7.png](assets/resources-writeups/6255de5a6695ba25381a1af8b659f6f7.png)
I used Detect It Easy to see if this malware can be decompiled and look like we need to unpack it first
![999e5366df8a6b17849fa8459598c7e8.png](assets/resources-writeups/999e5366df8a6b17849fa8459598c7e8.png)
Using upx to unpack then put it in Detect It Easy again, we can see that its an ELF linux executable file as expected
![0093ce7366edf9c5a25b7ca672846eff.png](assets/resources-writeups/0093ce7366edf9c5a25b7ca672846eff.png)
...
![590d6c29d7965b12a3804fd7b073179e.png](assets/resources-writeups/590d6c29d7965b12a3804fd7b073179e.png)
Which it is
```
requestFile
```
...
![fabd7c9a67797bdd8fa5c296eddcca9b.png](assets/resources-writeups/fabd7c9a67797bdd8fa5c296eddcca9b.png)
```
174.129.57.253
```
...
![21b331e1ed94dbc632d4fbc45fceb13f.png](assets/resources-writeups/21b331e1ed94dbc632d4fbc45fceb13f.png)
...
![7eeb16d25a9fd191488a4807acb474b7.png](assets/resources-writeups/7eeb16d25a9fd191488a4807acb474b7.png)
...
![d5429def0e6601877ee4c926dcdaffe9.png](assets/resources-writeups/d5429def0e6601877ee4c926dcdaffe9.png)
Which translate to NOP (No operation)
![4e6e097b6a19ca427b8ad0b9bb940a50.png](assets/resources-writeups/4e6e097b6a19ca427b8ad0b9bb940a50.png)
Look like we will eventually found both on "processMessage" function
![3d544d4fc363ed1a510d110a6bb258e1.png](assets/resources-writeups/3d544d4fc363ed1a510d110a6bb258e1.png)
Translate to RUN
```
NOP,RUN
```

![18563b258460ebca1974df53836a9d91.png](assets/resources-writeups/18563b258460ebca1974df53836a9d91.png)
* * *
