...
![44325ea22fa5780eb05348ff7676a589.png](assets/resources-writeups44325ea22fa5780eb05348ff7676a589-1.png)
The content of text file is a URL
![0fc7188d18f308d041ba410e22aa8248.png](assets/resources-writeups0fc7188d18f308d041ba410e22aa8248-1.png)
It is a github repo of the EMarseille99 user 
![875feea30700ba61cd0f4fca67c5922c.png](assets/resources-writeups875feea30700ba61cd0f4fca67c5922c-1.png)
...
![3a46a60731bca07239a79d8eafd45d4d.png](assets/resources-writeups3a46a60731bca07239a79d8eafd45d4d-1.png)
![be9d8be086591982b62a8cfd373400a4.png](assets/resources-writeupsbe9d8be086591982b62a8cfd373400a4-1.png)

Nothing special about `fsociety.js`, its just a logo from the infamous Mr Robot series
![a81eab6001dd06c902cc1aff3c967680.png](assets/resources-writeupsa81eab6001dd06c902cc1aff3c967680-1.png)

But on the other hand, There is an API key paremeter was set at the first line of `Login Page.js`
![2b0098dbccee1d111d18aea2d23b533f.png](assets/resources-writeups2b0098dbccee1d111d18aea2d23b533f-1.png)
...
![541079eedde829692f6723648cf37ebc.png](assets/resources-writeups541079eedde829692f6723648cf37ebc-1.png)
Decode the password with cyberchef
![c1916bba638f1f54a8ed7ec650cabccc.png](assets/resources-writeupsc1916bba638f1f54a8ed7ec650cabccc-1.png)
```
PicassoBaguette99
```
...
![288f5150cc3ea355362fd80ca5d01594.png](assets/resources-writeups288f5150cc3ea355362fd80ca5d01594-1.png)
After reading the `README.md`, It is confirmed that this is the crypto mining tool that we're searching for
![0012ee4031ac0760074f0617e23d7178.png](assets/resources-writeups0012ee4031ac0760074f0617e23d7178-1.png)
```
xmrig
```
...
![80dbdc19c07d808f055e5d282ba09068.png](assets/resources-writeups80dbdc19c07d808f055e5d282ba09068-1.png)
![7904a8ee7dc3d38b93ed55e34276e450.png](assets/resources-writeups7904a8ee7dc3d38b93ed55e34276e450-1.png)
And in the Linkedin there is an education section that list the university this user went to
![c9e4a9322236378cf27e06ecc765d332.png](assets/resources-writeupsc9e4a9322236378cf27e06ecc765d332-1.png)
...
![774d12f43dcc8cab0275d3cd0e52fe01.png](assets/resources-writeups774d12f43dcc8cab0275d3cd0e52fe01-1.png)
So I went to other tool like [Namechk](https://namechk.com/)
![b5de20078bc807dfd712072831f9e40f.png](assets/resources-writeupsb5de20078bc807dfd712072831f9e40f-1.png)
And there it is! This username exists on Steam
![4c5e0330567053bd6b2a951c9e2c8e0d.png](assets/resources-writeups4c5e0330567053bd6b2a951c9e2c8e0d-1.png)
![b0eb65e1a231de0b0ef64da3a3b60910.png](assets/resources-writeupsb0eb65e1a231de0b0ef64da3a3b60910-1.png)
```
steam
```
...
![746658e4ae483ce5e8220ffe0221eb28.png](assets/resources-writeups746658e4ae483ce5e8220ffe0221eb28-1.png)
![321618eb8f73ec3777e2893d05a3bcb4.png](assets/resources-writeups321618eb8f73ec3777e2893d05a3bcb4-1.png)
```
...
![28e5f683e52af4eb1cb43fa220b74d84.png](assets/resources-writeups28e5f683e52af4eb1cb43fa220b74d84-1.png)
...
![abd998eb0d2867e491ee7eaefc9c2d5a.png](assets/resources-writeupsabd998eb0d2867e491ee7eaefc9c2d5a-1.png)
```
Singapore
```
...
![07e57d511483aa3f12454467c8ed37aa.png](assets/resources-writeups07e57d511483aa3f12454467c8ed37aa-1.png)
![d62584a7ba75238e3c41a2f03c2e92f3.png](assets/resources-writeupsd62584a7ba75238e3c41a2f03c2e92f3-1.png)
...
![7c53e2a85280a76c122f45f7b3db8548.png](assets/resources-writeups7c53e2a85280a76c122f45f7b3db8548-1.png)
```
Dubai
```
...
![b042dc4cfc3805c6c6d37030d135fdd1.png](assets/resources-writeupsb042dc4cfc3805c6c6d37030d135fdd1-1.png)
And it says Birmingham New Street, on the office.jpg also showed the Grand Central and Odeon cinema
![a233ae2cf8a6b8e30d9ab3778c0dab4b.png](assets/resources-writeupsa233ae2cf8a6b8e30d9ab3778c0dab4b-1.png)
So both building confirmed the search result.
![1f772851f8bc3f9a0f2230bc3511c57c.png](assets/resources-writeups1f772851f8bc3f9a0f2230bc3511c57c-1.png)
...
![4ba202593a66736dc7cba09c44bfbc16.png](assets/resources-writeups4ba202593a66736dc7cba09c44bfbc16-1.png)
...
![fe7e0d0f44759f096ce699ecfffaf22e.png](assets/resources-writeupsfe7e0d0f44759f096ce699ecfffaf22e-1.png)
Indiana it is
![5253085b01ead368261a4241cacf1321.png](assets/resources-writeups5253085b01ead368261a4241cacf1321-1.png)

```
Indiana
```

![718647f618d6237452180364af952c4f.png](assets/resources-writeups718647f618d6237452180364af952c4f.png)
* * *