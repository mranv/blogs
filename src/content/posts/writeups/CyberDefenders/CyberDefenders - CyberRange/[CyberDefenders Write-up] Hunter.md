...
![4f981334c213e3b36d0e9ecad4e546d2.png](assets/resources-writeups4f981334c213e3b36d0e9ecad4e546d2.png)
...
![28655c2ba8e5db054d1463e60c7baa73.png](assets/resources-writeups28655c2ba8e5db054d1463e60c7baa73.png)
...
![4df248a9aba86e81d48b67f61ab3e101.png](assets/resources-writeups4df248a9aba86e81d48b67f61ab3e101.png)
...
![677e38db558178a6067361690d66eb43.png](assets/resources-writeups677e38db558178a6067361690d66eb43.png)
...
![7a62fceaf04cee8eaa28ff7d23a06a21.png](assets/resources-writeups7a62fceaf04cee8eaa28ff7d23a06a21.png)
...
![38408571f6e0bf3ed185a62f3f2ebec2.png](assets/resources-writeups38408571f6e0bf3ed185a62f3f2ebec2.png)
...
![9e5aac0e436beb12c0f9a2ba400386b1.png](assets/resources-writeups9e5aac0e436beb12c0f9a2ba400386b1.png)
...
![06dd308dff0c26cc3acce45a5e7b12a4.png](assets/resources-writeups06dd308dff0c26cc3acce45a5e7b12a4.png)
...
![ab08a1a9cb1085a663dd550dd04da861.png](assets/resources-writeupsab08a1a9cb1085a663dd550dd04da861.png)
...
![b00aea5a9a2ab8e70ea7e4cf63f0a0e2.png](assets/resources-writeupsb00aea5a9a2ab8e70ea7e4cf63f0a0e2.png)
...
![2ec484c2cbe2a9fc196a4e1a0efaca12.png](assets/resources-writeups2ec484c2cbe2a9fc196a4e1a0efaca12.png)
...
![d7fec6509b4b113b0e9d41dc94c6c980.png](assets/resources-writeupsd7fec6509b4b113b0e9d41dc94c6c980.png)

There is `.zenmap` folder inside Hunter user folder that mean zenmap was executed at least 1 time

![b7827f859694b85304d5a9839f514d4b.png](assets/resources-writeupsb7827f859694b85304d5a9839f514d4b.png)

So lets export its prefetch file 

![383d8ab26a542d598d5dd50e35caf5ec.png](assets/resources-writeups383d8ab26a542d598d5dd50e35caf5ec.png)
...
![9509418bfd36d6e2163b9dfe250e824a.png](assets/resources-writeups9509418bfd36d6e2163b9dfe250e824a.png)
...
![10bc53454669059832e4a20f885c713d.png](assets/resources-writeups10bc53454669059832e4a20f885c713d.png)
...
![3edf0d0c0fa7bdd502d60a337572f2ff.png](assets/resources-writeups3edf0d0c0fa7bdd502d60a337572f2ff.png)
...
![1bffe515c4bad8d4274ebf178dab442f.png](assets/resources-writeups1bffe515c4bad8d4274ebf178dab442f.png)
...
![e94de8901c4c07e1055068e34dc930c2.png](assets/resources-writeupse94de8901c4c07e1055068e34dc930c2.png)
...
![150810fb303f7a3ecea6f49116680b74.png](assets/resources-writeups150810fb303f7a3ecea6f49116680b74.png)

We only need to know the location of this `main.db` file so we can use any tool that can open SQLite 3 to proceed 

![fca4975b203c2af02e3dcfd090d32138.png](assets/resources-writeupsfca4975b203c2af02e3dcfd090d32138.png)
...
![65278948e4471be488751b15bfbfb7f2.png](assets/resources-writeups65278948e4471be488751b15bfbfb7f2.png)

Go to Messages table then we will have full conversation between 2 parties talking about data exfiltration 

![449e43a9d5363f9f4dab4cc2ae0b339f.png](assets/resources-writeups449e43a9d5363f9f4dab4cc2ae0b339f.png)
...
![51b457158ac2c72c221d3bccb9a04ef2.png](assets/resources-writeups51b457158ac2c72c221d3bccb9a04ef2.png)
...
![0a09494a3922e8f7aa5a5971a7f5c293.png](assets/resources-writeups0a09494a3922e8f7aa5a5971a7f5c293.png)

They talked about sending a file to someone's hotmail account so we need to investigate outlook if available

![5e69985478d09e0fb983405c8b94c14e.png](assets/resources-writeups5e69985478d09e0fb983405c8b94c14e.png)

Which there is a backup in pst file inside Documents folder

![b3db048dd060164052d0cbd4e805c14e.png](assets/resources-writeupsb3db048dd060164052d0cbd4e805c14e.png)
...
![ea0b1b1e43596850cb42d71020610a19.png](assets/resources-writeupsea0b1b1e43596850cb42d71020610a19.png)

There is a file named after someone thesis so I think it worth looking for

![d6aaf95cb36e3e42ca574acbf5780de6.png](assets/resources-writeupsd6aaf95cb36e3e42ca574acbf5780de6.png)
...
![3f471619dbf7acc1c80ccf6bfedf6b98.png](assets/resources-writeups3f471619dbf7acc1c80ccf6bfedf6b98.png)

There is an installer named `bcwipeSetup.exe` inside Downloads folder

![858328de1fc79a3b964e58977ee26d33.png](assets/resources-writeups858328de1fc79a3b964e58977ee26d33.png)
...
![9877ed3c83f323ef7459d7706f70e275.png](assets/resources-writeups9877ed3c83f323ef7459d7706f70e275.png)
...
![c105fd2f9a4d3630657fc567a952abd1.png](assets/resources-writeupsc105fd2f9a4d3630657fc567a952abd1.png)
...
![7fc4f5c928c91fa65a6c4472a5e41685.png](assets/resources-writeups7fc4f5c928c91fa65a6c4472a5e41685.png)
...
![67c80ba10ea71d5a7a6e557284348aa4.png](assets/resources-writeups67c80ba10ea71d5a7a6e557284348aa4.png)
...
![4aab8a4e43648f31de6f081ea2d8ba12.png](assets/resources-writeups4aab8a4e43648f31de6f081ea2d8ba12.png)
...
![4e0c314a9b2027493c50757e32d3fd04.png](assets/resources-writeups4e0c314a9b2027493c50757e32d3fd04.png)
...
![e2230504f8402f3b599a8d60e2490025.png](assets/resources-writeupse2230504f8402f3b599a8d60e2490025.png)
...
![cc57fd247357a45c894f9e6523ddce61.png](assets/resources-writeupscc57fd247357a45c894f9e6523ddce61.png)
...
![1ee4726781e8fb941d0a41cccdec9643.png](assets/resources-writeups1ee4726781e8fb941d0a41cccdec9643.png)

To process ShellBags, we need to extract UsrClass.dat hive first 

![c7d9e0d093fb8a81df8e3a0a252d6c77.png](assets/resources-writeupsc7d9e0d093fb8a81df8e3a0a252d6c77.png)

Then use ShellBags Explorer than we can see that there is Exfil folder under Pictures folder there

![de1300716c83b775ea4951d0f6371bee.png](assets/resources-writeupsde1300716c83b775ea4951d0f6371bee.png)
...
![c60ad4c07c7100cbb79cf01e67f66be3.png](assets/resources-writeupsc60ad4c07c7100cbb79cf01e67f66be3.png)

There are 2 image files inside $Recycle.Bin, the larger one should have the higher resolution

![f7dfa6a749dd40efccc0de86b1cbbe5a.png](assets/resources-writeupsf7dfa6a749dd40efccc0de86b1cbbe5a.png)
...
![7f71cdb424666a96815202fd5f7a3e37.png](assets/resources-writeups7f71cdb424666a96815202fd5f7a3e37.png)
...
![3e146cce32c38a2b423ecc6350fbb014.png](assets/resources-writeups3e146cce32c38a2b423ecc6350fbb014.png)

This item was located under CustomDestinations folder

![dfce9f2658649666373fc495f2841664.png](assets/resources-writeupsdfce9f2658649666373fc495f2841664.png)

Export it and use JumpList Explorer to parse it then we have half of absolute path here

![8c76a9edac6bd6640b831107c544f0c3.png](assets/resources-writeups8c76a9edac6bd6640b831107c544f0c3.png)
