...
![3a571c113d0f511d91d1e834761e39ae.png](assets/resources-writeups3a571c113d0f511d91d1e834761e39ae.png)
...
![7cb9fea83d85965be57e67dcee024112.png](assets/resources-writeups7cb9fea83d85965be57e67dcee024112.png)
...
![dd2be8a53bda8913bcce93a30a6f1691.png](assets/resources-writeupsdd2be8a53bda8913bcce93a30a6f1691.png)
...
![6cdc2179fc51bbfdb7445dcd5fee1b14.png](assets/resources-writeups6cdc2179fc51bbfdb7445dcd5fee1b14.png)

Lets dump all ost files using `vol.py -f Target1-1dd8701f.vmss --profile=Win7SP1x86_23418 dumpfiles -n -u -r ost$ -D /tmp/robot`

![8a87b8fa0ad5306b5991bf8d3a74f9f7.png](assets/resources-writeups8a87b8fa0ad5306b5991bf8d3a74f9f7.png)
...
![97857f1c98890909a106a8101cae9a97.png](assets/resources-writeups97857f1c98890909a106a8101cae9a97.png)

Find for Headers then we will have an email of suspected sender

![66e475dcc919d59d019d30fc4a3dd291.png](assets/resources-writeups66e475dcc919d59d019d30fc4a3dd291.png)
...
![22387c51c27925fedac520cff47eff9b.png](assets/resources-writeups22387c51c27925fedac520cff47eff9b.png)
...
![46651a41c49930777ead05837ea6fe1a.png](assets/resources-writeups46651a41c49930777ead05837ea6fe1a.png)
...
![af6dc78274961912231f3c6dfa2ea09c.png](assets/resources-writeupsaf6dc78274961912231f3c6dfa2ea09c.png)
...
![a92a04ead3bdb4068cb0e7bf5669de53.png](assets/resources-writeupsa92a04ead3bdb4068cb0e7bf5669de53.png)

![9229cdf0e980b399751e4ef7248fc37d.png](assets/resources-writeups9229cdf0e980b399751e4ef7248fc37d.png)
...
![b27f8387e18754d48c205c431a797315.png](assets/resources-writeupsb27f8387e18754d48c205c431a797315.png)
...
![bd0ebdfc46afa45be0e5388bebe512d1.png](assets/resources-writeupsbd0ebdfc46afa45be0e5388bebe512d1.png)
...
![3cbc8ad5cccdac8001fa8380ba2c7dbf.png](assets/resources-writeups3cbc8ad5cccdac8001fa8380ba2c7dbf.png)
...
![76acb8e844aa337ec689da7cda196bd8.png](assets/resources-writeups76acb8e844aa337ec689da7cda196bd8.png)
...
![0e437475c55c5a205ea76d7e513005bf.png](assets/resources-writeups0e437475c55c5a205ea76d7e513005bf.png)
...
![481807195c8fe361e423900f63a9c8bb.png](assets/resources-writeups481807195c8fe361e423900f63a9c8bb.png)
...
![08ad0885d1a9de51c06a103ab1cc1094.png](assets/resources-writeups08ad0885d1a9de51c06a103ab1cc1094.png)

Then we can see that zerocool user was there when this memory dump was captured

![9fe2fc57aae7714c319e1d70e682ae56.png](assets/resources-writeups9fe2fc57aae7714c319e1d70e682ae56.png)
...
![f908e3c75948dff4fe482c8c2b6ffdea.png](assets/resources-writeupsf908e3c75948dff4fe482c8c2b6ffdea.png)
...
![29488fc59c0cd874e41829d9371bddb1.png](assets/resources-writeups29488fc59c0cd874e41829d9371bddb1.png)
...
![00dbb43596460033d5b6f1b031c4a2bf.png](assets/resources-writeups00dbb43596460033d5b6f1b031c4a2bf.png)

`nbtscan.exe` is NETBIOS nameserver scanner

![aaaefa4878a3cfd9e0dafe6e3c91fed1.png](assets/resources-writeupsaaaefa4878a3cfd9e0dafe6e3c91fed1.png)

`Rar.exe` is winrar executable to compress and decompress files

![bc5c339e4be1628c85e9b85bd37e9eea.png](assets/resources-writeupsbc5c339e4be1628c85e9b85bd37e9eea.png)

but `wce.exe` and `getlsasrvaddr.exe` are from found on the same github repo so we can count them as 1 tool

![736e22a98a3c74590578291c274ba9b6.png](assets/resources-writeups736e22a98a3c74590578291c274ba9b6.png)

`wce.exe` can be used for acitivity related to authentication on Windows sytem

![c8d4439c2aca2f2e9a902fa9d24b511a.png](assets/resources-writeupsc8d4439c2aca2f2e9a902fa9d24b511a.png)
...
![d0238145e21a34689d173252d5d975e8.png](assets/resources-writeupsd0238145e21a34689d173252d5d975e8.png)
...
![506f37bf8c29cae5c8ea7e9894b40c49.png](assets/resources-writeups506f37bf8c29cae5c8ea7e9894b40c49.png)
...
![777349483993ffbc2dcf4b770db4f207.png](assets/resources-writeups777349483993ffbc2dcf4b770db4f207.png)
...
![5b8a0e10d3bbde32c60e129499f919ae.png](assets/resources-writeups5b8a0e10d3bbde32c60e129499f919ae.png)
...
![978aed09a2a9081379f103de8ac5f003.png](assets/resources-writeups978aed09a2a9081379f103de8ac5f003.png)
...
![29e7e06fd9dea8897846c157e94af7c7.png](assets/resources-writeups29e7e06fd9dea8897846c157e94af7c7.png)
...
![8d9cbd2f62f295441ce58bbd20d4b003.png](assets/resources-writeups8d9cbd2f62f295441ce58bbd20d4b003.png)
...
![b990ea12f8c9bfb8541ef18795d28b0e.png](assets/resources-writeupsb990ea12f8c9bfb8541ef18795d28b0e.png)

Used `vol.py -f target2-6186fe9f.vmss --profile=Win7SP1x86_23418 pstree` then we can see outlook and cmd were running 

![802af58d48ae9e832767cdcebe0e4d3e.png](assets/resources-writeups802af58d48ae9e832767cdcebe0e4d3e.png)
...
![260f3f0e69beb21ae3a5a3fad0a3bc46.png](assets/resources-writeups260f3f0e69beb21ae3a5a3fad0a3bc46.png)
...
![104a2dc2d80f8338b143f6bea828b893.png](assets/resources-writeups104a2dc2d80f8338b143f6bea828b893.png)
...
![f9f66caa76e655ab2beccf632d63eb43.png](assets/resources-writeupsf9f66caa76e655ab2beccf632d63eb43.png)

From console history,we can see that an attacker used rar to compress a file with password

![548f267072178ed89eb3277c970d3179.png](assets/resources-writeups548f267072178ed89eb3277c970d3179.png)
...
![c563b91b6266c1994e2f749baec64ec6.png](assets/resources-writeupsc563b91b6266c1994e2f749baec64ec6.png)

We need to dump process that was used to create rar archive, first lets grab this PID

![b3831aa9fe1bf8eaac84df29065b2057.png](assets/resources-writeupsb3831aa9fe1bf8eaac84df29065b2057.png)

Then use `vol.py -f target2-6186fe9f.vmss --profile=Win7SP1x86_23418 memdump -p 3048 -D /tmp/robot/` 

![9007865d033aea263c9b01e05db01302.png](assets/resources-writeups9007865d033aea263c9b01e05db01302.png)
...
![be885ebae002fd3e154a8ce0a3b6b7e2.png](assets/resources-writeupsbe885ebae002fd3e154a8ce0a3b6b7e2.png)
...
![c4b779bb576a6a70d340dd413c9fb372.png](assets/resources-writeupsc4b779bb576a6a70d340dd413c9fb372.png)
...
![a71d4cb0e76098079e59887aca9ffe52.png](assets/resources-writeupsa71d4cb0e76098079e59887aca9ffe52.png)
...
![aa13bf1d6aaf2619fc46134ff7f66c9b.png](assets/resources-writeupsaa13bf1d6aaf2619fc46134ff7f66c9b.png)

This memory dump is still using the same profiles as other 2

![e52f3b0bfba68b0872a135d06c81ea06.png](assets/resources-writeupse52f3b0bfba68b0872a135d06c81ea06.png)
...
![aa5c4f8347538da50573b8afb91b884c.png](assets/resources-writeupsaa5c4f8347538da50573b8afb91b884c.png)

![84b9040cf23699ac6ad1a61d68c73617.png](assets/resources-writeups84b9040cf23699ac6ad1a61d68c73617.png)
...
![eb2814e7e37ee76ac3954d863eac260d.png](assets/resources-writeupseb2814e7e37ee76ac3954d863eac260d.png)
...
![990be0b9caf43047dd76eb67269714c4.png](assets/resources-writeups990be0b9caf43047dd76eb67269714c4.png)
...
![04998be2d2430c55032ae32eb8b426b5.png](assets/resources-writeups04998be2d2430c55032ae32eb8b426b5.png)
...
![3b0491aa271516b19d1918aa1c4e5e54.png](assets/resources-writeups3b0491aa271516b19d1918aa1c4e5e54.png)
* * *
