...
![c9b2621a4b69cb389672bf31aafbb41d.png](/assets/resources-writeups/c9b2621a4b69cb389672bf31aafbb41d.png)
...
![fab92bc104032bd6f3b943c7db150cd4.png](/assets/resources-writeups/fab92bc104032bd6f3b943c7db150cd4.png)

According to [apple support](https://support.apple.com/en-us/109033), this major version is 10.15

![74a1195d6992ad4e2e230fa1dcb304a3.png](/assets/resources-writeups/74a1195d6992ad4e2e230fa1dcb304a3.png)
...
![29f520bc4de4dab71ce6e48335b8aa22.png](/assets/resources-writeups/29f520bc4de4dab71ce6e48335b8aa22.png)

Open evidence file using FTK Imager then go to the CoreServices directory to export plist file

![aba879aa97829c2395eceb720abaef62.png](/assets/resources-writeups/aba879aa97829c2395eceb720abaef62.png)
...
![3f466bff41825f5c1b43d87177c68b9d.png](/assets/resources-writeups/3f466bff41825f5c1b43d87177c68b9d.png)

You can see that there are 2 users on this machine which are `hansel.apricot` and `sneaky`

![570f53f073b5368f0e2c2a732003d038.png](/assets/resources-writeups/570f53f073b5368f0e2c2a732003d038.png)

But `AnotherExample.jpg` could be found on Shared directory

![96e686877661914b3c406375614266ea.png](/assets/resources-writeups/96e686877661914b3c406375614266ea.png)

Export an image and using `strings` to find out the secret, you will find that the secret is "flip phone"

![546c28e0b4be022a8034a29e56b875e8.png](/assets/resources-writeups/546c28e0b4be022a8034a29e56b875e8.png)
...
![31935a5125a3010f5cee3de3a1cfae3a.png](/assets/resources-writeups/31935a5125a3010f5cee3de3a1cfae3a.png)
...
![84b44df1996e76015efae131acf70648.png](/assets/resources-writeups/84b44df1996e76015efae131acf70648.png)

We're interested in bookmark so we will grab `Bookmarks.plist`

![79e5bb5724cbba30b2988954377d5861.png](/assets/resources-writeups/79e5bb5724cbba30b2988954377d5861.png)
...
![7dad79a4fa5730af404d7b84e31c40f4.png](/assets/resources-writeups/7dad79a4fa5730af404d7b84e31c40f4.png)

[mac_apt](https://github.com/ydkhatri/mac_apt) also have NOTES plugin which written in `notes.py`

![9f3778215ec80a321645e69ed42d3936.png](/assets/resources-writeups/9f3778215ec80a321645e69ed42d3936.png)

Grab `NoteStore.sqlite`

![395e4f7392219e77ef738dae5fe0b1b0.png](/assets/resources-writeups/395e4f7392219e77ef738dae5fe0b1b0.png)
...
![d8c8c1ff190013357e8a1d4efdb4e0ee.png](/assets/resources-writeups/d8c8c1ff190013357e8a1d4efdb4e0ee.png)
...
![c728f97216fe42cbf98e53b71006b9be.png](/assets/resources-writeups/c728f97216fe42cbf98e53b71006b9be.png)
...
![2128524c5a70973dd33dd188b27e69d1.png](/assets/resources-writeups/2128524c5a70973dd33dd188b27e69d1.png)
...
![0029a51a8f1635da432dde9b718650ae.png](/assets/resources-writeups/0029a51a8f1635da432dde9b718650ae.png)

[mac_apt](https://github.com/ydkhatri/mac_apt) also has a plugin for this which is called QUARANTINE

![a774c1a9dadf80f23f62d29dab024a8f.png](/assets/resources-writeups/a774c1a9dadf80f23f62d29dab024a8f.png)

![96d66d0cfb5929250a481772370271c0.png](/assets/resources-writeups/96d66d0cfb5929250a481772370271c0.png)
...
![286aff36ef3454c5f99d58dc4de2e6e1.png](/assets/resources-writeups/286aff36ef3454c5f99d58dc4de2e6e1.png)
...
![754782d6329dc3e2efb01c9b181126d7.png](/assets/resources-writeups/754782d6329dc3e2efb01c9b181126d7.png)

back to terminal history, you can see that `SilentEye` was installed

![0056fc0f1f2c9dd52c0909e21403f942.png](/assets/resources-writeups/0056fc0f1f2c9dd52c0909e21403f942.png)
...
![0a919528d4e867261191a2443e2b94b0.png](/assets/resources-writeups/0a919528d4e867261191a2443e2b94b0.png)

All file system events happened on Mac will be stored inside `.fseventsd`

![e91b5e68375c5876d3d1c87bee41a5d4.png](/assets/resources-writeups/e91b5e68375c5876d3d1c87bee41a5d4.png)

Luckily, [mac_apt](https://github.com/ydkhatri/mac_apt) also has a plugin for this
![83faed0479ce5a99a6bd0d4a75e3d977.png](/assets/resources-writeups/83faed0479ce5a99a6bd0d4a75e3d977.png)

Export whole directory out
![472e94e7ecf036fa95ce33326dac646c.png](/assets/resources-writeups/472e94e7ecf036fa95ce33326dac646c.png)

Parse those events out (`mac_apt_artifact_only.exe -i .fseventsd -o . -c FSEVENTS`)

![355aa5296f3dea622ca14c9e663ad4de.png](/assets/resources-writeups/355aa5296f3dea622ca14c9e663ad4de.png)
...
![251fbf871ca25b59072227f3d0dc8bfd.png](/assets/resources-writeups/251fbf871ca25b59072227f3d0dc8bfd.png)

[mac_apt](https://github.com/ydkhatri/mac_apt) has a plugin for SCREENTIME

![db597ccf005ec20916d763614cdfb88f.png](/assets/resources-writeups/db597ccf005ec20916d763614cdfb88f.png)

Export an artifact from ScreenTimeAgent
![631b72a144fd579181398d003ad2b491.png](/assets/resources-writeups/631b72a144fd579181398d003ad2b491.png)
Parse the artifact with mac_apt (`mac_apt_artifact_only.exe -i RMAdminStore-Local.sqlite -o . -c SCREENTIME`)

![995a195faeae561b7d8562be6da23a01.png](/assets/resources-writeups/995a195faeae561b7d8562be6da23a01.png)
...
![42e1d9f9569f4111a0db68b6896cd3b2.png](/assets/resources-writeups/42e1d9f9569f4111a0db68b6896cd3b2.png)
...
![77f96e4c2498e3fca51acc03db60a122.png](/assets/resources-writeups/77f96e4c2498e3fca51acc03db60a122.png)
...
![5c12fa8ca5227ecbb593c5bc105ff47d.png](/assets/resources-writeups/5c12fa8ca5227ecbb593c5bc105ff47d.png)

I went to mac_apt `imessage.py` to find where to get an artifact for this question

![eb8362716a95839d8aaa4cbd3be9d8b2.png](/assets/resources-writeups/eb8362716a95839d8aaa4cbd3be9d8b2.png)

But it was not available here but we still have file system event that we just parsed using mac_apt

![5039ffa48395fdee5bae7e8613720973.png](/assets/resources-writeups/5039ffa48395fdee5bae7e8613720973.png)

Find for directory that store imessage artifact, you can see the pattern to filter

![c913a59f2b78afe70b38d3bd61a9a1bb.png](/assets/resources-writeups/c913a59f2b78afe70b38d3bd61a9a1bb.png)
...
![74e08709fdb7274b3cc594b7f724a52c.png](/assets/resources-writeups/74e08709fdb7274b3cc594b7f724a52c.png)

And the artifact that will be needed is `_usbmuxd.plist`

![07a00ebe499d58c08ecad1e9d7f4d3bb.png](/assets/resources-writeups/07a00ebe499d58c08ecad1e9d7f4d3bb.png)
...
![693785c3a37a108058e3e42b8a7549ce.png](/assets/resources-writeups/693785c3a37a108058e3e42b8a7549ce.png)

From File System Event, we know that this image was renamed and located in Shared directory

![e2c7d177b19cac41dacc175230cce9e1.png](/assets/resources-writeups/e2c7d177b19cac41dacc175230cce9e1.png)

Using website that was quarantined we can upload this image and unreveal it secret for us

![0d8df0c1efa3e7c2ddba917a44139ab6.png](/assets/resources-writeups/0d8df0c1efa3e7c2ddba917a44139ab6.png)

There it is

![5de4499d348337407fc453218cf952b2.png](/assets/resources-writeups/5de4499d348337407fc453218cf952b2.png)
...
![8b4aa62f8865ca2012f8c85001f103b3.png](/assets/resources-writeups/8b4aa62f8865ca2012f8c85001f103b3.png)

Which our best friend mac_apt has 2 plugins for this feature

![676bd3bdfa1d570ab21d94129aec12b7.png](/assets/resources-writeups/676bd3bdfa1d570ab21d94129aec12b7.png)

I didn't find any artifact from `spotlight.py` so I went to `spotlightshorcuts.py` to find more artifacts

![bb7d953f1699e7a095ff26b5933b2936.png](/assets/resources-writeups/bb7d953f1699e7a095ff26b5933b2936.png)
...
![c871d4e7f6cbf6a5ce6c34aaf8becc26.png](/assets/resources-writeups/c871d4e7f6cbf6a5ce6c34aaf8becc26.png)
