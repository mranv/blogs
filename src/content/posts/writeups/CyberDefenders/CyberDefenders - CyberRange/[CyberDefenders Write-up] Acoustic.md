...
![031565a58e9cf33e9c945f7e0665776d.png](assets/resources-writeups031565a58e9cf33e9c945f7e0665776d.png)
And the first package is SIP packet then a lot of HTTP packets came after
![d671749e324dabd025ba1e21ca2d6f7f.png](assets/resources-writeupsd671749e324dabd025ba1e21ca2d6f7f.png)
...
![c93c966e6eff2d5a3f6f7bff82307cb7.png](assets/resources-writeupsc93c966e6eff2d5a3f6f7bff82307cb7.png)
...
![a47453dad46e8dfd176ea381d2377cd4.png](assets/resources-writeupsa47453dad46e8dfd176ea381d2377cd4.png)
There is some string that caught my eyes rightway so I went to google to find out what is it
![2d9db34a37585784c596925a8b2da39c.png](assets/resources-writeups2d9db34a37585784c596925a8b2da39c.png)
...
![393536fc15a6512d5452d78a5c20c2eb.png](assets/resources-writeups393536fc15a6512d5452d78a5c20c2eb.png)
```
...
![c7b40cb16aa97f9aafcbe1ae36f8f4e0.png](assets/resources-writeupsc7b40cb16aa97f9aafcbe1ae36f8f4e0.png)
then found that there are 5 python scripts that could be use to test VoIP
![dfa3ae36b004239c5ba47194b95d4c0f.png](assets/resources-writeupsdfa3ae36b004239c5ba47194b95d4c0f.png)
Fortunately, I went to `svcrack.py` first cuz on the Register function there is an attempt to make a request to VoIP server
![a0a565b3eee1f31637861644218c2ca2.png](assets/resources-writeupsa0a565b3eee1f31637861644218c2ca2.png)
And I also found that this `makeRequest` function was imported from `siphelper.py`
![0e68d9c32a456d8ee933360d82e94c2e.png](assets/resources-writeups0e68d9c32a456d8ee933360d82e94c2e.png)
![aaaf6faf5f978d45b5571f62c4ef9302.png](assets/resources-writeupsaaaf6faf5f978d45b5571f62c4ef9302.png)
...
![ed17d1320ad7293f534e9dd132cfc24c.png](assets/resources-writeupsed17d1320ad7293f534e9dd132cfc24c.png)
...
![176df61cede513116ac7df863cc4031f.png](assets/resources-writeups176df61cede513116ac7df863cc4031f.png)
...
![7526840f4a640abdf6b704dc34c0bf8c.png](assets/resources-writeups7526840f4a640abdf6b704dc34c0bf8c.png)
This script also use `makeRequest` function and has similar context
![91e40bf8ebd1fa6ed94da34171281178.png](assets/resources-writeups91e40bf8ebd1fa6ed94da34171281178.png)
...
![53a309862c8297d6f2aba7cb5d31d2ff.png](assets/resources-writeups53a309862c8297d6f2aba7cb5d31d2ff.png)
So I used this python script to read `log.txt` then put all starts with `Contact: sip:` to a new file
![45909e1ef9e0ffc1a0a98c1475cf0c69.png](assets/resources-writeups45909e1ef9e0ffc1a0a98c1475cf0c69.png)
...
![90b8188ce76fd364254eda820c49123f.png](assets/resources-writeups90b8188ce76fd364254eda820c49123f.png)
And I also saw the pattern that all contacts with `@honey.pot` are the one I was looking for 
![1ae044cf757b86ae1cb57b3666da6fa2.png](assets/resources-writeups1ae044cf757b86ae1cb57b3666da6fa2.png)
...
![f6bbbd51d68b1918799ab37cc5ac6629.png](assets/resources-writeupsf6bbbd51d68b1918799ab37cc5ac6629.png)
...
![2121f78ac1de4fee4773a928c35330d3.png](assets/resources-writeups2121f78ac1de4fee4773a928c35330d3.png)
![7fa9c820a8efd18fdb25a3f46669ae2c.png](assets/resources-writeups7fa9c820a8efd18fdb25a3f46669ae2c.png)
...
![75198e04d24535c7ab851bda12380a48.png](assets/resources-writeups75198e04d24535c7ab851bda12380a48.png)
...
![0526959976eae9e8eed742e88dbe582e.png](assets/resources-writeups0526959976eae9e8eed742e88dbe582e.png)
...
![2c60277f03f6538405878d788efa6235.png](assets/resources-writeups2c60277f03f6538405878d788efa6235.png)
...
![a5003fec267769c4f241c4af313eaa11.png](assets/resources-writeupsa5003fec267769c4f241c4af313eaa11.png)
...
![5890aa14c20c71b6ee2f7b286b826856.png](assets/resources-writeups5890aa14c20c71b6ee2f7b286b826856.png)
...
![f96cf863e3f47d5a122a8fa0cf72a052.png](assets/resources-writeupsf96cf863e3f47d5a122a8fa0cf72a052.png)
So from the explaination, 1 second happened 8000 times if sampling rate is 8000Hz
![a692115278f029a7fc3bae6839f961c8.png](assets/resources-writeupsa692115278f029a7fc3bae6839f961c8.png)
...
![5b59fd5ceee6a4f25ffbba522f21be49.png](assets/resources-writeups5b59fd5ceee6a4f25ffbba522f21be49.png)
...
![111910d2c21b138cdcead1570a1d56d1.png](assets/resources-writeups111910d2c21b138cdcead1570a1d56d1.png)
and found that there is a config file for SIP was requested and it contained credentials 
![f416a4bdf4e555d789037271b7fc8ed3.png](assets/resources-writeupsf416a4bdf4e555d789037271b7fc8ed3.png)
```
1234
```
...
![241121e7d0679b6617ba74b2b4707340.png](assets/resources-writeups241121e7d0679b6617ba74b2b4707340.png)
...
![70e991346c256aff48bbc88795d22da6.png](assets/resources-writeups70e991346c256aff48bbc88795d22da6.png)
When you reached there, you will hear the secret code
```
mexico
```

![59b3446f0435347c8afee2a10dff5cdf.png](assets/resources-writeups59b3446f0435347c8afee2a10dff5cdf.png)
* * *
