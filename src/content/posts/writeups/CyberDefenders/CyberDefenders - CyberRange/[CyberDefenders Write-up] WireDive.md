...
![23d172e1ee3e561e26153302354a083a.png](assets/resources-writeups23d172e1ee3e561e26153302354a083a.png)
Now we can see that IP 192.168.2.244 got release 
![9f46a1ef28676dcb3eadc7a989c85ccd.png](assets/resources-writeups9f46a1ef28676dcb3eadc7a989c85ccd.png)
...
![b43dd72ba99bd44391497c69ab616cdf.png](assets/resources-writeupsb43dd72ba99bd44391497c69ab616cdf.png)
...
![1ab1f4eafdaf8d93d450c637c6d017f7.png](assets/resources-writeups1ab1f4eafdaf8d93d450c637c6d017f7.png)
![80a287514e103ea7ca72ed3492a5688d.png](assets/resources-writeups80a287514e103ea7ca72ed3492a5688d.png)
```
0x9f8fa557
```
...
![3a3308c96a41be6729dbafd73b663132.png](assets/resources-writeups3a3308c96a41be6729dbafd73b663132.png)
```
00:0c:29:82:f5:94
```
...
![525e99ec9c8c908f4bf850846859f4ce.png](assets/resources-writeups525e99ec9c8c908f4bf850846859f4ce.png)
...
![e3442d53c821b123c073c01d18c87757.png](assets/resources-writeupse3442d53c821b123c073c01d18c87757.png)
The first response is a response from Root server
![5fdd18ae8c8cc006dd9fc7c6708bb833.png](assets/resources-writeups5fdd18ae8c8cc006dd9fc7c6708bb833.png)
...
![ef2fc0a58280185cd461eaeec9fe0afe.png](assets/resources-writeupsef2fc0a58280185cd461eaeec9fe0afe.png)
I scrolled down to the bottom of this filtered packages
![d92cb9cd50dcce4f18754f7d8fc35602.png](assets/resources-writeupsd92cb9cd50dcce4f18754f7d8fc35602.png)
...
![cca88f67efcf7f25521f2319b2b6551e.png](assets/resources-writeupscca88f67efcf7f25521f2319b2b6551e.png)
![6168f44a63a5f37e249cce519b7aa4f2.png](assets/resources-writeups6168f44a63a5f37e249cce519b7aa4f2.png)
```
0xc000006d
```
...
![509f43b22fb3136bbb47f47d5d785641.png](assets/resources-writeups509f43b22fb3136bbb47f47d5d785641.png)
```
\\192.168.2.10\public
```
...
![fd3558f3588fdd3525d676abad004dc6.png](assets/resources-writeupsfd3558f3588fdd3525d676abad004dc6.png)
...
![b3fee32dca830e33971a3a095d32fde2.png](assets/resources-writeupsb3fee32dca830e33971a3a095d32fde2.png)
That's a flag
```
OneSuperDuperSecret
```
...
![15c68e71314326d66650399aa6840896.png](assets/resources-writeups15c68e71314326d66650399aa6840896.png)
...
![f6f562d87a1b54b1a22182f2cd1877da.png](assets/resources-writeupsf6f562d87a1b54b1a22182f2cd1877da.png)
...
![4c7fcb553542640906026251c586bb4d.png](assets/resources-writeups4c7fcb553542640906026251c586bb4d.png)
...
![c3dc9c6d1378c3e1e2f9b151726478fb.png](assets/resources-writeupsc3dc9c6d1378c3e1e2f9b151726478fb.png)
```
*umR@Q%4V&RC
```
...
![00b31c5d1f0268a376b40a3424433da7.png](assets/resources-writeups00b31c5d1f0268a376b40a3424433da7.png)
```
bionic
```
...
![88720f429307f48049d954e609313828.png](assets/resources-writeups88720f429307f48049d954e609313828.png)
There it is
![c7877958d88cef1a611706b000c62e3a.png](assets/resources-writeupsc7877958d88cef1a611706b000c62e3a.png)
```
31
```
...
![10f83a68e5effba3fbe4e54faf27d46c.png](assets/resources-writeups10f83a68e5effba3fbe4e54faf27d46c.png)
...
filter by `dhcp`
![8bc3f0c9316070e1a71e0e670958c097.png](assets/resources-writeups8bc3f0c9316070e1a71e0e670958c097.png)
...
![2bde83a564a1bfb14cd0ad7f7e4d736a.png](assets/resources-writeups2bde83a564a1bfb14cd0ad7f7e4d736a.png)
```
...
I didn't know anything about Protocol that VLAN is using on so I did some research and found that ![7fdce62fd35b55626cd9bb0cca6c42fc.png](assets/resources-writeups7fdce62fd35b55626cd9bb0cca6c42fc.png)
There are 3 protocols to look out for
![df231b9b9b052285c8ee1b056e8f2247.png](assets/resources-writeupsdf231b9b9b052285c8ee1b056e8f2247.png)
It might be STP on this pcapng file so I started with STP

![40cdf0a8449455e1cb930f861030f642.png](assets/resources-writeups40cdf0a8449455e1cb930f861030f642.png)
Then I inspected STP packet and found that there is a flag that could be used here
![730258014537e8e03c358098b768913e.png](assets/resources-writeups730258014537e8e03c358098b768913e.png)
Apply as Filter and then changed from False to True
![c04f1b5a2d28bb912ea78a73a56ccda0.png](assets/resources-writeupsc04f1b5a2d28bb912ea78a73a56ccda0.png)
There it is 
```
20
```
...
![ebf7bd12267dda9fe611b5a409d6b1f5.png](assets/resources-writeupsebf7bd12267dda9fe611b5a409d6b1f5.png)
...
![574fe27bec62672bc5b6f0efc71e37cb.png](assets/resources-writeups574fe27bec62672bc5b6f0efc71e37cb.png)
You can see that we can use Originating VLAN to filter out for VLAN 60
![6f1057eaf6ef573ae4996a090c096c7a.png](assets/resources-writeups6f1057eaf6ef573ae4996a090c096c7a.png)
Got it
```
00:21:1b:ae:31:80
```
...
![ca0d28cf17a28dc63d37b12be5dd4545.png](assets/resources-writeupsca0d28cf17a28dc63d37b12be5dd4545.png)
```
12.1(22)EA14
```
...
![6ce72a42637d2f13453ab6ba18427a13.png](assets/resources-writeups6ce72a42637d2f13453ab6ba18427a13.png)
On hsrp packet, I used group as filter and I could find the answer there
![ddfcf356e62f5ef34cc63a7a8e3d39f0.png](assets/resources-writeupsddfcf356e62f5ef34cc63a7a8e3d39f0.png)
```
192.168.121.1
```
...
![9484ba1cb148c8d23ed898595403855f.png](assets/resources-writeups9484ba1cb148c8d23ed898595403855f.png)
![a5d94447fe900f958060bde970114b4a.png](assets/resources-writeupsa5d94447fe900f958060bde970114b4a.png)
Then I found this [post](https://osqa-ask.wireshark.org/questions/19753/ipv6-router-solicitation/) on Wireshark Q&A 
![90d8916faafe6b2d2be1b0f1edd36029.png](assets/resources-writeups90d8916faafe6b2d2be1b0f1edd36029.png)
Now applied that filter on pcapng file
![b1fa423055bc32b404242b699cf828b1.png](assets/resources-writeupsb1fa423055bc32b404242b699cf828b1.png)
We got 3
```
3
```
...
![54e54bb25a504aa57f6ea54c6ca4033e.png](assets/resources-writeups54e54bb25a504aa57f6ea54c6ca4033e.png)
```
192.168.121.20
```
...
![0fe8df87943084e9993396d336b4d4bf.png](assets/resources-writeups0fe8df87943084e9993396d336b4d4bf.png)
get-request didn't have the answer so It has to be in get-response
![510d701dd58fd1af0d469de989664b8e.png](assets/resources-writeups510d701dd58fd1af0d469de989664b8e.png)
There is it
```
Fa0/1
```
...
![e9a2b20d5b3b28720d599bf0bc74fd10.png](assets/resources-writeupse9a2b20d5b3b28720d599bf0bc74fd10.png)
After found it, I followed UDP stream to find more information
![6476b3a0335325b51e2dc392dbe9e7c2.png](assets/resources-writeups6476b3a0335325b51e2dc392dbe9e7c2.png)
...
![cb2a1680d3df0f93eb57553273721157.png](assets/resources-writeupscb2a1680d3df0f93eb57553273721157.png)
```
2001:DB8::1812
```
...
![af4aad88a3c4ad0cd2a7ec4562201931.png](assets/resources-writeupsaf4aad88a3c4ad0cd2a7ec4562201931.png)
...
![84d0bd7a2e5d86f429333253fc2f56d5.png](assets/resources-writeups84d0bd7a2e5d86f429333253fc2f56d5.png)
Next find TLS and add (Pre)-Master-Secret log filename and then click OK
![4299f7888a27336d98e5acc1c8b43bcf.png](assets/resources-writeups4299f7888a27336d98e5acc1c8b43bcf.png)
Now after follow TLS, we can read the content inside of it now
![a29e0e071a01c1d8416ec10075c99f50.png](assets/resources-writeupsa29e0e071a01c1d8416ec10075c99f50.png)
```
y2*Lg4cHe@Ps
```
...
![2948b46f090f3b2963e270b2ba4bf349.png](assets/resources-writeups2948b46f090f3b2963e270b2ba4bf349.png)
...
![2e1d194bcec7f9a27f765e9d8e100939.png](assets/resources-writeups2e1d194bcec7f9a27f765e9d8e100939.png)
Which we can see in cleartext
![94928a9260d17dd034b34af9baffc086.png](assets/resources-writeups94928a9260d17dd034b34af9baffc086.png)
```
...
![f16c0e328c6088f25253060342f95ebf.png](assets/resources-writeupsf16c0e328c6088f25253060342f95ebf.png)
...
![7eb977e3a6e178ece6e70afa9c6e5dbd.png](assets/resources-writeups7eb977e3a6e178ece6e70afa9c6e5dbd.png)
```
good
```
...
![79d42843077fc0cba3fca81335797352.png](assets/resources-writeups79d42843077fc0cba3fca81335797352.png)
```
...
![239ca1a8452df963946b7458f7b74e59.png](assets/resources-writeups239ca1a8452df963946b7458f7b74e59.png)
It is a page that used to setting NTP so the service is NTP
![78d913a3cd6d5c9dcd0029bf62ecb949.png](assets/resources-writeups78d913a3cd6d5c9dcd0029bf62ecb949.png)
...
![c55d28d38fbcb7ea9efa5b788bc570d4.png](assets/resources-writeupsc55d28d38fbcb7ea9efa5b788bc570d4.png)
Which is lan
![b704042af3b60861ac6346bed3d1d2c8.png](assets/resources-writeupsb704042af3b60861ac6346bed3d1d2c8.png)
```
lan:ntp
```

![51c871a6b93e112c9f0cd909efa5eb62.png](assets/resources-writeups51c871a6b93e112c9f0cd909efa5eb62.png)
* * *
