...
* * *
![760157a5055428e4c929a136231636b7.png](assets/resources-writeups760157a5055428e4c929a136231636b7.png)
**Scenario:**
...
![1bfa426c86a9c2c8c8406ff7ae149a7f.png](assets/resources-writeups1bfa426c86a9c2c8c8406ff7ae149a7f.png)
```
...
![d89ff211da648e8f7df9962c8fce86f8.png](assets/resources-writeupsd89ff211da648e8f7df9962c8fce86f8.png)

First, I used `MFTCmd.exe` to make my search easy with Timeline Explorer

![8cdccf6d45c6fc943ee41626be486249.png](assets/resources-writeups8cdccf6d45c6fc943ee41626be486249.png)

Search for `\Users\` directory then we will have all users on this system

![500d3da85cfdec38e36e895b4197b432.png](assets/resources-writeups500d3da85cfdec38e36e895b4197b432.png)
...
![f9a94d0b35867f0512c1e163018716cf.png](assets/resources-writeupsf9a94d0b35867f0512c1e163018716cf.png)

one way to find this is to search for `.hta` file within `Downloads` directory of this user

![016ad5334d2dfc544aa26cf2b9f89dfa.png](assets/resources-writeups016ad5334d2dfc544aa26cf2b9f89dfa.png)
...
![2252fde4f5035a6b6edf37afc945309a.png](assets/resources-writeups2252fde4f5035a6b6edf37afc945309a.png)

You can get ZoneId from ADS of this file, we can do this by getting Zone Id Contents from csv file or 

![1ce543d01131d273099ac34fcfec1e07.png](assets/resources-writeups1ce543d01131d273099ac34fcfec1e07.png)
...
![76dbe118555923dade5abd99e607094b.png](assets/resources-writeups76dbe118555923dade5abd99e607094b.png)
csv file could not answer us with this one, we need to use MFTExplorer and get physical size of this file from here. 

![44bd8ab6163b5f30127c0d4c9d4d8899.png](assets/resources-writeups44bd8ab6163b5f30127c0d4c9d4d8899.png)
...
![d6a4bc15da5ecba3324cf6a70f15d8e4.png](assets/resources-writeupsd6a4bc15da5ecba3324cf6a70f15d8e4.png)
...
![cf4b1a1d3ab583cb34ac25e1bc245aa5.png](assets/resources-writeupscf4b1a1d3ab583cb34ac25e1bc245aa5.png)
...
![1c75809c30b8c9d919fccf04ff101e0c.png](assets/resources-writeups1c75809c30b8c9d919fccf04ff101e0c.png)
...
![1703f5ad082f3f405a03a00e89a812c2.png](assets/resources-writeups1703f5ad082f3f405a03a00e89a812c2.png)
...
![36adfba0a9725e8b18828e185d793bac.png](assets/resources-writeups36adfba0a9725e8b18828e185d793bac.png)
...
![e5ea65b4c202d0ee9eea128c3b10853e.png](assets/resources-writeupse5ea65b4c202d0ee9eea128c3b10853e.png)
...
![4921d4f6b4e6881aed01756ef409a8f9.png](assets/resources-writeups4921d4f6b4e6881aed01756ef409a8f9.png)
* * *
