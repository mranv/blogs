...
![e50dc23737164283600a67dba73daaef.png](assets/resources-writeupse50dc23737164283600a67dba73daaef.png)
...
rdesktop $IP
```
![ac272e6886df58b9996c20b86cae1171.png](assets/resources-writeupsac272e6886df58b9996c20b86cae1171.png)
...
![1f3714b4aa92fad0bb459214484170bd.png](assets/resources-writeups1f3714b4aa92fad0bb459214484170bd.png)
...
![d5257c19034104dfddaf4d33ec3d1f57.png](assets/resources-writeupsd5257c19034104dfddaf4d33ec3d1f57.png)
...
![da37f801c7c3993482f936d8aa0dd359.png](assets/resources-writeupsda37f801c7c3993482f936d8aa0dd359.png)
...
![c9700d265ea174f93f04f4d8f52298ec.png](assets/resources-writeupsc9700d265ea174f93f04f4d8f52298ec.png)
...
![879280d62835a725eba9172d6a3fbda1.png](assets/resources-writeups879280d62835a725eba9172d6a3fbda1.png)

Now I will download `cmd.exe` from `file:\\C:\Windows\System32` to the downloads folder that I can access

![77f8435ba9f1265b4a277e46802fb846.png](assets/resources-writeups77f8435ba9f1265b4a277e46802fb846.png)

This cmd will not be able to run if I don't change the name to `msedge.exe`.

![6a4463874576bf9be0725e8a065c9604.png](assets/resources-writeups6a4463874576bf9be0725e8a065c9604.png)
...
![64429c6645dc80f729785b9616fdbcf8.png](assets/resources-writeups64429c6645dc80f729785b9616fdbcf8.png)
...
![f06480d90160780684460cbbc48ef5f3.png](assets/resources-writeupsf06480d90160780684460cbbc48ef5f3.png)

Now I can grab the flag on the desktop of "KioskUser0" user.

![a5a2d6c048ea090540f1c51cb6e15dd6.png](assets/resources-writeupsa5a2d6c048ea090540f1c51cb6e15dd6.png)
...
![eb36369b9bc79028f6859add9525c46a.png](assets/resources-writeupseb36369b9bc79028f6859add9525c46a.png)
...
![6bebf7358321b759a3fbe847c1a44293.png](assets/resources-writeups6bebf7358321b759a3fbe847c1a44293.png)

After exploring the file system again, I found "Remote Desktop Plus" installation folder inside "Program Files (x86)" folder.

![41ee407f443deb937b58a4989d412340.png](assets/resources-writeups41ee407f443deb937b58a4989d412340.png)

I will execute `rdp.exe` inside this folder to open Remote Desktop Plus.

![4f3aae1f4c8123e9167202ea2c1265ef.png](assets/resources-writeups4f3aae1f4c8123e9167202ea2c1265ef.png)

Now I will import the profile, I found in `_admin` folder into this application.

![7144eb1d9b674b04b33320bad638cf11.png](assets/resources-writeups7144eb1d9b674b04b33320bad638cf11.png)
...
![bffd6cfb21cd707a2a13700dadf6dcc8.png](assets/resources-writeupsbffd6cfb21cd707a2a13700dadf6dcc8.png)
...
```
![9d060af00e6a63ea0bcf0f50bf4f5c5c.png](assets/resources-writeups9d060af00e6a63ea0bcf0f50bf4f5c5c.png)

Now I can import this profile.

![f27050e62e46400d9194d347534e88cb.png](assets/resources-writeupsf27050e62e46400d9194d347534e88cb.png)

Sadly the password is still marked inside this application so I will need a way to reveal it in cleartext.

![99924a56814cba1463c18acd2a9c26f5.png](assets/resources-writeups99924a56814cba1463c18acd2a9c26f5.png)
...
![f9484cc58e068972b9123fe07aafa913.png](assets/resources-writeupsf9484cc58e068972b9123fe07aafa913.png)

For some reason, It did not recognize the password in Remote Desktop Plus so I will resort with another software.

![d6e3a376c16b29d902a4e6512c4fc8f4.png](assets/resources-writeupsd6e3a376c16b29d902a4e6512c4fc8f4.png)
...
![a3041ac9e553a7209158f84a6921d536.png](assets/resources-writeupsa3041ac9e553a7209158f84a6921d536.png)
...
![372b97e504e81262e7dff7d629571419.png](assets/resources-writeups372b97e504e81262e7dff7d629571419.png)
...
![45df07dcf958d038fbd207430cd51327.png](assets/resources-writeups45df07dcf958d038fbd207430cd51327.png)
...
![2f8dc819396ff16c1f715d7b3b158c2f.png](assets/resources-writeups2f8dc819396ff16c1f715d7b3b158c2f.png)

And now I finally have full privilege administrator shell to get the root flag.

![781c910db8c7a035527ebb036a5a1db9.png](assets/resources-writeups781c910db8c7a035527ebb036a5a1db9.png)

![cdd6a1e764cfbc04b496a47c8ca29a74.png](assets/resources-writeupscdd6a1e764cfbc04b496a47c8ca29a74.png)

The root flag is located on the desktop of administrator user and I successfully root the box :D

![347a7ca811d8e01bc954913ad49bbdef.png](assets/resources-writeups347a7ca811d8e01bc954913ad49bbdef.png)

![77222dec6336f37377c676c3fe3a0d12.png](assets/resources-writeups77222dec6336f37377c676c3fe3a0d12.png)
