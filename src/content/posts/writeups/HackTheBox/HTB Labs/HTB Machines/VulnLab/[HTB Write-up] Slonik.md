...
![83fb37a52cd7f1e70f4a5c5a558c3a32.png](/assets/resources-writeups/83fb37a52cd7f1e70f4a5c5a558c3a32.avif)
...
![c8b9593a04c6692cd118168c8c739b94.png](/assets/resources-writeups/c8b9593a04c6692cd118168c8c739b94.avif)
...
```
![64f6435c9ef39497d762d3b3b25c74ee.png](/assets/resources-writeups/64f6435c9ef39497d762d3b3b25c74ee.avif)
...
![9b76e9eb6a8d6fd3a70817459690cdb7.png](/assets/resources-writeups/9b76e9eb6a8d6fd3a70817459690cdb7.avif)
...
sudo -u svc1337 -i
```
![414e5d061aa50e7db29b184abb8cd434.png](/assets/resources-writeups/414e5d061aa50e7db29b184abb8cd434.avif)

The `.bash_history` file reveals the existence of postgres SQL user and service running locally on the machine.

![5eec89e6271f6ab42febe1c15d915ccf.png](/assets/resources-writeups/5eec89e6271f6ab42febe1c15d915ccf.avif)
...
![9eb2e4b41a14d96c32798da7a6933daf.png](/assets/resources-writeups/9eb2e4b41a14d96c32798da7a6933daf.avif)

CrackStation found its match in an instant and look like service is also the password of the service user.

![a0d97753f50badbeedc2887890e2e34a.png](/assets/resources-writeups/a0d97753f50badbeedc2887890e2e34a.avif)
...
```
![8f6860c83a39b075fc6056c3177e51e8.png](/assets/resources-writeups/8f6860c83a39b075fc6056c3177e51e8.avif)
...
![69d2f46706593d3b1447c3fd54e83635.png](/assets/resources-writeups/69d2f46706593d3b1447c3fd54e83635.avif)
...
```
![f5822b6353823148962b2d3811af5ef9.png](/assets/resources-writeups/f5822b6353823148962b2d3811af5ef9.avif)
...
```
![9ae22502abbd6cae473ac556d3cf2961.png](/assets/resources-writeups/9ae22502abbd6cae473ac556d3cf2961.avif)
...
```
![170a4d60bd7ff7a383f1a3096ec37bba.png](/assets/resources-writeups/170a4d60bd7ff7a383f1a3096ec37bba.avif)
...
```
![ce48bdecc2f21ef8058c38d970cc8ba7.png](/assets/resources-writeups/ce48bdecc2f21ef8058c38d970cc8ba7.avif)

and now I can loot user flag and continue my exploration on this machine.

![6196f644f84e963b0820011483d91832.png](/assets/resources-writeups/6196f644f84e963b0820011483d91832.avif)
...
./pspy64s
```
![0fdf5d45579ca7057f032de5ff3e2fc5.png](/assets/resources-writeups/0fdf5d45579ca7057f032de5ff3e2fc5.avif)
...
![b0291f9ddb8ffdb2ac19076f68f9f5ba.png](/assets/resources-writeups/b0291f9ddb8ffdb2ac19076f68f9f5ba.avif)
...
![d2d1eb4a7e856ceccdb3fd9da85c0e59.png](/assets/resources-writeups/d2d1eb4a7e856ceccdb3fd9da85c0e59.avif)
...
![7fb192b2f595909271a81e9e86d8b306.png](/assets/resources-writeups/7fb192b2f595909271a81e9e86d8b306.avif)
...
chmod u+s bash
```
![31c5480e5fdfec306aaf48b725d4e6e9.png](/assets/resources-writeups/31c5480e5fdfec306aaf48b725d4e6e9.avif)

Wait for a minute to let the backup script run and now I have SETID bash own by root!

![3a490bcda50ad351a16cf9b65468c1fc.png](/assets/resources-writeups/3a490bcda50ad351a16cf9b65468c1fc.avif)
...
```
![18e0831e360cf83f2414c44c79a39ab4.png](/assets/resources-writeups/18e0831e360cf83f2414c44c79a39ab4.avif)

![b513661dd8cfc0cb1b356a8b8eeeff30.png](/assets/resources-writeups/b513661dd8cfc0cb1b356a8b8eeeff30.avif)
