...
![46ad3b94d4e0c8388c661813b8fb8691.png](/assets/resources-writeups/46ad3b94d4e0c8388c661813b8fb8691.avif)
...
nmap $IP
```
![11fec01c57ae3d06db7c7a02d9276b1c.png](/assets/resources-writeups/11fec01c57ae3d06db7c7a02d9276b1c.avif)
...
![9ba38760f500f464525bbc4e5147ab5a.png](/assets/resources-writeups/9ba38760f500f464525bbc4e5147ab5a.avif)
...
```
![26c291257a1b3db1d954abe231f71b0c.png](/assets/resources-writeups/26c291257a1b3db1d954abe231f71b0c.avif)

On the `share` share, I found 3 folders here.
```
smbclient \\\\breach.vl\\share -N
```
![86a29f1971ef0c0d85967cc80cb0cec3.png](/assets/resources-writeups/86a29f1971ef0c0d85967cc80cb0cec3.avif)

I found 3 users from `transfer` folder so at least we know that these 3 users are the active user on this machine.

![828d9d8d2028bbfa3ad8dc8d67e10282.png](/assets/resources-writeups/828d9d8d2028bbfa3ad8dc8d67e10282.avif)

Nothing really impressed on Users share

![efaf51a807fc8d8bc7c0cf8bcc399fc7.png](/assets/resources-writeups/efaf51a807fc8d8bc7c0cf8bcc399fc7.avif)
...
![3c21d9374d898d65294470d1cd9df20b.png](/assets/resources-writeups/3c21d9374d898d65294470d1cd9df20b.avif)
...
```
![b609212f9c4546066d986d37c22a8f35.png](/assets/resources-writeups/b609212f9c4546066d986d37c22a8f35.avif)

Then I upload it to `transfer` folder.

![962b2e25da423b54cadf3a6237d3e481.png](/assets/resources-writeups/962b2e25da423b54cadf3a6237d3e481.avif)

As soon as I use `responder` to setup the listener for NTLMSSP, I got NTLMv2 hash of Julia.Wong right away.
```
sudo responder -I tun0
```
![666c98564180851e5319ba258681e53b.png](/assets/resources-writeups/666c98564180851e5319ba258681e53b.avif)
...
```
![72f930efe8fa0d94c2605802c34cab61.png](/assets/resources-writeups/72f930efe8fa0d94c2605802c34cab61.avif)
...
```
![ac84f25c62c50d31ca40467794dab8c7.png](/assets/resources-writeups/ac84f25c62c50d31ca40467794dab8c7.avif)
...
```
![a8f33c50d81ffad4a3c3edbea6cbccc7.png](/assets/resources-writeups/a8f33c50d81ffad4a3c3edbea6cbccc7.avif)
...
```
![e18955eae723336b4e0e233acc0d2aba.png](/assets/resources-writeups/e18955eae723336b4e0e233acc0d2aba.avif)
...
```
![87782a67c93efcfe41045323bf959f1b.png](/assets/resources-writeups/87782a67c93efcfe41045323bf959f1b.avif)
...
```
![50225f1e29b4d4660128d544be720432.png](/assets/resources-writeups/50225f1e29b4d4660128d544be720432.avif)

But after turn out, this user still have "guest" access on the MSSQL service so what should I do next?

![cdae923635bff44a6effc8c5e0379a09.png](/assets/resources-writeups/cdae923635bff44a6effc8c5e0379a09.avif)
...
```
![901f12098260ecb62ae83b8f4b645db9.png](/assets/resources-writeups/901f12098260ecb62ae83b8f4b645db9.avif)
...
![1104efef1e75ddbd5de9179789677a1e.png](/assets/resources-writeups/1104efef1e75ddbd5de9179789677a1e.avif)

Interestingly, there is one more user in the Administrators group which is Christine.bruce here.

![1ddd64e05c82687120b2059ffa02deaa.png](/assets/resources-writeups/1ddd64e05c82687120b2059ffa02deaa.avif)

Lastly, I grab the domain SID here and we will have all requirements for the silver ticket forging.

![2c5c37affd3ee0c052b8adf53e9fc5c0.png](/assets/resources-writeups/2c5c37affd3ee0c052b8adf53e9fc5c0.avif)
...
```
![834fa714ff7aa893ab3f194342a5d033.png](/assets/resources-writeups/834fa714ff7aa893ab3f194342a5d033.avif)
...
enable_xp_cmdshell
```
![02a3882f06ea1f841c4926df5cd0ecaf.png](/assets/resources-writeups/02a3882f06ea1f841c4926df5cd0ecaf.avif)
...
run
```
![2879d62eae81e069f0180a8e6cf245de.png](/assets/resources-writeups/2879d62eae81e069f0180a8e6cf245de.avif)
...
```
![46c1b630b0d9683ac133c0dfd4b07011.png](/assets/resources-writeups/46c1b630b0d9683ac133c0dfd4b07011.avif)

![3a4d07b4a7b121e5acdd46187e63b2de.png](/assets/resources-writeups/3a4d07b4a7b121e5acdd46187e63b2de.avif)
...
![77a535aab32f0493ea4db3442751d9a0.png](/assets/resources-writeups/77a535aab32f0493ea4db3442751d9a0.avif)

So I will use [GodPotato](https://github.com/BeichenDream/GodPotato) instead which I upload it to music folder of public user.

![312e02a0207b917ccf992905e054a0c9.png](/assets/resources-writeups/312e02a0207b917ccf992905e054a0c9.avif)
...
```
![7c037362d6d4f9d627f1364a46026b62.png](/assets/resources-writeups/7c037362d6d4f9d627f1364a46026b62.avif)
...
```
![e8f1424d867f34a80822110d2f20e8ba.png](/assets/resources-writeups/e8f1424d867f34a80822110d2f20e8ba.avif)

User flag

![b5a030b37c82ac7e211d6f9f22101fb7.png](/assets/resources-writeups/b5a030b37c82ac7e211d6f9f22101fb7.avif)

Root flag

![3499ce5087a7afe7f136140f0ed37709.png](/assets/resources-writeups/3499ce5087a7afe7f136140f0ed37709.avif)

![b9a2f9a205825c67f52d1ea064f305ae.png](/assets/resources-writeups/b9a2f9a205825c67f52d1ea064f305ae.avif)
