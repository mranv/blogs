...
![8c94c9bdb9cbd0dabf013db6a0e7ad1a.png](assets/resources-writeups8c94c9bdb9cbd0dabf013db6a0e7ad1a.png)
...
## Networks
### HTTP Mayhem (100)
![c5b34cf9b222c9440248ba185e723a02.png](assets/resources-writeupsc5b34cf9b222c9440248ba185e723a02.png)
...
* * *
![4ecf4f728710c037ab413c4188ac883e.png](assets/resources-writeups4ecf4f728710c037ab413c4188ac883e.png)
...
![ebec72ef1618f75596ba851b08c217af.png](assets/resources-writeupsebec72ef1618f75596ba851b08c217af.png)
...
![56cd3acca464b1095ccbd073782228a6.png](assets/resources-writeups56cd3acca464b1095ccbd073782228a6.png)
...
***
### Silent Whisper (100)
![32693a25aa9b7ee37b2ba70adb2da510.png](assets/resources-writeups32693a25aa9b7ee37b2ba70adb2da510.png)
...
***
![f6556842907378a5284e29513d01b171.png](assets/resources-writeupsf6556842907378a5284e29513d01b171.png)

แวปแรกเมื่อเราเปิดไฟล์โจทย์ด้วย Wireshark จะพบว่ามี packet SYN จำนวนมากไปยัง Port 2121 ของอีก IP

![137deb8342557625dc38c9d83848a027.png](assets/resources-writeups137deb8342557625dc38c9d83848a027.png)
...
![0c6ea3b3d2f17a8e993ae0320099b6c7.png](assets/resources-writeups0c6ea3b3d2f17a8e993ae0320099b6c7.png)
...
***
### Encrypted C2 v2 (200)
![a7ac6318655c51ac545b225abd3200de.png](assets/resources-writeupsa7ac6318655c51ac545b225abd3200de.png)
...
Flag Format : THCTT24{MD5}
***
![8566b28b5ffe8199751976f6ae67d69e.png](assets/resources-writeups8566b28b5ffe8199751976f6ae67d69e.png)
...
![fce2744a2d6d2ab54f44c2caba07fb79.png](assets/resources-writeupsfce2744a2d6d2ab54f44c2caba07fb79.png)

ซึ่งเมื่อเราลองมองดูสิ่งที่ส่งไปให้ server ก็จะรู้ได้ทันทีว่านี่ก็คือ wordlist นั่นเอง

![f0adb9ff38f2d7c1707a0a4245f8162b.png](assets/resources-writeupsf0adb9ff38f2d7c1707a0a4245f8162b.png)

โดยสิ่งที่เราจะนำมา decode ก็จะมาจาก //callback โดยผมก็ได้ให้ ChatGPT เขียนสคริป match แต่ละ word ใน cmd ให้

![f0e05b59f76242356e75684272b6454d.png](assets/resources-writeupsf0e05b59f76242356e75684272b6454d.png)
...
![409015f8c630e02dd6c5a3d40f29ba5c.png](assets/resources-writeups409015f8c630e02dd6c5a3d40f29ba5c.png)

ซึ่งหลังจากแตกไฟล์ผมก็พบว่ามันเป็น Nested directories โดยจะมี `flag.txt` อยู่ทุก directory 

![4504df914e986852cf3c6c2ddb88e17d.png](assets/resources-writeups4504df914e986852cf3c6c2ddb88e17d.png)
...
![f9a5a381c91c0ddcf44bb3c03c314ac0.png](assets/resources-writeupsf9a5a381c91c0ddcf44bb3c03c314ac0.png)
...
![8b13728b277dddc5111b2a8593e18e26.png](assets/resources-writeups8b13728b277dddc5111b2a8593e18e26.png)

ซึ่งทุก ๆ ภาพก็จะได้เป็นข้อความเดียวกันก็คือ "Password is THCTT24" แต่ password ใช่กับอะไรหละ?

![f4466ef40178a9e673105ec7ce931325.png](assets/resources-writeupsf4466ef40178a9e673105ec7ce931325.png)
...
![eeed1587ea6240db9df3078f361cf214.png](assets/resources-writeupseeed1587ea6240db9df3078f361cf214.png)

หลังจากรันสคริปต์ก็จะพบว่าทุกไฟล์มี text file ซ่อนอยู่และทุกไฟล์เหมือนจะมี flag format หมดเลย

![ab716a804401102f917c67585b7f8a74.png](assets/resources-writeupsab716a804401102f917c67585b7f8a74.png)
...
![df214d17755cb93e96bcf624deae0610.png](assets/resources-writeupsdf214d17755cb93e96bcf624deae0610.png)
...
![60c183665b7b02c82df5b511f380e24a.png](assets/resources-writeups60c183665b7b02c82df5b511f380e24a.png)

ซึ่งเมื่อ query ด้วย splunk จะพบว่ามีเพียง IP เดียวที่เข้าถึง arn ตัวนี้

![1501f525ff5afee873cfc1b5d5f5564f.png](assets/resources-writeups1501f525ff5afee873cfc1b5d5f5564f.png)
...
![c8c8a7b4fd9ce1ec0a1c57810ffcfceb.png](assets/resources-writeupsc8c8a7b4fd9ce1ec0a1c57810ffcfceb.png)
...
![fdf408be02f15d5068a28c3e51cd4020.png](assets/resources-writeupsfdf408be02f15d5068a28c3e51cd4020.png)

ก่อนผมเริ่ม decompile ผมลองหาดูก่อนว่ามันมีไฟล์น่าสนใจซ่อนอยู่ไหม ซึ่งผมก็เจอว่ามันมี `flag.txt` ซ่อนอยู่จริง ๆ 

![25b8158baccc53c8f24162cf908d84de.png](assets/resources-writeups25b8158baccc53c8f24162cf908d84de.png)

แต่เมื่อทำการ decompile เข้าไปอ่านก็จะพบว่า content ของ flag จริง ๆ นั้น อยู่ใน Manifest ไฟล์

![91884de20bcc4021696570de0156b34b.png](assets/resources-writeups91884de20bcc4021696570de0156b34b.png)

ซึ่งตัว Manifest ไฟล์ที่ว่าก็คือ `AndroidManifest.xml` นั่นเอง โดยเราจะพบ base64 encoded string อยู่ตรงนี้

![058795d323e6b4866aadef828fa0b886.png](assets/resources-writeups058795d323e6b4866aadef828fa0b886.png)
...
***
![13d58909597b60b01cfb6de183a8d23f.png](assets/resources-writeups13d58909597b60b01cfb6de183a8d23f.png)
...
![d33ec4d4de71196b0501cf9b59e2da27.png](assets/resources-writeupsd33ec4d4de71196b0501cf9b59e2da27.png)
...
![f5dbdb521bf0c94302889b11bacfa2ff.png](assets/resources-writeupsf5dbdb521bf0c94302889b11bacfa2ff.png)

เราต้องไปที่ `resources\res\drawable` เพื่อหารูปนี้ครับ

![f2eda8d6495114ac522f98434ee56f77.png](assets/resources-writeupsf2eda8d6495114ac522f98434ee56f77.png)

เมื่อเราได้ภาพมา เราก็จะเห็นว่ามันมีข้อความที่เป็น flag แอบอยู่ใต้ภาพ

![02a543abe49c70adb7f7159013e6a391.png](assets/resources-writeups02a543abe49c70adb7f7159013e6a391.png)
...
![871826a5a891f1bd2d029895062a4926.png](assets/resources-writeups871826a5a891f1bd2d029895062a4926.png)

ซึ่งก็เจอจริง ๆ ครับ...

![1c1cef15e83fcef4a6ed6a6348850090.png](assets/resources-writeups1c1cef15e83fcef4a6ed6a6348850090.png)

เข้าไปอ่าน content หรือเราจะ unzip apk ไฟล์โดยตรงเลยก็ได้

![9bbb024a548615b603ca2c8a2c6d9255.png](assets/resources-writeups9bbb024a548615b603ca2c8a2c6d9255.png)
...
หมายเหตุ รูปแบบของ Flag ที่เป็นคำตอบของข้อนี้คือ THCTT24{md5}
***
![e7661181bcc7435898a4d47eb2725089.png](assets/resources-writeupse7661181bcc7435898a4d47eb2725089.png)
...
![ca41219f3d4cbac5e1fa761bea3e41c3.png](assets/resources-writeupsca41219f3d4cbac5e1fa761bea3e41c3.png)

ซึ่งตัว secret เราจะหาได้จาก `Message.java`

![0932608c488e14f269379ab7fd28bc2c.png](assets/resources-writeups0932608c488e14f269379ab7fd28bc2c.png)

นี่คือหลักการทำงานคร่าว ๆ ของโปรแกรมครับ เรามี secret แล้ว เราแค่ต้องหา key ในการ XOR

![c5664e0da75ccc8a0b083311d4a2d567.png](assets/resources-writeupsc5664e0da75ccc8a0b083311d4a2d567.png)
...
![333c3db500b6a2e78c20c0f69dce858b.png](assets/resources-writeups333c3db500b6a2e78c20c0f69dce858b.png)

ตรงนี้นั่นเอง

![66129639d3cdeeda9fd601b2de829e5c.png](assets/resources-writeups66129639d3cdeeda9fd601b2de829e5c.png)
