...
![11b9c71bf25ae116fd9db78e1e76fe8e.png](assets/resources-writeups/11b9c71bf25ae116fd9db78e1e76fe8e.png)
...
![845da5db022971cefe01425d6da2a015.png](assets/resources-writeups/845da5db022971cefe01425d6da2a015.png)
...
![70bd8c8f20f42debce68b79858ec9917.png](assets/resources-writeups/70bd8c8f20f42debce68b79858ec9917.png)
...
![3338553f72ac1106accf0728661c7720.png](assets/resources-writeups/3338553f72ac1106accf0728661c7720.png)
...
![4cae078493f6d720c276266ef9506d98.png](assets/resources-writeups/4cae078493f6d720c276266ef9506d98.png)
...
![df98637d77a9f292c3ff9f441f88485c.png](assets/resources-writeups/df98637d77a9f292c3ff9f441f88485c.png)
...
![01ee4ac221a9836fa16686b5fe03f071.png](assets/resources-writeups/01ee4ac221a9836fa16686b5fe03f071.png)
...
![flag2.png](assets/resources-writeups/flag2.png)

Use password we obtained to get second half of a flag!

## Getting first half of a flag

![d8e3be1b26e648ec2f46014554c6bd80.png](assets/resources-writeups/d8e3be1b26e648ec2f46014554c6bd80.png)
...
![8547b4927aa44872a1fa0b5f99674da1.png](assets/resources-writeups/8547b4927aa44872a1fa0b5f99674da1.png)
...
![648ea59219c56a30f09855f48a5bb55d.png](assets/resources-writeups/648ea59219c56a30f09855f48a5bb55d.png)
...
![e886bc53645a8d0c1052eecb38666a80.png](assets/resources-writeups/e886bc53645a8d0c1052eecb38666a80.png)

Which eventually lead us to Mega Drive which is locked by a key so now we need to find password to unlock it.

![8c91a62257aced0562f33a2771c6dd55.png](assets/resources-writeups/8c91a62257aced0562f33a2771c6dd55.png)
...
![0237787a4453123e34f0d3ef2354715a.png](assets/resources-writeups/0237787a4453123e34f0d3ef2354715a.png)

Unlock mega with that key and download a flag.

![cc450e276fd75bcff083774b715d0615.png](assets/resources-writeups/cc450e276fd75bcff083774b715d0615.png)

But look like this file is corrupted so we might need to use hexeditor to fix it

![fd92aafc89db70130a12600e62b4ad77.png](assets/resources-writeups/fd92aafc89db70130a12600e62b4ad77.png)

I used HxD that pre-installed in Flare-VM and we can see that in IHDR chuck because it supposed to be IHDR not iHDR 

![2fa42bb50f6ded65ac384aa0353e0c87.png](assets/resources-writeups/2fa42bb50f6ded65ac384aa0353e0c87.png)

Compare to `flag2.png`, we can see which offset we need to fix.

![c09538089b698f0cb4d9f730478c8cbf.png](assets/resources-writeups/c09538089b698f0cb4d9f730478c8cbf.png)

Lets change 0x0000000C offset from 69(i) to 49(I) then save it, we should be able to view this image for now.

![d0d5d88cb62e3e230abc4109ba6983fe.png](assets/resources-writeups/d0d5d88cb62e3e230abc4109ba6983fe.png)
