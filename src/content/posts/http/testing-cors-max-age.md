...
author: Anubhav Gain
category: http
description: Today I noticed that [Datasette](https://datasette.io/) wasn't serving  a
  `Access-Control-Max-Age` header.
draft: false
featured: false
lang: en
pubDatetime: '2024-08-16T16:01:59+05:30'
slug: testing-the-access-control-max-age-cors-header
tags:
- /
- http
- javascript
...
- web
- testing
title: Testing the Access-Control-Max-Age CORS header
---
