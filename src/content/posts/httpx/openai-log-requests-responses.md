...
author: Anubhav Gain
category: httpx
description: My [LLM](https://llm.datasette.io/) tool has a feature where you can
  set a `LLM_OPENAI_SHOW_RESPONSES` environment variable to see full debug level...
draft: false
featured: false
lang: en
pubDatetime: '2024-02-14T15:37:45+05:30'
slug: logging-openai-api-requests-and-responses-using-httpx
tags:
- /
- httpx
- python
...
- web
- cli
title: Logging OpenAI API requests and responses using HTTPX
---
