...
author: Anubhav Gain
category: llms
description: '[llama.cpp](https://github.com/ggerganov/llama.cpp) recently added the
  ability to control the output of any model using a grammar.'
draft: false
featured: false
lang: en
pubDatetime: '2024-12-26T11:45:07+05:30'
slug: using-llama-cpp-python-grammars-to-generate-json
tags:
- /
- llms
- python
...
- cli
- testing
title: Using llama-cpp-python grammars to generate JSON
---
