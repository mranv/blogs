...
author: Anubhav Gain
category: llms
description: The ChatGPT Code Interpreter alpha remains incredibly interesting. I
  wrote about how I was using it [for Python and SQLite benchmarking](https://si...
draft: false
featured: false
lang: en
pubDatetime: '2024-12-02T08:01:13+05:30'
slug: expanding-chatgpt-code-interpreter-with-python-packages-deno-and-lua
tags:
- /
- llms
- python
...
- database
- web
title: Expanding ChatGPT Code Interpreter with Python packages, Deno and Lua
---
