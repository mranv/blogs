...
author: Anubhav Gain
category: llms
description: OpenAI [announced new models](https://openai.com/blog/function-calling-and-other-api-updates)
  today. Of particular interest to me is the new `gpt-3...
draft: false
featured: false
lang: en
pubDatetime: '2024-12-03T18:28:04+05:30'
slug: running-openais-large-context-models-using-llm
tags:
- /
- llms
- git
...
- cli
- testing
title: Running OpenAI's large context models using llm
---
