...
author: Anubhav Gain
category: llms
description: I've been experimenting with the combination of [Claude](https://claude.ai/)
  and my [LLM CLI tool](https://llm.datasette.io/) to give me quick summ...
draft: false
featured: false
lang: en
pubDatetime: '2024-09-20T18:34:32+05:30'
slug: summarizing-hacker-news-discussion-themes-with-claude-and-llm
tags:
- /
- llms
- python
...
- database
- web
title: Summarizing Hacker News discussion themes with Claude and LLM
---
