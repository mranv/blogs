...
author: Anubhav Gain
category: llms
description: I was exploring the original BERT model from 2018, which is mainly useful
  if you fine-tune a model on top of it for a specific task.
draft: false
featured: false
lang: en
pubDatetime: '2024-10-29T14:00:23+05:30'
slug: named-entity-resolution-with-dslimdistilbert-ner
tags:
- /
- llms
- python
...
- web
- cli
title: Named Entity Resolution with dslim/distilbert-NER
---
