...
author: Anubhav Gain
category: llms
description: OpenAI's [gpt-oss models](https://github.com/openai/gpt-oss/) come with
  an eval suite, which is described in their [Verifying gpt-oss implementatio...
draft: false
featured: false
lang: en
pubDatetime: '2024-10-19T11:12:57+05:30'
slug: running-a-gpt-oss-eval-suite-against-lm-studio-on-a-mac
tags:
- /
- llms
- python
...
- cli
- testing
title: Running a gpt-oss eval suite against LM Studio on a Mac
---
