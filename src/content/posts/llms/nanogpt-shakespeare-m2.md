...
author: Anubhav Gain
category: llms
description: '[nanoGPT](https://github.com/karpathy/nanoGPT) is Andrej Karpathy''s
  "simplest, fastest repository for training/finetuning medium-sized GPTs".'
draft: false
featured: false
lang: en
pubDatetime: '2025-01-11T13:17:47+05:30'
slug: running-nanogpt-on-a-macbook-m2-to-generate-terrible-shakespeare
tags:
- /
- llms
- python
...
- cli
- testing
title: Running nanoGPT on a MacBook M2 to generate terrible Shakespeare
---
