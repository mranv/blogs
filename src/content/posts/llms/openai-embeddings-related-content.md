...
author: Anubhav Gain
category: llms
description: I decide to upgrade the related articles feature on my TILs site. Previously
  I calculated these [using full-text search](https://til.simonwillison....
draft: false
featured: false
lang: en
pubDatetime: '2024-11-01T16:45:53+05:30'
slug: storing-and-serving-related-documents-with-openai-to-sqlite-and-embeddings
tags:
- /
- llms
- python
...
- git
- database
title: Storing and serving related documents with openai-to-sqlite and embeddings
---
