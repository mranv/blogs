...
author: Anubhav Gain
category: llms
description: This is a follow-up to [Running nanoGPT on a MacBook M2 to generate terrible
  Shakespeare](https://til.simonwillison.net/llms/nanogpt-shakespeare-m2).
draft: false
featured: false
lang: en
pubDatetime: '2024-09-27T09:43:22+05:30'
slug: training-nanogpt-entirely-on-content-from-my-blog
tags:
- /
- llms
- python
...
- web
- cli
title: Training nanoGPT entirely on content from my blog
---
