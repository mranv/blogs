...
author: Anubhav Gain
category: llms
description: I'm still working towards adding multi-modal support to my [LLM](https://llm.datasette.io/)
  tool. In the meantime, here are notes on running prompt...
draft: false
featured: false
lang: en
pubDatetime: '2024-10-15T12:13:23+05:30'
slug: running-prompts-against-images-pdfs-audio-and-video-with-google-gemini
tags:
- /
- llms
- python
...
- cli
- testing
title: Running prompts against images, PDFs, audio and video with Google Gemini
---
