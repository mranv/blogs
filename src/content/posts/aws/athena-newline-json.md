...
author: Anubhav Gain
category: aws
description: I've been writing my Fly logs to S3 in newline-delimited JSON format
  using the recipe described in [Writing Fly logs to S3](https://til.simonwillis...
draft: false
featured: false
lang: en
