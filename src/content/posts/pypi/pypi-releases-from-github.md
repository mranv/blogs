...
author: Anubhav Gain
category: pypi
description: I published a package to [PyPI](https://pypi.org) today using their [Trusted
  Publishers](https://docs.pypi.org/trusted-publishers/) mechanism for t...
draft: false
featured: false
lang: en
pubDatetime: '2024-02-02T11:48:58+05:30'
slug: publish-releases-to-pypi-from-github-actions-without-a-password-or-token
tags:
- /
- pypi
- python
...
- web
- testing
title: Publish releases to PyPI from GitHub Actions without a password or token
---
