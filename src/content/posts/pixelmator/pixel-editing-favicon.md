...
author: Anubhav Gain
category: pixelmator
description: I wanted to [add a favicon](https://github.com/simonw/datasette/issues/1603)
  to Datasette, using a PNG image served from `/favicon.ico` as suggeste...
draft: false
featured: false
lang: en
pubDatetime: '2024-04-22T10:39:12+05:30'
slug: pixel-editing-a-favicon-with-pixelmator
tags:
- /
- pixelmator
- python
- git
- web
title: Pixel editing a favicon with Pixelmator
---
