...
author: Anubhav Gain
category: valtown
description: '[Val Town](https://www.val.town/) is a neat service for hosting short
  server-side JavaScript programs online - reminiscent of a combination of Glit...'
draft: false
featured: false
lang: en
pubDatetime: '2024-12-04T20:42:01+05:30'
slug: running-a-scheduled-function-on-val-town-to-import-atom-feeds-into-datasette-cloud
tags:
- /
- valtown
- javascript
...
- web
- testing
title: Running a scheduled function on Val Town to import Atom feeds into Datasette
  Cloud
---
