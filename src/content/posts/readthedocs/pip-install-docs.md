...
description: I decided to use ReadTheDocs for my in-development [datasette-enrichments](https://github.com/datasette/datasette-enrichments)
  project.
draft: false
featured: false
lang: en
pubDatetime: '2024-02-29T09:14:45+05:30'
slug: running-pip-install-docs-on-readthedocs
tags:
- /
- readthedocs
- python
...
- cli
- testing
title: Running pip install '.[docs]' on ReadTheDocs
---
