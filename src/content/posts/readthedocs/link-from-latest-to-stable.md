...
description: '[Read The Docs](https://readthedocs.org/) has a handy feature where
  documentation for older versions will automatically link to the latest release,...'
draft: false
featured: false
lang: en
pubDatetime: '2024-01-16T14:04:02+05:30'
slug: linking-from-latest-to-stable-on-read-the-docs
tags:
- /
- readthedocs
- python
...
- web
- testing
title: Linking from /latest/ to /stable/ on Read The Docs
---
