...
description: 'I use [ReadTheDocs](https://readthedocs.org/) for several of my projects.
  It''s fantastic: among other things, it makes it easy to publish the docum...'
draft: false
featured: false
lang: en
pubDatetime: '2024-01-25T09:05:39+05:30'
slug: updating-stable-docs-in-readthedocs-without-pushing-a-release
tags:
- /
- readthedocs
- python
...
- web
- cli
title: Updating stable docs in ReadTheDocs without pushing a release
---
