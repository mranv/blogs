...
description: I wanted to make a small customization to one of my documentation templates
  on Read the Docs.
draft: false
featured: false
lang: en
pubDatetime: '2024-06-21T09:12:00+05:30'
slug: using-custom-sphinx-templates-on-read-the-docs
tags:
- /
- readthedocs
- git
- web
title: Using custom Sphinx templates on Read the Docs
---
