...
author: Anubhav Gain
category: electron
description: I figured out how to use the Chrome DevTools to execute JavaScript interactively
  inside the Electron main process. I always like having a REPL for ...
draft: false
featured: false
lang: en
pubDatetime: '2024-07-03T21:49:33+05:30'
slug: using-the-chrome-devtools-console-as-a-repl-for-an-electron-app
tags:
- /
- electron
- javascript
- git
- web
title: Using the Chrome DevTools console as a REPL for an Electron app
---
