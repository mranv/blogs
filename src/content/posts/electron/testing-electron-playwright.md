...
author: Anubhav Gain
category: electron
description: Yesterday [I figured out (issue 133)](https://github.com/simonw/datasette-app/issues/133)
  how to use Playwright to run tests against my Electron ap...
draft: false
featured: false
lang: en
pubDatetime: '2024-02-14T09:22:10+05:30'
slug: testing-electron-apps-with-playwright-and-github-actions
tags:
- /
- electron
- python
...
- web
- testing
title: Testing Electron apps with Playwright and GitHub Actions
---
