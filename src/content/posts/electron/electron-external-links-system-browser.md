...
author: Anubhav Gain
category: electron
description: For [Datasette.app](https://github.com/simonw/datasette-app) I wanted
  to ensure that links to external URLs would [open in the system browser](http...
draft: false
featured: false
lang: en
pubDatetime: '2024-08-30T08:42:50+05:30'
slug: open-external-links-in-an-electron-app-using-the-system-browser
tags:
- /
- electron
- javascript
...
- web
- cli
title: Open external links in an Electron app using the system browser
---
