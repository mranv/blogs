...
author: Anubhav Gain
category: electron
description: I had to figure this out for [Datasette Desktop](https://github.com/simonw/datasette-app).
draft: false
featured: false
lang: en
pubDatetime: '2024-06-10T10:39:06+05:30'
slug: signing-and-notarizing-an-electron-app-for-distribution-using-github-actions
tags:
- /
- electron
- python
...
- web
- testing
title: Signing and notarizing an Electron app for distribution using GitHub Actions
---
