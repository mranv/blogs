...
author: Anubhav Gain
category: electron
description: For [Datasette Desktop](https://datasette.io/desktop) I chose to bundle
  a full version of Python 3.9 inside my `Datasette.app` application. I did t...
draft: false
featured: false
lang: en
pubDatetime: '2024-03-23T14:17:08+05:30'
slug: bundling-python-inside-an-electron-app
tags:
- /
- electron
- python
...
- git
- web
title: Bundling Python inside an Electron app
---
