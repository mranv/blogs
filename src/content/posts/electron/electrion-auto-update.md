...
author: Anubhav Gain
category: electron
description: This is _almost_ really simple. I used [electron/update-electron-app](https://github.com/electron/update-electron-app)
  for it, the instructions for...
draft: false
featured: false
lang: en
pubDatetime: '2024-08-11T14:06:56+05:30'
slug: configuring-auto-update-for-an-electron-app
tags:
- /
- electron
- javascript
- git
- web
title: Configuring auto-update for an Electron app
---
