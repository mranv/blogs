...
author: Anubhav Gain
category: json
description: A follow-up to [Using OpenAI functions and their Python library for data
  extraction](https://til.simonwillison.net/gpt3/openai-python-functions-dat...
draft: false
featured: false
lang: en
pubDatetime: '2024-03-07T17:16:35+05:30'
slug: processing-a-stream-of-chunks-of-json-with-ijson
tags:
- /
- json
- python
- javascript
- web
title: Processing a stream of chunks of JSON with ijson
---
