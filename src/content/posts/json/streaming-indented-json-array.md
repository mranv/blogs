...
author: Anubhav Gain
category: json
description: For [paginate-json]() I wanted to implement streaming output of an indented
  JSON array to my terminal.
draft: false
featured: false
lang: en
pubDatetime: '2024-02-05T18:43:36+05:30'
slug: streaming-output-of-an-indented-json-array
tags:
- /
- json
- python
...
- cli
- testing
title: Streaming output of an indented JSON array
---
