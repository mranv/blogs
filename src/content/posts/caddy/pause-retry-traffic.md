...
author: Anubhav Gain
category: caddy
description: A pattern I really like for zero-downtime deploys is the ability to "pause"
  HTTP traffic at the load balancer, such that incoming requests from bro...
draft: false
featured: false
lang: en
pubDatetime: '2024-07-27T15:23:56+05:30'
slug: pausing-traffic-and-retrying-in-caddy
tags:
- /
- caddy
- javascript
- git
- web
title: Pausing traffic and retrying in Caddy
---
