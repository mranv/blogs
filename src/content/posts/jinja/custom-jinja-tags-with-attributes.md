...
author: Anubhav Gain
category: jinja
description: I decided to implement a custom Jinja template block tag for my [datasette-render-markdown](https://datasette.io/plugins/datasette-render-markdown)...
draft: false
featured: false
lang: en
pubDatetime: '2024-02-21T11:59:48+05:30'
slug: custom-jinja-template-tags-with-attributes
tags:
- /
- jinja
- python
...
- web
- testing
title: Custom Jinja template tags with attributes
---
