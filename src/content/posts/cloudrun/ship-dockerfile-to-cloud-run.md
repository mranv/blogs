...
author: Anubhav Gain
category: cloudrun
description: I deployed https://metmusem.datasettes.com/ by creating a folder on my
  computer containing a Dockerfile and then shipping that folder up to Google ...
draft: false
featured: false
lang: en
pubDatetime: '2024-12-18T13:15:47+05:30'
slug: how-to-deploy-a-folder-with-a-dockerfile-to-cloud-run
tags:
- /
- cloudrun
- python
...
- web
- cli
title: How to deploy a folder with a Dockerfile to Cloud Run
---
