...
author: Anubhav Gain
category: cloudrun
description: 'The `gcloud run services list` command lists your services running on
  Google Cloud Run:'
draft: false
featured: false
lang: en
pubDatetime: '2024-08-22T08:10:23+05:30'
slug: using-the-gcloud-run-services-list-command
tags:
- /
- cloudrun
- python
- javascript
- web
title: Using the gcloud run services list command
---
