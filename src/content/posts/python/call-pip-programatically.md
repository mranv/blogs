...
author: Anubhav Gain
category: python
description: 'I needed this for the `datasette install` and `datasette uninstall`
  commands, see [issue #925](https://github.com/simonw/datasette/issues/925).'
draft: false
featured: false
lang: en
pubDatetime: '2024-03-09T15:47:42+05:30'
slug: how-to-call-pip-programatically-from-python
tags:
- /
- python
- git
- web
- testing
title: How to call pip programatically from Python
---
