...
author: Anubhav Gain
category: python
description: When building the [--sniff option](https://github.com/simonw/sqlite-utils/issues/230)
  for `sqlite-utils insert` (which attempts to detect the corre...
draft: false
featured: false
lang: en
pubDatetime: '2024-02-04T16:48:42+05:30'
slug: using-iobufferedreader-to-peek-against-a-non-peekable-stream
tags:
- /
- python
- aws
...
- database
- web
title: Using io.BufferedReader to peek against a non-peekable stream
---
