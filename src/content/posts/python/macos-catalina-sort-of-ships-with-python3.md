...
author: Anubhav Gain
category: python
description: 'Once you have installed the "command line tools" for Catalina using
  the following terminal command:'
draft: false
featured: false
lang: en
pubDatetime: '2024-06-20T10:52:27+05:30'
slug: macos-catalina-sort-of-includes-python-3
tags:
- /
- python
- git
...
- web
- cli
title: macOS Catalina sort-of includes Python 3
---
