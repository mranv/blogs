...
author: Anubhav Gain
category: python
description: I figured out how to run a subprocess with a time limit for [datasette-ripgrep](https://github.com/simonw/datasette-ripgrep),
  using the `asyncio.cr...
draft: false
featured: false
lang: en
pubDatetime: '2024-07-21T18:56:05+05:30'
slug: running-python-code-in-a-subprocess-with-a-time-limit
tags:
- /
- python
- javascript
...
- web
- cli
title: Running Python code in a subprocess with a time limit
---
