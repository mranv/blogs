...
author: Anubhav Gain
category: python
description: I wanted a mechanism to check if a given Python object was "callable"
  - could be called like a function - or "async callable" - could be called usi...
draft: false
featured: false
lang: en
pubDatetime: '2024-07-18T15:22:14+05:30'
slug: checking-if-something-is-callable-or-async-callable-in-python
tags:
- /
- python
- git
- web
- testing
title: Checking if something is callable or async callable in Python
---
