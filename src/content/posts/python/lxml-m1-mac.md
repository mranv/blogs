...
author: Anubhav Gain
category: python
description: 'I ran into this error while trying to run `pip install lxml` on an M2
  Mac, inside a virtual environment I had intitially created using `pipenv shell`:'
draft: false
featured: false
lang: en
pubDatetime: '2024-06-02T10:29:57+05:30'
slug: installing-lxml-for-python-on-an-m1m2-mac
tags:
- /
- python
- cli
title: Installing lxml for Python on an M1/M2 Mac
---
