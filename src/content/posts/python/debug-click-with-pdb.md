...
author: Anubhav Gain
category: python
description: This tip is for when you are working on a Python command-line application
  that runs using that program's name, as opposed to typing `python my_scri...
draft: false
featured: false
lang: en
pubDatetime: '2024-08-11T12:03:28+05:30'
slug: debugging-a-click-application-using-pdb
tags:
- /
- python
- git
- database
- web
title: Debugging a Click application using pdb
---
