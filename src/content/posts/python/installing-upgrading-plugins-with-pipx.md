...
author: Anubhav Gain
category: python
description: 'If you installed `datasette` using `pipx install datasette` you can
  install additional plugins with `pipx inject` like so:'
draft: false
featured: false
lang: en
pubDatetime: '2024-03-20T17:50:07+05:30'
slug: installing-and-upgrading-datasette-plugins-with-pipx
tags:
- /
- python
- javascript
...
- web
- testing
title: Installing and upgrading Datasette plugins with pipx
---
