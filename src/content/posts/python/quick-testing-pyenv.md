...
author: Anubhav Gain
category: python
description: I had [a bug](https://github.com/simonw/llm/issues/82#issuecomment-1629735729)
  that was only showing up in CI against Python 3.8.
draft: false
featured: false
lang: en
pubDatetime: '2024-02-20T11:43:24+05:30'
slug: quickly-testing-code-in-a-different-python-version-using-pyenv
tags:
- /
- python
- git
...
- cli
- testing
title: Quickly testing code in a different Python version using pyenv
---
