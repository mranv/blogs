...
author: Anubhav Gain
category: python
description: I tried to install my [datasette-bplist](https://github.com/simonw/datasette-bplist)
  plugin today in a fresh Python 3.10 virtual environment on mac...
draft: false
featured: false
lang: en
pubDatetime: '2024-04-10T21:34:09+05:30'
slug: using-c_include_path-to-install-python-packages
tags:
- /
- python
- git
- web
title: Using C_INCLUDE_PATH to install Python packages
---
