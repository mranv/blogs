...
author: Anubhav Gain
category: python
description: 'For [simonw/til issue #82](https://github.com/simonw/til/issues/82)
  I needed to embed some binary content directly in a Python script.'
draft: false
featured: false
lang: en
pubDatetime: '2024-02-06T19:47:53+05:30'
slug: a-simple-pattern-for-inlining-binary-content-in-a-python-script
tags:
- /
- python
- git
...
- cli
- testing
title: A simple pattern for inlining binary content in a Python script
---
