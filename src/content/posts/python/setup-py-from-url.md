...
author: Anubhav Gain
category: python
description: For [sqlite-utils issue 464](https://github.com/simonw/sqlite-utils/issues/464)
  I implemented a fix to a tiny bug in a dependency in [my own fork](...
draft: false
featured: false
lang: en
pubDatetime: '2024-05-31T11:39:16+05:30'
slug: defining-setuppy-dependencies-using-a-url
tags:
- /
- python
- git
...
- web
- testing
title: Defining setup.py dependencies using a URL
---
