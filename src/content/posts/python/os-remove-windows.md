...
author: Anubhav Gain
category: python
description: I puzzled over this one for [quite a while](https://github.com/simonw/sqlite-utils/issues/503)
  this morning. I had this test that was failing with ...
draft: false
featured: false
lang: en
pubDatetime: '2024-06-01T14:10:35+05:30'
slug: osremove-on-windows-fails-if-the-file-is-already-open
tags:
- /
- python
- git
...
- web
- testing
title: os.remove() on Windows fails if the file is already open
---
