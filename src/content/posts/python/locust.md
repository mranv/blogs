...
author: Anubhav Gain
category: python
description: I've been using [Locust](https://locust.io/) recently to run some load
  tests - most significantly [these tests](https://github.com/simonw/django_sq...
draft: false
featured: false
lang: en
pubDatetime: '2024-02-03T11:08:25+05:30'
slug: simple-load-testing-with-locust
tags:
- /
- python
- javascript
...
- web
- testing
title: Simple load testing with Locust
---
