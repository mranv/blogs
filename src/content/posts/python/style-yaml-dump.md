...
author: Anubhav Gain
category: python
description: I had a list of Python dictionaries I wanted to output as YAML, but I
  wanted to control the style of the output.
draft: false
featured: false
lang: en
pubDatetime: '2024-04-13T20:13:32+05:30'
slug: controlling-the-style-of-dumped-yaml-using-pyyaml
tags:
- /
- python
- javascript
- database
- web
title: Controlling the style of dumped YAML using PyYAML
---
