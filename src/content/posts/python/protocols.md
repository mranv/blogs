...
author: Anubhav Gain
category: python
description: '[Datasette](https://datasette.io/) currently has a few API internals
  that return `sqlite3.Row` objects. I was thinking about how this might work in...'
draft: false
featured: false
lang: en
pubDatetime: '2024-07-10T14:45:21+05:30'
slug: protocols-in-python
tags:
- /
- python
- git
