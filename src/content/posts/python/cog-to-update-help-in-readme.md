...
author: Anubhav Gain
category: python
description: My [csvs-to-sqlite README](https://github.com/simonw/csvs-to-sqlite/blob/main/README.md)
  includes a section that shows the output of the `csvs-to-s...
draft: false
featured: false
lang: en
pubDatetime: '2024-07-08T11:40:19+05:30'
slug: using-cog-to-update-help-in-a-markdown-readme-file
tags:
- /
- python
- git
...
- web
- testing
title: Using cog to update --help in a Markdown README file
---
