...
author: Anubhav Gain
category: python
description: 'I figured out a really simple pattern for experimenting with new Python
  packages today:'
draft: false
featured: false
lang: en
pubDatetime: '2024-04-09T16:18:53+05:30'
slug: trying-out-python-packages-with-ipython-and-uvx
tags:
- /
- python
- git
...
- web
- cli
title: Trying out Python packages with ipython and uvx
---
