...
author: Anubhav Gain
category: python
description: '[Pyodide](https://github.com/pyodide/pyodide) provides "Python with
  the scientific stack, compiled to WebAssembly" - it''s an incredible project whi...'
draft: false
featured: false
lang: en
pubDatetime: '2024-06-10T12:11:59+05:30'
slug: using-the-sqlite3-python-module-in-pyodide-python-webassembly
tags:
- /
- python
- javascript
...
- web
- cli
title: Using the sqlite3 Python module in Pyodide - Python WebAssembly
---
