...
author: Anubhav Gain
category: python
description: '[PyInstaller](https://www.pyinstaller.org/) can take a Python script
  and bundle it up as a standalone executable for macOS, Linux and apparently Wi...'
draft: false
featured: false
lang: en
pubDatetime: '2024-05-21T09:51:58+05:30'
slug: packaging-a-python-app-as-a-standalone-binary-with-pyinstaller
tags:
- /
- python
- git
...
- cli
- testing
title: Packaging a Python app as a standalone binary with PyInstaller
---
