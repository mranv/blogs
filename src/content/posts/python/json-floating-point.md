...
author: Anubhav Gain
category: python
description: '[datasette-leaflet-geojson](github.com/simonw/datasette-leaflet-geojson)
  outputs GeoJSON geometries in HTML pages in a way that can be picked up by...'
draft: false
featured: false
lang: en
pubDatetime: '2024-05-17T09:34:46+05:30'
slug: outputting-json-with-reduced-floating-point-precision
tags:
- /
- python
- javascript
- git
- web
title: Outputting JSON with reduced floating point precision
---
