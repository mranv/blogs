...
author: Anubhav Gain
category: python
description: I finally figured out a process that works for me for hacking on Python
  CLI utilities using [uv](https://docs.astral.sh/uv/) to manage my developme...
draft: false
featured: false
lang: en
pubDatetime: '2024-04-09T16:37:29+05:30'
slug: using-uv-to-develop-python-command-line-applications
tags:
- /
- python
- git
