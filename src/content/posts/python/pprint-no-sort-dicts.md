...
author: Anubhav Gain
category: python
description: 'While parsing a CSV file using `csv.DictReader` today I noticed the
  following surprising result:'
draft: false
featured: false
lang: en
pubDatetime: '2024-08-11T20:23:38+05:30'
slug: using-pprint-to-print-dictionaries-while-preserving-their-key-order
tags:
- /
- python
- git
- web
title: Using pprint() to print dictionaries while preserving their key order
---
