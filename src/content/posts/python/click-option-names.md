...
author: Anubhav Gain
category: python
description: I hit [a bug today](https://github.com/simonw/datasette/issues/973) where
  I had defined a Click option called `open` but in doing so I replaced the...
draft: false
featured: false
lang: en
pubDatetime: '2024-04-09T12:31:48+05:30'
slug: understanding-option-names-in-click
tags:
- /
- python
- git
- web
title: Understanding option names in Click
---
