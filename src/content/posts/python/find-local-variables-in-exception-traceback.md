...
author: Anubhav Gain
category: python
description: 'For [sqlite-utils issue #309](https://github.com/simonw/sqlite-utils/issues/309)
  I had an error that looked like this:'
draft: false
featured: false
lang: en
pubDatetime: '2024-08-03T12:58:42+05:30'
slug: find-local-variables-in-the-traceback-for-an-exception
tags:
- /
- python
- git
- database
- web
title: Find local variables in the traceback for an exception
---
