...
author: Anubhav Gain
category: python
description: I tried [pip-tools](https://github.com/jazzband/pip-tools) for the first
  time today to pin the requirements for the [natbat/pillarpointstewards](ht...
draft: false
featured: false
lang: en
pubDatetime: '2024-02-01T21:45:55+05:30'
slug: freezing-requirements-with-pip-tools
tags:
- /
- python
- git
...
- web
- testing
title: Freezing requirements with pip-tools
---
