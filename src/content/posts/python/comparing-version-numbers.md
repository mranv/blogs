...
author: Anubhav Gain
category: python
description: I found myself wanting to compare the version numbers `0.63.1`, `1.0`
  and the `1.0a13` in Python code, in order to mark a `pytest` test as skipped ...
draft: false
featured: false
lang: en
pubDatetime: '2024-06-21T14:04:45+05:30'
slug: programmatically-comparing-python-version-strings
tags:
- /
- python
- git
