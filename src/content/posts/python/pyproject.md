...
author: Anubhav Gain
category: python
description: 'I''ve been using `setuptools` and `setup.py` for my Python packages
  for a long time: I like that it works without me having to think about installin...'
draft: false
featured: false
lang: en
pubDatetime: '2024-05-13T17:26:36+05:30'
slug: python-packages-with-pyprojecttoml-and-nothing-else
tags:
- /
- python
- javascript
