...
author: Anubhav Gain
category: python
description: '[tree-sitter](https://tree-sitter.github.io/tree-sitter/) is a "parser
  generator tool and an incremental parsing library". It has a very good reput...'
draft: false
featured: false
lang: en
pubDatetime: '2024-08-22T09:46:55+05:30'
slug: using-tree-sitter-with-python
tags:
- /
- python
- javascript
...
- web
- cli
title: Using tree-sitter with Python
---
