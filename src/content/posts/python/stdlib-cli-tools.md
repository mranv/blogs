...
author: Anubhav Gain
category: python
description: Seth Michael Larson [pointed out](https://twitter.com/sethmlarson/status/1674141676325990400)
  that the Python `gzip` module can be used as a CLI to...
draft: false
featured: false
lang: en
pubDatetime: '2024-05-31T15:49:04+05:30'
slug: cli-tools-hidden-in-the-python-standard-library
tags:
- /
- python
- javascript
