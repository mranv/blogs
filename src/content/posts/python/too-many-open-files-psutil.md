...
author: Anubhav Gain
category: python
description: 'I was getting this intermittent error running my Datasette test suite:'
draft: false
featured: false
lang: en
pubDatetime: '2024-01-29T10:06:48+05:30'
slug: using-psutil-to-investigate-too-many-open-files
tags:
- /
- python
- git
- web
- testing
title: Using psutil to investigate "Too many open files"
---
