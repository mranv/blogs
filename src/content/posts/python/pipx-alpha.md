...
author: Anubhav Gain
category: python
description: I wanted to upgrade my [git-history](https://datasette.io/tools/git-history)
  installation to a new alpha version.
draft: false
featured: false
lang: en
pubDatetime: '2024-07-27T16:24:11+05:30'
slug: upgrading-a-pipx-application-to-an-alpha-version
tags:
- /
- python
- git
- web
title: Upgrading a pipx application to an alpha version
---
