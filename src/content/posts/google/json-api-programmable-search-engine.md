...
author: Anubhav Gain
category: google
description: I figured out how to use a JSON API to run a very limited Google search
  today in a legit, non-screen-scraper way.
draft: false
featured: false
lang: en
pubDatetime: '2024-08-05T17:33:59+05:30'
slug: limited-json-api-for-google-searches-using-programmable-search-engine
tags:
- /
- google
- python
...
- web
- cli
title: Limited JSON API for Google searches using Programmable Search Engine
---
