...
description: '[App Platform](https://www.digitalocean.com/docs/app-platform/) is the
  new PaaS from DigitalOcean. I figured out how to run Datasette on it.'
draft: false
featured: false
lang: en
pubDatetime: '2024-06-16T09:00:07+05:30'
slug: running-datasette-on-digitalocean-app-platform
tags:
- /
- digitalocean
- python
...
- web
- testing
title: Running Datasette on DigitalOcean App Platform
---
