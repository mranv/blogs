...
author: Anubhav Gain
category: vscode
description: When I'm working with Python I like four space indents, but for JavaScript
  or HTML I like two space indents.
draft: false
featured: false
lang: en
pubDatetime: '2024-01-16T14:29:18+05:30'
slug: language-specific-indentation-settings-in-vs-code
tags:
- /
- vscode
- python
- javascript
- web
title: Language-specific indentation settings in VS Code
---
