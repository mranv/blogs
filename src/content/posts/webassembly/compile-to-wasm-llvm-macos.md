...
description: '[howto-wasm-minimal](https://github.com/ern0/howto-wasm-minimal) by
  Zalka Ernő ([my fork here](https://github.com/simonw/howto-wasm-minimal)) is a ...'
draft: false
featured: false
lang: en
pubDatetime: '2024-06-16T14:48:47+05:30'
slug: compiling-to-wasm-with-llvm-on-macos
tags:
- /
- webassembly
- python
...
- web
- cli
title: Compiling to WASM with llvm on macOS
---
