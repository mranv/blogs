...
description: I added some unit tests to my [datasette-plugin](https://github.com/simonw/datasette-plugin)
  cookiecutter template today, since the latest features...
draft: false
featured: false
lang: en
pubDatetime: '2024-06-25T18:42:54+05:30'
slug: testing-cookiecutter-templates-with-pytest
tags:
- /
- cookiecutter
- python
...
- web
- testing
title: Testing cookiecutter templates with pytest
---
