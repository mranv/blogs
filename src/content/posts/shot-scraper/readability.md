...
description: '[Readability.js](https://github.com/mozilla/readability) is "A standalone
  version of the readability library used for Firefox Reader View".'
draft: false
featured: false
lang: en
pubDatetime: '2024-05-05T09:17:11+05:30'
slug: extracting-web-page-content-using-readabilityjs-and-shot-scraper
tags:
- /
- shot-scraper
- python
