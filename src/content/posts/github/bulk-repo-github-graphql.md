...
author: Anubhav Gain
category: github
description: I wanted to be able to fetch details of a list of different repositories
  from the GitHub GraphQL API by name in a single operation.
draft: false
featured: false
lang: en
pubDatetime: '2024-07-09T11:09:22+05:30'
slug: bulk-fetching-repository-details-with-the-github-graphql-api
tags:
- /
- github
- python
...
- database
- web
title: Bulk fetching repository details with the GitHub GraphQL API
---
