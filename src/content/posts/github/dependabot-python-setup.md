...
author: Anubhav Gain
category: github
description: GitHub's Dependabot can automatically file PRs with bumps to dependencies
  when new versions of them are available.
draft: false
featured: false
lang: en
pubDatetime: '2024-04-15T15:26:40+05:30'
slug: configuring-dependabot-for-a-python-project
tags:
- /
- github
- python
...
- git
- web
title: Configuring Dependabot for a Python project
---
