...
author: Anubhav Gain
category: github
description: I wanted to use the GitHub GraphQL API to return all of the repositories
  on the https://github.com/topics/git-scraping page.
draft: false
featured: false
lang: en
pubDatetime: '2024-04-08T10:07:55+05:30'
slug: searching-for-repositories-by-topic-using-the-github-graphql-api
tags:
- /
- github
- javascript
...
- web
- testing
title: Searching for repositories by topic using the GitHub GraphQL API
---
