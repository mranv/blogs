...
description: I'm learning service workers. I wanted to start with one that intercepts
  calls to a `/path` and returns "Hello World".
draft: false
featured: false
lang: en
pubDatetime: '2024-05-05T10:29:09+05:30'
slug: intercepting-fetch-in-a-service-worker
tags:
- /
- service-workers
- python
