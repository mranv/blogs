...
author: Anubhav Gain
category: selenium
description: I needed to run Selenium on macOS for the first time today. Here's how
  I got it working.
draft: false
featured: false
lang: en
pubDatetime: '2024-05-10T22:23:31+05:30'
slug: installing-selenium-for-python-on-macos-with-chromedriver
tags:
- /
- selenium
- python
...
- cli
- testing
title: Installing Selenium for Python on macOS with ChromeDriver
---
