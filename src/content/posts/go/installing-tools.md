...
author: Anubhav Gain
category: go
description: Today I learned how to install tools from GitHub that are written in
  Go, using [github.com/icholy/semgrepx](https://github.com/icholy/semgrepx) as ...
draft: false
featured: false
lang: en
pubDatetime: '2024-07-24T14:31:12+05:30'
slug: installing-tools-written-in-go
tags:
- /
- go
- aws
...
- web
- testing
title: Installing tools written in Go
---
