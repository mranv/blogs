...
author: Anubhav Gain
category: fly
description: '[Fly.io](https://fly.io/) lets you deploy Docker containers that will
  be compiled as a Firecracker VM and run in locations around the world.'
draft: false
featured: false
lang: en
pubDatetime: '2024-05-21T13:57:26+05:30'
slug: using-the-fly-docker-registry
tags:
- /
- fly
- javascript
- docker
- web
title: Using the Fly Docker registry
---
