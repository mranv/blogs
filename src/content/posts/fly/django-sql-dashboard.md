...
author: Anubhav Gain
category: fly
description: I have a Fly application that uses their PostgreSQL service. I wanted
  to run [Django SQL Dashboard]() with a read-only user against that database.
draft: false
featured: false
lang: en
pubDatetime: '2024-08-25T18:17:06+05:30'
slug: configuring-django-sql-dashboard-for-fly-postgresql
tags:
- /
- fly
- python
...
- cli
- testing
title: Configuring Django SQL Dashboard for Fly PostgreSQL
---
