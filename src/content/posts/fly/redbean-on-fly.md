...
author: Anubhav Gain
category: fly
description: '[redbean](https://redbean.dev/) is a fascinating project - it provides
  a web server in a self-contained executable which you can add assets (or dyn...'
draft: false
featured: false
lang: en
pubDatetime: '2024-07-19T22:00:08+05:30'
slug: deploying-a-redbean-app-to-fly
tags:
- /
- fly
- javascript
...
- cli
- testing
title: Deploying a redbean app to Fly
---
