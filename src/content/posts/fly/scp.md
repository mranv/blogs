...
author: Anubhav Gain
category: fly
description: I have a Fly instance with a 20GB volume, and I wanted to copy files
  to and from the instance from my computer using `scp`.
draft: false
featured: false
lang: en
pubDatetime: '2024-12-19T21:28:58+05:30'
slug: how-to-scp-files-to-and-from-fly
tags:
- /
- fly
- docker
- web
title: How to scp files to and from Fly
---
