...
author: Anubhav Gain
category: fly
description: '[Fly](https://fly.io/) makes it surprisingly easy to configure wildcard
  DNS, such that `anything.your-new-domain.dev` is served by a single Fly app...'
draft: false
featured: false
lang: en
pubDatetime: '2024-12-04T11:17:32+05:30'
slug: wildcard-dns-and-ssl-on-fly
tags:
- /
- fly
- javascript
- web
title: Wildcard DNS and SSL on Fly
---
