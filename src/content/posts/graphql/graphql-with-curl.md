...
author: Anubhav Gain
category: graphql
description: I wanted to run a query against the GitHub GraphQL API using `curl` on
  the command line, while keeping the query itself as readable as possible. He...
draft: false
featured: false
lang: en
pubDatetime: '2024-06-29T15:41:43+05:30'
slug: using-curl-to-run-graphql-queries-from-the-command-line
tags:
- /
- graphql
- python
...
- web
- cli
title: Using curl to run GraphQL queries from the command line
---
