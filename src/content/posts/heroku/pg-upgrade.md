...
author: Anubhav Gain
category: heroku
description: Figured this out in https://github.com/simonw/simonwillisonblog/issues/132
  - I was running PostgreSQL 9.x and I wanted 11.x in order to use the new...
draft: false
featured: false
lang: en
pubDatetime: '2024-12-06T12:04:13+05:30'
slug: upgrading-a-heroku-postgresql-database-with-pgcopy
tags:
- /
- heroku
- python
...
- database
- web
title: Upgrading a Heroku PostgreSQL database with pg:copy
---
