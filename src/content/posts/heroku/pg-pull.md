...
author: Anubhav Gain
category: heroku
description: Today I worked out how to use the Heroku `pg:pull` command and [Postgres.app](https://postgresapp.com/)
  to pull a Heroku backup to my laptop.
draft: false
featured: false
lang: en
pubDatetime: '2024-12-15T19:46:40+05:30'
slug: using-heroku-pgpull-to-restore-a-backup-to-a-macos-laptop
tags:
- /
- heroku
- database
- web
- testing
title: Using heroku pg:pull to restore a backup to a macOS laptop
---
