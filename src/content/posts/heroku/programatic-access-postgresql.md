...
author: Anubhav Gain
category: heroku
description: My [db-to-sqlite](https://github.com/simonw/db-to-sqlite) tool can connect
  to a PostgreSQL database, export all of the content and write it to a SQ...
draft: false
featured: false
lang: en
pubDatetime: '2024-05-13T20:06:24+05:30'
slug: programatically-accessing-heroku-postgresql-from-github-actions
tags:
- /
- heroku
- python
...
- database
- web
title: Programatically accessing Heroku PostgreSQL from GitHub Actions
---
