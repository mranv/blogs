...
author: Anubhav Gain
category: sqlite
description: Given a large, heterogeneous table I wanted to identify patterns in the
  rows in terms of which columns were not null.
draft: false
featured: false
lang: en
pubDatetime: '2024-05-17T12:37:39+05:30'
slug: identifying-column-combination-patterns-in-a-sqlite-table
tags:
- /
- sqlite
- database
- web
- testing
title: Identifying column combination patterns in a SQLite table
---
