...
author: Anubhav Gain
category: sqlite
description: I figured out a pattern for doing this today using the `sqlite3` CLI
  tool - given two SQLite databases in the current folder, called `tils.db` and ...
draft: false
featured: false
lang: en
pubDatetime: '2024-05-05T14:41:53+05:30'
slug: copy-tables-between-sqlite-databases
tags:
- /
- sqlite
- git
...
- web
- cli
title: Copy tables between SQLite databases
---
