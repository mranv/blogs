...
author: Anubhav Gain
category: sqlite
description: In reading [Scraping JSON, HTML, and ZIP Files with Pure SQLite](https://observablehq.com/@asg017/scrape-json-html-zip-with-sqlite)
  by Alex Garcia ...
draft: false
featured: false
lang: en
pubDatetime: '2024-02-01T18:51:13+05:30'
slug: seeing-which-functions-are-unique-to-a-specific-sqlite-datasette-instance
tags:
- /
- sqlite
- javascript
...
- web
- testing
title: Seeing which functions are unique to a specific SQLite / Datasette instance
---
