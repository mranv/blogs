...
author: Anubhav Gain
category: sqlite
description: Google Chrome still includes support for [Web SQL](https://www.w3.org/TR/webdatabase/),
  the long since abandoned proposed standard for shipping a S...
draft: false
featured: false
lang: en
pubDatetime: '2024-07-25T16:14:32+05:30'
slug: finding-the-sqlite-version-used-by-web-sql-in-chrome
tags:
- /
- sqlite
- javascript
...
- web
- testing
title: Finding the SQLite version used by Web SQL in Chrome
---
