...
author: Anubhav Gain
category: sqlite
description: 'Here''s how to use SQLite''s `VALUES` syntax with a CTE to create a
  temporary table that you can then perform joins against in a query:'
draft: false
featured: false
lang: en
pubDatetime: '2024-05-05T09:55:01+05:30'
slug: combining-ctes-and-values-in-sqlite
tags:
- /
- sqlite
- database
- web
- testing
title: Combining CTEs and VALUES in SQLite
---
