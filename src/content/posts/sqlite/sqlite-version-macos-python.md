...
author: Anubhav Gain
category: sqlite
description: I've been trying to figure this out for years. Previous notes include
  [Using LD_PRELOAD to run any version of SQLite with Python](https://til.simon...
draft: false
featured: false
lang: en
pubDatetime: '2024-03-17T09:09:42+05:30'
slug: compile-and-run-a-new-sqlite-version-with-the-existing-sqlite3-python-library-on-macos
tags:
- /
- sqlite
- python
...
- web
- cli
title: Compile and run a new SQLite version with the existing sqlite3 Python library
  on macOS
---
