...
author: Anubhav Gain
category: sqlite
description: 'I was working with a database table that included values that were clearly
  in the wrong character encoding - values like this:'
draft: false
featured: false
lang: en
pubDatetime: '2024-06-23T14:05:47+05:30'
slug: fixing-broken-text-encodings-with-sqlite-transform-and-ftfy
tags:
- /
- sqlite
- python
...
- web
- cli
title: Fixing broken text encodings with sqlite-transform and ftfy
---
