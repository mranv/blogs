...
author: Anubhav Gain
category: sqlite
description: 'I was getting occasional `Error: database is locked` messages from a
  Datasette instance that was running against a bunch of different SQLite files ...'
draft: false
featured: false
lang: en
pubDatetime: '2024-06-13T17:44:44+05:30'
slug: enabling-wal-mode-for-sqlite-database-files
tags:
- /
- sqlite
- python
...
- database
- web
title: Enabling WAL mode for SQLite database files
---
