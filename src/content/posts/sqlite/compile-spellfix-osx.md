...
author: Anubhav Gain
category: sqlite
description: 'I wanted to browse a backup copy of my Plex database, which is a SQLite
  file. I tried this:'
draft: false
featured: false
lang: en
pubDatetime: '2024-07-02T21:59:49+05:30'
slug: compiling-the-sqlite-spellfixc-module-on-macos
tags:
- /
- sqlite
- git
- database
- web
title: Compiling the SQLite spellfix.c module on macOS
---
