...
author: Anubhav Gain
category: sqlite
description: Given a table with a `TEXT` column in SQLite I want to figure out if
  every value in that table is actually the text representation of an integer or...
draft: false
featured: false
lang: en
pubDatetime: '2024-06-23T17:43:24+05:30'
slug: figuring-out-if-a-text-value-in-sqlite-is-a-valid-integer-or-float
tags:
- /
- sqlite
- python
...
- web
- testing
title: Figuring out if a text value in SQLite is a valid integer or float
---
