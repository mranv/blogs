...
author: Anubhav Gain
category: sqlite
description: '[WizardLM](https://github.com/nlpxucan/WizardLM) is "an Instruction-following
  LLM Using Evol-Instruct". It''s a fine-tuned model on top of Meta''s LL...'
draft: false
featured: false
lang: en
pubDatetime: '2024-04-19T13:32:13+05:30'
slug: comparing-two-training-datasets-using-sqlite-utils
tags:
- /
- sqlite
- python
...
- web
- cli
title: Comparing two training datasets using sqlite-utils
---
