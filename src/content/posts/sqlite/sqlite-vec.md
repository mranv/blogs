...
author: Anubhav Gain
category: sqlite
description: Alex Garcia's [sqlite-vec](https://github.com/asg017/sqlite-vec) SQLite
  extension provides a bunch of useful functions for working with vectors ins...
draft: false
featured: false
lang: en
pubDatetime: '2024-02-12T13:48:40+05:30'
slug: using-sqlite-vec-with-embeddings-in-sqlite-utils-and-datasette
tags:
- /
- sqlite
- python
...
- web
- cli
title: Using sqlite-vec with embeddings in sqlite-utils and Datasette
---
