...
author: Anubhav Gain
category: sqlite
description: 'I figured out how to run a SQL query directly against a CSV file using
  the `sqlite3` command-line utility:'
draft: false
featured: false
lang: en
pubDatetime: '2024-08-12T18:13:14+05:30'
slug: one-liner-for-running-queries-against-csv-files-with-sqlite
tags:
- /
- sqlite
- javascript
