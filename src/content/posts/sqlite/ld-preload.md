...
author: Anubhav Gain
category: sqlite
description: I've been wanting to figure this out for ages. [This thread](https://news.ycombinator.com/item?id=23282684)
  on Hacker News plus [this Stackoverflow...
draft: false
featured: false
lang: en
pubDatetime: '2024-02-29T15:32:14+05:30'
slug: using-ld_preload-to-run-any-version-of-sqlite-with-python
tags:
- /
- sqlite
- python
...
- git
- database
title: Using LD_PRELOAD to run any version of SQLite with Python
---
