...
author: Anubhav Gain
category: sqlite
description: Here's a devious trick for listing ALL columns in a SQLite database,
  using a SQL query that generates another SQL query.
draft: false
featured: false
lang: en
pubDatetime: '2024-05-13T14:36:30+05:30'
slug: list-all-columns-in-a-sqlite-database
tags:
- /
- sqlite
- javascript
...
- web
- testing
title: List all columns in a SQLite database
---
