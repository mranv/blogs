...
author: Anubhav Gain
category: sqlite
description: 'I finally found a workaround for this error when attempting to load
  a SQLite extension in Python on macOS:'
draft: false
featured: false
lang: en
pubDatetime: '2024-03-10T13:22:08+05:30'
slug: loading-sqlite-extensions-in-python-on-macos
tags:
- /
- sqlite
- python
- database
- web
title: Loading SQLite extensions in Python on macOS
---
