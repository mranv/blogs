...
author: Anubhav Gain
category: sqlite
description: I wanted the ability to test my Python software against specific version
  of SQLite on macOS. I found a way to do that using [pysqlite3](https://git...
draft: false
featured: false
lang: en
pubDatetime: '2024-04-04T11:31:34+05:30'
slug: building-a-specific-version-of-sqlite-with-pysqlite-on-macoslinux
tags:
- /
- sqlite
- python
...
- web
- testing
title: Building a specific version of SQLite with pysqlite on macOS/Linux
---
