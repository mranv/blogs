...
author: Anubhav Gain
category: sqlite
description: I usually use my `sqlite-utils insert blah.db tablename file.csv --csv`
  command to import CSV data into SQLite, but for large CSV files (like a 750...
draft: false
featured: false
lang: en
pubDatetime: '2024-06-12T12:18:22+05:30'
slug: importing-csv-data-into-sqlite-with-import
tags:
- /
- sqlite
- database
