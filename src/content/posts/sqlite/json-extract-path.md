...
author: Anubhav Gain
category: sqlite
description: Several of the [SQLite JSON functions](), such as `json_extract()` and
  `json_array_length()`, take a path argument. This uses custom syntax along t...
draft: false
featured: false
lang: en
pubDatetime: '2024-07-13T22:28:18+05:30'
slug: json_extract-path-syntax-in-sqlite
tags:
- /
- sqlite
- javascript
