...
author: Anubhav Gain
category: sqlite
description: 'I figured out a single SQL query for the following today. Given a table
  of GitHub repositories, for each repository return:'
draft: false
featured: false
lang: en
pubDatetime: '2024-06-21T19:55:28+05:30'
slug: subqueries-in-select-expressions-in-sqlite-also-window-functions
tags:
- /
- sqlite
- javascript
...
- web
- testing
title: Subqueries in select expressions in SQLite - also window functions
---
