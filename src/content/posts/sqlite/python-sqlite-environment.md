...
author: Anubhav Gain
category: sqlite
description: In investigating [llm/issues/164](https://github.com/simonw/llm/issues/164)
  I found myself needing to know more precise details of the Python SQLit...
draft: false
featured: false
lang: en
pubDatetime: '2024-05-08T08:42:38+05:30'
slug: a-one-liner-to-output-details-of-the-current-pythons-sqlite
tags:
- /
- sqlite
- python
...
- web
- cli
title: A one-liner to output details of the current Python's SQLite
---
