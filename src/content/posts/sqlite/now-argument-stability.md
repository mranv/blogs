...
author: Anubhav Gain
category: sqlite
description: 'I stumbled across an interesting little detail of SQLite today, running
  the following query:'
draft: false
featured: false
lang: en
pubDatetime: '2024-01-19T20:45:31+05:30'
slug: the-sqlite-now-argument-is-stable-within-the-same-query
tags:
- /
- sqlite
- database
- web
- testing
title: The SQLite now argument is stable within the same query
---
