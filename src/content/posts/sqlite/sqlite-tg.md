...
author: Anubhav Gain
category: sqlite
description: '[TG](https://github.com/tidwall/tg) is an exciting new project in the
  world of open source geospatial libraries. It''s a single C file (an amalgamat...'
draft: false
featured: false
lang: en
pubDatetime: '2024-05-04T08:55:47+05:30'
slug: geospatial-sql-queries-in-sqlite-using-tg-sqlite-tg-and-datasette-sqlite-tg
tags:
- /
- sqlite
- python
...
- web
- cli
title: Geospatial SQL queries in SQLite using TG, sqlite-tg and datasette-sqlite-tg
---
