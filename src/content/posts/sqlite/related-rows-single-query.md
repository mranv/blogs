...
author: Anubhav Gain
category: sqlite
description: When building database-backed applications you'll often find yourself
  wanting to return a row from the database along with its related rows.
draft: false
featured: false
lang: en
pubDatetime: '2024-06-02T10:40:40+05:30'
slug: returning-related-rows-in-a-single-sql-query-using-json
tags:
- /
- sqlite
- python
...
- database
- web
title: Returning related rows in a single SQL query using JSON
---
