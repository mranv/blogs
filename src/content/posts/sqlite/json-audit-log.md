...
author: Anubhav Gain
category: sqlite
description: I continue to collect ways of tracking the history of a table of data
  stored in SQLite - see [sqlite-history](https://simonwillison.net/2023/Apr/15...
draft: false
featured: false
lang: en
pubDatetime: '2024-06-29T08:17:36+05:30'
slug: tracking-sqlite-table-history-using-a-json-audit-log
tags:
- /
- sqlite
- python
...
- database
- web
title: Tracking SQLite table history using a JSON audit log
---
