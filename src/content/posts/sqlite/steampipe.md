...
author: Anubhav Gain
category: sqlite
description: '[Steampipe](https://steampipe.io/) build software that lets you query
  different APIs directly from SQL databases.'
draft: false
featured: false
lang: en
pubDatetime: '2024-04-03T13:40:45+05:30'
slug: running-steampipe-extensions-in-sqlite-utils-and-datasette
tags:
- /
- sqlite
- python
...
- database
- web
title: Running Steampipe extensions in sqlite-utils and Datasette
---
