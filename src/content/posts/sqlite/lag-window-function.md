...
author: Anubhav Gain
category: sqlite
description: Here's [how to use a lag window function](https://covid-19.datasettes.com/covid?sql=with+italy+as+%28%0D%0A++select%0D%0A++++rowid%2C%0D%0A++++day%...
draft: false
featured: false
lang: en
pubDatetime: '2024-05-22T22:38:07+05:30'
slug: lag-window-function-in-sqlite
tags:
- /
- sqlite
- git
- database
- web
title: Lag window function in SQLite
---
