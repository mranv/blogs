...
author: Anubhav Gain
category: tailscale
description: I'm running an AWS Lightsail instance and I want to only be able to SSH
  to it from devices connected to my [Tailscale](https://tailscale.com/) netw...
draft: false
featured: false
lang: en
pubDatetime: '2024-10-01T11:38:40+05:30'
slug: restricting-ssh-connections-to-devices-within-a-tailscale-network
tags:
- /
- tailscale
- aws
- git
- web
title: Restricting SSH connections to devices within a Tailscale network
---
